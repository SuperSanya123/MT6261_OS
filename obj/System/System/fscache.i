# 1 "Source\\System\\fscache.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\System\\fscache.c"
# 21 "Source\\System\\fscache.c"
...
# 22 "Source\\System\\fscache.c" 2
# 1 "Source\\System\\fscache.h" 1
# 23 "Source\\System\\fscache.c" 2
...
static pFCBLOCK FSC_FindBlock(pFSCACHE Cache, uint32_t BlockIndex)
{
    ...
    while(tmpBlockItem != 
# 28 "Source\\System\\fscache.c" 3 4
                         ((void *)0)
# 28 "Source\\System\\fscache.c"
                             )
    {
...
{
    pFSCACHE NewFSCache = 
# 38 "Source\\System\\fscache.c" 3 4
                         ((void *)0)
# 38 "Source\\System\\fscache.c"
                             ;
    ...
    if (BlockSize)
    {
        ...
        if (NewFSCache != 
# 43 "Source\\System\\fscache.c" 3 4
                         ((void *)0)
# 43 "Source\\System\\fscache.c"
                             )
        {
            memset(NewFSCache, 0x00, sizeof(TFSCACHE));

            NewFSCache->BlockSize = BlockSize;
            NewFSCache->MaxBlocksCount = ({ typeof(128) _a = 128; typeof(MaxBlocksCount) _b = MaxBlocksCount; (_a < _b) ? _a : _b; });
        }
    }
    return NewFSCache;
}
...
{
    if (Cache != 
# 56 "Source\\System\\fscache.c" 3 4
                ((void *)0)
# 56 "Source\\System\\fscache.c"
                    )
    {
    ...
    return 
# 62 "Source\\System\\fscache.c" 3 4
          ((void *)0)
# 62 "Source\\System\\fscache.c"
              ;
}
...
boolean FSC_Invalidate(pFSCACHE Cache, TFSCCMD Command, uint32_t BlockIndex)
{
    ...
    if (Cache != 
# 69 "Source\\System\\fscache.c" 3 4
                ((void *)0)
# 69 "Source\\System\\fscache.c"
                    )
    {
        switch (Command)
        {
        ...
        case FSC_INVALIDATEBLOCK:
        {
            ...
            if (tmpBlock != 
# 82 "Source\\System\\fscache.c" 3 4
                           ((void *)0)
# 82 "Source\\System\\fscache.c"
                               )
            {
...
boolean FSC_StoreDataBlock(pFSCACHE Cache, uint32_t BlockIndex, void *Data)
{
    ...
    if ((Cache != 
# 98 "Source\\System\\fscache.c" 3 4
                 ((void *)0)
# 98 "Source\\System\\fscache.c"
                     ) && (Data != 
# 98 "Source\\System\\fscache.c" 3 4
                                   ((void *)0)
# 98 "Source\\System\\fscache.c"
                                       ))
    {
        ...
        if (DataBlock != 
# 102 "Source\\System\\fscache.c" 3 4
                        ((void *)0)
# 102 "Source\\System\\fscache.c"
                            )
        {
        ...
        else
        {
            ...
            if (DataBlock != 
# 110 "Source\\System\\fscache.c" 3 4
                            ((void *)0)
# 110 "Source\\System\\fscache.c"
                                )
            {
                while(DL_GetItemsCount(&Cache->BlockList) >= Cache->MaxBlocksCount)
                {
                    ...
                    if (tmpItem == 
# 116 "Source\\System\\fscache.c" 3 4
                                  ((void *)0)
# 116 "Source\\System\\fscache.c"
                                      ) break;
...
void *FSC_GetDataBlock(pFSCACHE Cache, uint32_t BlockIndex)
{
    ...
    if ((Cache != 
# 132 "Source\\System\\fscache.c" 3 4
                 ((void *)0)
# 132 "Source\\System\\fscache.c"
                     ) &&
            ((DataBlock = FSC_FindBlock(Cache, BlockIndex)) != 
# 133 "Source\\System\\fscache.c" 3 4
                                                              ((void *)0)
# 133 "Source\\System\\fscache.c"
                                                                  ))
        return DataBlock->BlockData;
    else return 
# 135 "Source\\System\\fscache.c" 3 4
               ((void *)0)
# 135 "Source\\System\\fscache.c"
                   ;
}
