# 1 "Source\\System\\evmngr.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\System\\evmngr.c"
# 21 "Source\\System\\evmngr.c"
...
# 22 "Source\\System\\evmngr.c" 2
# 1 "Source\\System\\evmngr.h" 1
# 23 "Source\\System\\evmngr.c" 2
...
static pEVENT EM_GetTopEvent(void)
{
    ...
    return (tmpItem != 
# 30 "Source\\System\\evmngr.c" 3 4
                      ((void *)0)
# 30 "Source\\System\\evmngr.c"
                          ) ? tmpItem->Data : 
# 30 "Source\\System\\evmngr.c" 3 4
                                              ((void *)0)
# 30 "Source\\System\\evmngr.c"
...
{
    if (EventsList == 
# 35 "Source\\System\\evmngr.c" 3 4
                     ((void *)0)
# 35 "Source\\System\\evmngr.c"
                         ) EventsList = DL_Create();
    if (EventsList == 
# 36 "Source\\System\\evmngr.c" 3 4
                     ((void *)0)
# 36 "Source\\System\\evmngr.c"
                         ) return false;
...
boolean EM_PostEvent(TEVTYPE Type, void *Object, void *Param, uint32_t ParamSz)
{
    ...
    if (Param == 
# 45 "Source\\System\\evmngr.c" 3 4
                ((void *)0)
# 45 "Source\\System\\evmngr.c"
                    ) ParamSz = 0;

    tmpEvent = malloc(sizeof(TEVENT) + ParamSz);
    if (tmpEvent != 
# 48 "Source\\System\\evmngr.c" 3 4
                   ((void *)0)
# 48 "Source\\System\\evmngr.c"
                       )
    {
        tmpEvent->Event = Type;
        ...
        if (Param != 
# 53 "Source\\System\\evmngr.c" 3 4
                    ((void *)0)
# 53 "Source\\System\\evmngr.c"
                        ) memcpy(tmpEvent->Param, Param, ParamSz);
...
void EM_ProcessEvents(void)
{
    ...
    while((tmpEvent = EM_GetTopEvent()) != 
# 64 "Source\\System\\evmngr.c" 3 4
                                          ((void *)0)
# 64 "Source\\System\\evmngr.c"
                                              )
    {
        ...
        case ET_ONTIMER:
            if (tmpEvent->ParamSz == sizeof(pTIMER))
            {
                ...
                if (EvTimer->Handler != 
# 97 "Source\\System\\evmngr.c" 3 4
                                       ((void *)0)
# 97 "Source\\System\\evmngr.c"
                                           ) EvTimer->Handler(EvTimer);
            }
            break;
        default:
            break;
