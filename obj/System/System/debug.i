# 1 "Source\\System\\debug.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\System\\debug.c"
# 21 "Source\\System\\debug.c"
...
# 22 "Source\\System\\debug.c" 2
# 1 "Source\\System\\debug.h" 1
# 23 "Source\\System\\debug.c" 2
...
void DBG_Initialize(void)
{
    ...
    USART_Initialize(USART_MODULE1, 460800, 
# 31 "Source\\System\\debug.c" 3 4
                                              ((void *)0)
# 31 "Source\\System\\debug.c"
                                                  , USART_EnFlag);
}
...
{
    int32_t Count = len;
    pUSART_CONTEXT USARTInf = USART_GetContext(USART_MODULE1);

    if ((USARTInf != 
# 39 "Source\\System\\debug.c" 3 4
                    ((void *)0)
# 39 "Source\\System\\debug.c"
                        ) && Count && (file == 1))
    {
        USARTInf->USART_TX_Buffer = ptr;
        USARTInf->USART_TX_Count = Count;
        USARTInf->USART_TX_Index = 0;
        USART_SendBufferPoll(USART_MODULE1);
    }
    return len;
}
...
void DBG_DumpMem32(uint32_t *Address, uint32_t Count)
{
    ...
    {
        do { printf("%08X  ", (uint32_t)Address); fflush(
# 57 "Source\\System\\debug.c" 3
       (_impure_ptr->_stdout)
# 57 "Source\\System\\debug.c"
       ); } while(0);
        for(x = 0; x < 16; x += 4)
            do { printf("%08X ", *Address++); fflush(
# 59 "Source\\System\\debug.c" 3
           (_impure_ptr->_stdout)
# 59 "Source\\System\\debug.c"
           ); } while(0);
        do { printf("\r\n"); fflush(
# 60 "Source\\System\\debug.c" 3
       (_impure_ptr->_stdout)
# 60 "Source\\System\\debug.c"
       ); } while(0);
    }
}
...
void DBG_DumpMem16(uint16_t *Address, uint32_t Count)
{
    ...
    {
        do { printf("%08X  ", (uint32_t)Address); fflush(
# 72 "Source\\System\\debug.c" 3
       (_impure_ptr->_stdout)
# 72 "Source\\System\\debug.c"
       ); } while(0);
        for(x = 0; x < 16; x += 2)
            do { printf("%04X ", *Address++); fflush(
# 74 "Source\\System\\debug.c" 3
           (_impure_ptr->_stdout)
# 74 "Source\\System\\debug.c"
           ); } while(0);
        do { printf("\r\n"); fflush(
# 75 "Source\\System\\debug.c" 3
       (_impure_ptr->_stdout)
# 75 "Source\\System\\debug.c"
       ); } while(0);
    }
}
