# 1 "Source\\System\\init.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\System\\init.c"
# 21 "Source\\System\\init.c"
...
# 22 "Source\\System\\init.c" 2
# 1 ".\\Source\\Application/appinit.h" 1
# 22 ".\\Source\\Application/appinit.h"
extern boolean APP_Initialize(void);
# 23 "Source\\System\\init.c" 2
# 1 "Source\\System\\init.h" 1
# 24 "Source\\System\\init.c" 2
...
# 30 "Source\\System\\init.c" 3
   (_impure_ptr->_stdout)
# 30 "Source\\System\\init.c"
   ); } while(0);
    ...
    do { printf("Initialize serial flash interface:\r\n"); fflush(
# 40 "Source\\System\\init.c" 3
   (_impure_ptr->_stdout)
# 40 "Source\\System\\init.c"
   ); } while(0);
    SF_Initialize();

    do { printf("Initialize system memory pool - "); fflush(
# 43 "Source\\System\\init.c" 3
   (_impure_ptr->_stdout)
# 43 "Source\\System\\init.c"
   ); } while(0);
    {
        size_t MemSize = InitializeMemoryPool();

        if (MemSize != -1) do { printf("%u KiB available\r\n", MemSize / 1024); fflush(
# 47 "Source\\System\\init.c" 3
                          (_impure_ptr->_stdout)
# 47 "Source\\System\\init.c"
                          ); } while(0);
        else do { printf("failed!\r\n"); fflush(
# 48 "Source\\System\\init.c" 3
            (_impure_ptr->_stdout)
# 48 "Source\\System\\init.c"
            ); } while(0);
    }

    do { printf("Initialize NVICs..."); fflush(
# 51 "Source\\System\\init.c" 3
   (_impure_ptr->_stdout)
# 51 "Source\\System\\init.c"
   ); } while(0);
    NVIC_Initialize();
    do { printf("Complete.\r\n"); fflush(
# 53 "Source\\System\\init.c" 3
   (_impure_ptr->_stdout)
# 53 "Source\\System\\init.c"
   ); } while(0);

    do { printf("Initialize real time clock..."); fflush(
# 55 "Source\\System\\init.c" 3
   (_impure_ptr->_stdout)
# 55 "Source\\System\\init.c"
   ); } while(0);
    RTC_Initialize();

    do { printf("Initialize event manager..."); fflush(
# 58 "Source\\System\\init.c" 3
   (_impure_ptr->_stdout)
# 58 "Source\\System\\init.c"
   ); } while(0);
    Result = EM_Initialize();
    do { printf(Result ? "Complete.\r\n" : "Failed\r\n"); fflush(
# 60 "Source\\System\\init.c" 3
   (_impure_ptr->_stdout)
# 60 "Source\\System\\init.c"
   ); } while(0);

    do { printf("Initialize low resolution timers pool..."); fflush(
# 62 "Source\\System\\init.c" 3
   (_impure_ptr->_stdout)
# 62 "Source\\System\\init.c"
   ); } while(0);
    Result = LRT_Initialize();
    do { printf(Result ? "Complete.\r\n" : "Failed\r\n"); fflush(
# 64 "Source\\System\\init.c" 3
   (_impure_ptr->_stdout)
# 64 "Source\\System\\init.c"
   ); } while(0);

    do { printf("Power management initialization"); fflush(
# 66 "Source\\System\\init.c" 3
   (_impure_ptr->_stdout)
# 66 "Source\\System\\init.c"
   ); } while(0);
    PMU_Initialize();
