# 1 "Source\\System\\lrtimer.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\System\\lrtimer.c"
# 21 "Source\\System\\lrtimer.c"
...
# 22 "Source\\System\\lrtimer.c" 2
# 1 "Source\\System\\lrtimer.h" 1
# 23 "Source\\System\\lrtimer.c" 2
...
{
    if (TimersList != 
# 30 "Source\\System\\lrtimer.c" 3 4
                     ((void *)0)
# 30 "Source\\System\\lrtimer.c"
                         )
    {
        pDLITEM tmrItem = DL_GetFirstItem(TimersList);

        while(tmrItem != 
# 34 "Source\\System\\lrtimer.c" 3 4
                        ((void *)0)
# 34 "Source\\System\\lrtimer.c"
                            )
        {
            pTIMER tmpLRT = tmrItem->Data;

            if (tmpLRT != 
# 38 "Source\\System\\lrtimer.c" 3 4
                         ((void *)0)
# 38 "Source\\System\\lrtimer.c"
                             )
            {
                if (tmpLRT->Flags & TF_ENABLED)
                {
                    ...
                    {
                        if (tmpLRT->Handler != 
# 47 "Source\\System\\lrtimer.c" 3 4
                                              ((void *)0)
# 47 "Source\\System\\lrtimer.c"
                                                  )
                        {
                            if (tmpLRT->Flags & TF_DIRECT)
                            {
                                ...
                                if ((volatile void *)tmrItem->Data == 
# 53 "Source\\System\\lrtimer.c" 3 4
                                                                     ((void *)0)
# 53 "Source\\System\\lrtimer.c"
                                                                         )
                                {
                            ...
                            else EM_PostEvent(ET_ONTIMER, 
# 62 "Source\\System\\lrtimer.c" 3 4
                                                         ((void *)0)
# 62 "Source\\System\\lrtimer.c"
                                                             , &tmpLRT, sizeof(pTIMER));
                        }
...
boolean LRT_Initialize(void)
{
    ...
    if (TimersList == 
# 95 "Source\\System\\lrtimer.c" 3 4
                     ((void *)0)
# 95 "Source\\System\\lrtimer.c"
                         ) TimersList = DL_Create();
    if (TimersList != 
# 96 "Source\\System\\lrtimer.c" 3 4
                     ((void *)0)
# 96 "Source\\System\\lrtimer.c"
                         )
    {
        if (GPT_SetupTimer(GP_TIMER1, 100, true, LRT_GPTHandler, true) &&
                GPT_StartTimer(GP_TIMER1))
            return true;
        GPT_SetupTimer(GP_TIMER1, 0, false, 
# 101 "Source\\System\\lrtimer.c" 3 4
                                              ((void *)0)
# 101 "Source\\System\\lrtimer.c"
                                                  , false);
    }
...
{
    pTIMER tmpTimer = 
# 110 "Source\\System\\lrtimer.c" 3 4
                     ((void *)0)
# 110 "Source\\System\\lrtimer.c"
                         ;

    if (Interval && (TimersList != 
# 112 "Source\\System\\lrtimer.c" 3 4
                                  ((void *)0)
# 112 "Source\\System\\lrtimer.c"
                                      ))
    {
        Interval *= 1000;

        if (Interval < (1000000 / 100)) Interval = (1000000 / 100);
        tmpTimer = malloc(sizeof(TTIMER));
        if (tmpTimer != 
# 118 "Source\\System\\lrtimer.c" 3 4
                       ((void *)0)
# 118 "Source\\System\\lrtimer.c"
                           )
        {
                                      ...
                                      &tmpTimer->ListHeader))
            {
                free(tmpTimer);
                tmpTimer = 
# 128 "Source\\System\\lrtimer.c" 3 4
                          ((void *)0)
# 128 "Source\\System\\lrtimer.c"
                              ;
            }
        }
    }
...
{
    if ((Timer != 
# 137 "Source\\System\\lrtimer.c" 3 4
                 ((void *)0)
# 137 "Source\\System\\lrtimer.c"
                     ) && (DL_GetItemIndex(TimersList, &Timer->ListHeader) != -1))
    {
        uint32_t intflags = __disable_interrupts();

        __secure_memset(&Timer->Flags, 0x00, sizeof(TTIMER) - 
# 141 "Source\\System\\lrtimer.c" 3 4
                                                             __builtin_offsetof (
# 141 "Source\\System\\lrtimer.c"
                                                             TTIMER
# 141 "Source\\System\\lrtimer.c" 3 4
                                                             , 
# 141 "Source\\System\\lrtimer.c"
...
# 141 "Source\\System\\lrtimer.c"
        ...
        if (__is_in_isr_mode())
        {
            Timer->ListHeader.Data = 
# 145 "Source\\System\\lrtimer.c" 3 4
                                    ((void *)0)
# 145 "Source\\System\\lrtimer.c"
                                        ;
            DL_MoveItemToIndex(TimersList, 0, &Timer->ListHeader);
        }
        else DL_DeleteItem(TimersList, &Timer->ListHeader);
...
{
    if (Timer != 
# 158 "Source\\System\\lrtimer.c" 3 4
                ((void *)0)
# 158 "Source\\System\\lrtimer.c"
                    )
    {
...
{
    if (Timer != 
# 176 "Source\\System\\lrtimer.c" 3 4
                ((void *)0)
# 176 "Source\\System\\lrtimer.c"
                    )
    {
        if (Timer->Flags & TF_ENABLED)
        {
...
{
    if (Timer != 
# 193 "Source\\System\\lrtimer.c" 3 4
                ((void *)0)
# 193 "Source\\System\\lrtimer.c"
                    )
    {
        uint32_t iflags = __disable_interrupts();
...
{
    if (Timer != 
# 211 "Source\\System\\lrtimer.c" 3 4
                ((void *)0)
# 211 "Source\\System\\lrtimer.c"
                    )
    {
        uint32_t iflags = __disable_interrupts();
