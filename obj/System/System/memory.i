# 1 "Source\\System\\memory.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\System\\memory.c"
# 21 "Source\\System\\memory.c"
...
# 22 "Source\\System\\memory.c" 2
# 1 "Source\\System\\tlsf.h" 1
# 29 "Source\\System\\tlsf.h"
...
# 23 "Source\\System\\memory.c" 2
# 1 "Source\\System\\memory.h" 1
# 24 "Source\\System\\memory.c" 2

static uint8_t MemoryPool[(3 * 1024 * 1024)] __attribute__ ((aligned (8), section (".noinit")));
...
size_t InitializeMemoryPool(void)
{
    ...
    Result = init_memory_pool((3 * 1024 * 1024), MemoryPool);
...
boolean IsDynamicMemory(void *Memory)
{
    return (((uintptr_t)Memory >= (uintptr_t)&MemoryPool[0]) &&
            ((uintptr_t)Memory <= (uintptr_t)&MemoryPool[(3 * 1024 * 1024) - 1])) ? true : false;
}
