# 1 "Source\\Lib\\USB\\usb9.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\Lib\\USB\\usb9.c"
# 21 "Source\\Lib\\USB\\usb9.c"
...
# 22 "Source\\Lib\\USB\\usb9.c" 2
# 1 ".\\Source\\Lib\\MT6261\\Drivers/usb.h" 1
# 23 "Source\\Lib\\USB\\usb9.c" 2
...
static boolean USB9_GetDescriptor(pUSBSETUP Setup)
{
    ...
    {
        switch (Setup->wValue & 0xFF00)
        {
        case (0x01 << 8):
            USB_PrepareDataTransmit(USB_EP0, DevInterface->DeviceDescriptor,
                                    ({ typeof(18) _a = 18; typeof(Setup->wLength) _b = Setup->wLength; (_a < _b) ? _a : _b; }));
            break;
        case (0x02 << 8):
            USB_PrepareDataTransmit(USB_EP0, DevInterface->ConfigDescriptor,
                                    ({ typeof(DevInterface->ConfigDescriptor->wTotalLength) _a = DevInterface->ConfigDescriptor->wTotalLength; typeof(Setup->wLength) _b = Setup->wLength; (_a < _b) ? _a : _b; }));
            break;
        case (0x03 << 8):
        {
            ...
            if (String == 
# 51 "Source\\Lib\\USB\\usb9.c" 3 4
                         ((void *)0)
# 51 "Source\\Lib\\USB\\usb9.c"
                             ) Error = true;
            else USB_PrepareDataTransmit(USB_EP0, String, ({ typeof(String->bLength) _a = String->bLength; typeof(Setup->wLength) _b = Setup->wLength; (_a < _b) ? _a : _b; }));
        }
        break;
        default:
            Error = true;
...
static boolean USB9_ClearFeature(pUSBSETUP Setup)
{
    ...
    switch (Setup->bmRequestType & 0x03)
    {
    case 0x02:
    {
        uint8_t EPIndex = Setup->wIndex & 0x000F;
...
static void USB9_HandleStdRequest(pUSBSETUP Setup)
{
    ...
    case 0x0A:
        if ((USB_GetDeviceState() < USB_DEVICE_CONFIGURED) ||
                (DevInterface->GetAltInterface == 
# 195 "Source\\Lib\\USB\\usb9.c" 3 4
                                                 ((void *)0)
# 195 "Source\\Lib\\USB\\usb9.c"
                                                     )) Error = true;
        else
        {
            ...
            if (AltInterfIndex == 
# 200 "Source\\Lib\\USB\\usb9.c" 3 4
                                 ((void *)0)
# 200 "Source\\Lib\\USB\\usb9.c"
                                     ) Error = true;
    ...
    case 0x0B:
        if ((USB_GetDeviceState() < USB_DEVICE_CONFIGURED) ||
                (DevInterface->SetAltInterface == 
# 206 "Source\\Lib\\USB\\usb9.c" 3 4
                                                 ((void *)0)
# 206 "Source\\Lib\\USB\\usb9.c"
                                                     )) Error = true;
...
void USB9_HandleSetupRequest(pUSBSETUP Setup)
{
    ...
    case 0x00:
        ...
        break;
    case 0x20:
        if (DevInterface->InterfaceReqHandler != 
# 226 "Source\\Lib\\USB\\usb9.c" 3 4
                                                ((void *)0)
# 226 "Source\\Lib\\USB\\usb9.c"
                                                    )
            DevInterface->InterfaceReqHandler(Setup);
        else USB_UpdateEPState(USB_EP0, USB_DIR_OUT, true, false);
        break;
    case 0x40:
        if (DevInterface->VendorReqHandler != 
# 231 "Source\\Lib\\USB\\usb9.c" 3 4
                                             ((void *)0)
# 231 "Source\\Lib\\USB\\usb9.c"
                                                 )
...
boolean USB9_InterfaceInitialize(void)
{
    ...
    DevInterface = USB_CDC_Initialize();

    return (DevInterface != 
# 246 "Source\\Lib\\USB\\usb9.c" 3 4
                           ((void *)0)
# 246 "Source\\Lib\\USB\\usb9.c"
                               );
