# 1 "Source\\Lib\\MT6261\\Drivers\\msdc.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\Lib\\MT6261\\Drivers\\msdc.c"
# 21 "Source\\Lib\\MT6261\\Drivers\\msdc.c"
...
# 22 "Source\\Lib\\MT6261\\Drivers\\msdc.c" 2
# 1 "Source\\Lib\\MT6261\\Drivers\\msdc.h" 1
# 23 "Source\\Lib\\MT6261\\Drivers\\msdc.c" 2

static TMSDCCONTEXT MSDCCONTEXT[MSDC_ITFNUM] =
{
    {((volatile TMSDCREGS*)0xA0130000), (0x13)},
    {((volatile TMSDCREGS*)0xA0270000), (0x2A)}
};

static TMSDCCONTEXT *MSDC_GetModuleContext(TMSDC Index)
{
    if (Index >= MSDC_ITFNUM) return 
# 32 "Source\\Lib\\MT6261\\Drivers\\msdc.c" 3 4
                                    ((void *)0)
# 32 "Source\\Lib\\MT6261\\Drivers\\msdc.c"
                                        ;
...
{
    Context->MSDC->MSDC_CFG |= (1 << 1);
    USC_Pause_us(2000);
    Context->MSDC->MSDC_CFG &= ~((1 << 1) | (1 << 0));
}

static void MSDC_ClockInit(TMSDCCONTEXT *Context)
{
    Context->MSDC->CLK_RED &= ~(1 << 7);
    Context->MSDC->SDC_CFG = (Context->MSDC->SDC_CFG & ~(((-1) & 0xFF) << 24)) | (((80) & 0xFF) << 24);
}
