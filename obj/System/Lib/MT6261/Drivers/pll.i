# 1 "Source\\Lib\\MT6261\\Drivers\\pll.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\Lib\\MT6261\\Drivers\\pll.c"
# 21 "Source\\Lib\\MT6261\\Drivers\\pll.c"
...
# 22 "Source\\Lib\\MT6261\\Drivers\\pll.c" 2
# 1 "Source\\Lib\\MT6261\\Drivers\\pll.h" 1
# 23 "Source\\Lib\\MT6261\\Drivers\\pll.c" 2
...
void PLL_Initialize(void)
{
    ...
    (*(volatile uint16_t *)(0xA0170000 + 0x0048)) = 0x0000;

    (*(volatile uint16_t *)(0xA0170000 + 0x004C)) = 0x0000;


    (*(volatile uint16_t *)(0xA0170000 + 0x0700)) = 0x0000;


    USC_Pause_us(1);


    tmp = (*(volatile uint16_t *)(0xA0170000 + 0x0140));
    tmp |= 0x0001;
    (*(volatile uint16_t *)(0xA0170000 + 0x0140)) = tmp;


    (*(volatile uint16_t *)(0xA0170000 + 0x0100)) = 0x1400;

    (*(volatile uint16_t *)(0xA0170000 + 0x0104)) = 0x0000;


    (*(volatile uint16_t *)(0xA0170000 + 0x0640)) = 0x0001;


    tmp = (*(volatile uint16_t *)(0xA0170000 + 0x0100));
    tmp |= 0x0001;
    (*(volatile uint16_t *)(0xA0170000 + 0x0100)) = tmp;


    USC_Pause_us(50);


    tmp = (*(volatile uint16_t *)(0xA0170000 + 0x0050));
    tmp &= 0xFFFB;
    (*(volatile uint16_t *)(0xA0170000 + 0x0050)) = tmp;


    (*(volatile uint32_t *)(0xA0010000 + 0x011C)) = 0xD000;

    (*(volatile uint32_t *)(0xA0010000 + 0x0108)) = 0x8008;
    ...
    (*(volatile uint32_t *)(0xA0010000 + 0x0108)) = 0xB620;
