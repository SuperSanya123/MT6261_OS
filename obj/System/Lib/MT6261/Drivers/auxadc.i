# 1 "Source\\Lib\\MT6261\\Drivers\\auxadc.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\Lib\\MT6261\\Drivers\\auxadc.c"
# 21 "Source\\Lib\\MT6261\\Drivers\\auxadc.c"
...
# 22 "Source\\Lib\\MT6261\\Drivers\\auxadc.c" 2
# 1 "Source\\Lib\\MT6261\\Drivers\\auxadc.h" 1
# 23 "Source\\Lib\\MT6261\\Drivers\\auxadc.c" 2
...
static boolean AUXADC_WaitBusy(void)
{
    ...
    while(((*(volatile uint16_t *)(0xA0790000 + 0x000C)) & (1 << 0)) &&
            ((CurrentTicks = USC_GetCurrentTicks()) - tmpUSTicks < 50000));

    return (CurrentTicks - tmpUSTicks < 50000);
}

boolean AUXADC_Enable(void)
{
    do { typeof((0x32)) _x = (0x32); if (_x <= (0x2E)) { (*(volatile uint16_t *)(0xA0010000 + 0x0320 + 0x04 * (_x >> 4))) = (1UL << (_x & 0x0F)); } else if (_x <= (0x34)) { (*(volatile uint16_t *)(0xA0730000 + 0x0010)) = (1UL << (_x & 0x0F)); } } while(0);

    (*(volatile uint16_t *)(0xA0790000 + 0x000C)) = (1 << 7);
    (*(volatile uint16_t *)(0xA0790000 + 0x000C)) &= ~(1 << 7);

    (*(volatile uint16_t *)(0xA0790000 + 0x0000)) = 0;
    (*(volatile uint16_t *)(0xA0790000 + 0x0004)) = 0;
    (*(volatile uint16_t *)(0xA0790000 + 0x0008)) = 0;
...
void AUXADC_Disable(void)
{
    ...
    do { typeof((0x32)) _x = (0x32); if (_x <= (0x2E)) { (*(volatile uint16_t *)(0xA0010000 + 0x0310 + 0x04 * (_x >> 4))) = (1UL << (_x & 0x0F)); } else if (_x <= (0x34)) { (*(volatile uint16_t *)(0xA0730000 + 0x000C)) = (1UL << (_x & 0x0F)); } } while(0);
}

uint16_t AUXADC_MeasureChannel(uint16_t Channel)
{
    uint16_t Mask = ((1 << Channel) & 0xF23F);
    uint16_t Result = 0;

    if (Mask)
    {
        (*(volatile uint16_t *)(0xA0790000 + 0x0004)) &= ~Mask;
        (*(volatile uint16_t *)(0xA0790000 + 0x0004)) |= Mask;
        if (AUXADC_WaitBusy()) Result = (*(volatile uint16_t *)(0xA0790000 + 0x0010 + 4 * (Channel)));
    }
    return Result;
}
...
{
    uint16_t Mask = ChannelsMask & 0xF23F;

    if (DataArray != 
# 81 "Source\\Lib\\MT6261\\Drivers\\auxadc.c" 3 4
                    ((void *)0)
# 81 "Source\\Lib\\MT6261\\Drivers\\auxadc.c"
                        )
    {
        (*(volatile uint16_t *)(0xA0790000 + 0x0004)) &= ~Mask;
        (*(volatile uint16_t *)(0xA0790000 + 0x0004)) |= Mask;
        if (AUXADC_WaitBusy())
        {
            ...
            {
                if (Mask & 0x0001)
                    *DataArray++ = (*(volatile uint16_t *)(0xA0790000 + 0x0010 + 4 * (i)));
            }
            return true;
        }
    }
