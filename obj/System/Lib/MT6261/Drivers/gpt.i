# 1 "Source\\Lib\\MT6261\\Drivers\\gpt.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\Lib\\MT6261\\Drivers\\gpt.c"
# 21 "Source\\Lib\\MT6261\\Drivers\\gpt.c"
...
# 22 "Source\\Lib\\MT6261\\Drivers\\gpt.c" 2
# 1 "Source\\Lib\\MT6261\\Drivers\\gpt.h" 1
# 23 "Source\\Lib\\MT6261\\Drivers\\gpt.c" 2

static TGPTSTATE GPTStatus;

static uint16_t GPT_GetStatus(void)
{
    return (*(volatile uint32_t *)(0xA00C0000 + 0x0010));
}

static void GPT_PowerUp(void)
{
    do { typeof((0x22)) _x = (0x22); if (_x <= (0x2E)) { (*(volatile uint16_t *)(0xA0010000 + 0x0320 + 0x04 * (_x >> 4))) = (1UL << (_x & 0x0F)); } else if (_x <= (0x34)) { (*(volatile uint16_t *)(0xA0730000 + 0x0010)) = (1UL << (_x & 0x0F)); } } while(0);
}

static void GPT_PowerDown(void)
{
    do { typeof((0x22)) _x = (0x22); if (_x <= (0x2E)) { (*(volatile uint16_t *)(0xA0010000 + 0x0310 + 0x04 * (_x >> 4))) = (1UL << (_x & 0x0F)); } else if (_x <= (0x34)) { (*(volatile uint16_t *)(0xA0730000 + 0x000C)) = (1UL << (_x & 0x0F)); } } while(0);
}

static boolean GPT_IsPoweredUp(void)
{
    return PCTL_GetPeripheralPowerStatus((0x22));
}
...
static void GPT_InterruptHandler(void)
{
    ...
    do
    {
        if ((Status & (1 << 0)) && (GPTStatus.GPT.GPT1_Handler != 
# 57 "Source\\Lib\\MT6261\\Drivers\\gpt.c" 3 4
                                                                ((void *)0)
# 57 "Source\\Lib\\MT6261\\Drivers\\gpt.c"
                                                                    )) GPTStatus.GPT.GPT1_Handler();
        if ((Status & (1 << 1)) && (GPTStatus.GPT.GPT2_Handler != 
# 58 "Source\\Lib\\MT6261\\Drivers\\gpt.c" 3 4
                                                                ((void *)0)
# 58 "Source\\Lib\\MT6261\\Drivers\\gpt.c"
                                                                    )) GPTStatus.GPT.GPT2_Handler();
...
static boolean GPT_RegisterInterrupt(void)
{
    ...
    GPTStatus.GPT.GPTIntsRegistered = NVIC_RegisterIRQ(0x17, GPT_InterruptHandler,
                                      0, true, true);
...
static boolean GPT_TryUnregisterInterrupt(void)
{
    ...
    if ((GPTStatus.GPT.GPT1_Handler != 
# 79 "Source\\Lib\\MT6261\\Drivers\\gpt.c" 3 4
                                      ((void *)0)
# 79 "Source\\Lib\\MT6261\\Drivers\\gpt.c"
                                          ) ||
            (GPTStatus.GPT.GPT2_Handler != 
# 80 "Source\\Lib\\MT6261\\Drivers\\gpt.c" 3 4
                                          ((void *)0)
# 80 "Source\\Lib\\MT6261\\Drivers\\gpt.c"
                                              )) return false;


    GPTStatus.GPT.GPTIntsRegistered = !NVIC_UnregisterIRQ(0x17);
...
void GPT_InitializeTimers(void)
{
    ...
    (*(volatile uint32_t *)(0xA00C0000 + 0x0000)) = 0;
    (*(volatile uint32_t *)(0xA00C0000 + 0x0008)) = 0;
    if (!((*(volatile uint32_t *)(0xA00C0000 + 0x0028)) & (1 << 1))) (*(volatile uint32_t *)(0xA00C0000 + 0x0028)) &= ~(1 << 0);
    memset(&GPTStatus, 0x00, sizeof(GPTStatus));
    GPTStatus.GPT.GPT4_Enabled = !!((*(volatile uint32_t *)(0xA00C0000 + 0x0028)) & (1 << 0));
...
boolean GPT_StartTimer(TGPT Index)
{
    ...
    {
    case GP_TIMER1:
        (*(volatile uint32_t *)(0xA00C0000 + 0x0000)) |= (1 << 15);
        Result = GPTStatus.GPT.GPT1_Enabled = !!((*(volatile uint32_t *)(0xA00C0000 + 0x0000)) & (1 << 15));
        break;
    case GP_TIMER2:
        (*(volatile uint32_t *)(0xA00C0000 + 0x0008)) |= (1 << 15);
        Result = GPTStatus.GPT.GPT2_Enabled = !!((*(volatile uint32_t *)(0xA00C0000 + 0x0008)) & (1 << 15));
        break;
    case GP_TIMER4:
        if (!((*(volatile uint32_t *)(0xA00C0000 + 0x0028)) & (1 << 1))) (*(volatile uint32_t *)(0xA00C0000 + 0x0028)) |= (1 << 0);
        Result = GPTStatus.GPT.GPT4_Enabled = !!((*(volatile uint32_t *)(0xA00C0000 + 0x0028)) & (1 << 0));
        break;
    }
...
boolean GPT_StopTimer(TGPT Index)
{
    ...
    case GP_TIMER1:
        (*(volatile uint32_t *)(0xA00C0000 + 0x0000)) &= ~(1 << 15);
        Result = !(GPTStatus.GPT.GPT1_Enabled = ((*(volatile uint32_t *)(0xA00C0000 + 0x0000)) & (1 << 15)) ? true : false);
        break;
    case GP_TIMER2:
        (*(volatile uint32_t *)(0xA00C0000 + 0x0008)) &= ~(1 << 15);
        Result = !(GPTStatus.GPT.GPT2_Enabled = ((*(volatile uint32_t *)(0xA00C0000 + 0x0008)) & (1 << 15)) ? true : false);
        break;
    case GP_TIMER4:
        if (!((*(volatile uint32_t *)(0xA00C0000 + 0x0028)) & (1 << 1))) (*(volatile uint32_t *)(0xA00C0000 + 0x0028)) &= ~(1 << 0);
        Result = !(GPTStatus.GPT.GPT4_Enabled = ((*(volatile uint32_t *)(0xA00C0000 + 0x0028)) & (1 << 15)) ? true : false);
        break;
    }
...
boolean GPT_DisableTimer(TGPT Index)
{
    ...
    if (Result && GPTStatus.GPT.GPTIntsRegistered)
    {
        ...
        case GP_TIMER1:
            if (GPTStatus.GPT.GPT1_Handler != 
# 163 "Source\\Lib\\MT6261\\Drivers\\gpt.c" 3 4
                                             ((void *)0)
# 163 "Source\\Lib\\MT6261\\Drivers\\gpt.c"
                                                 )
            {
                GPTStatus.GPT.GPT1_Handler = 
# 165 "Source\\Lib\\MT6261\\Drivers\\gpt.c" 3 4
                                            ((void *)0)
# 165 "Source\\Lib\\MT6261\\Drivers\\gpt.c"
                                                ;
                GPT_TryUnregisterInterrupt();
            }
            break;
        case GP_TIMER2:
            if (GPTStatus.GPT.GPT2_Handler != 
# 170 "Source\\Lib\\MT6261\\Drivers\\gpt.c" 3 4
                                             ((void *)0)
# 170 "Source\\Lib\\MT6261\\Drivers\\gpt.c"
                                                 )
            {
                GPTStatus.GPT.GPT2_Handler = 
# 172 "Source\\Lib\\MT6261\\Drivers\\gpt.c" 3 4
                                            ((void *)0)
# 172 "Source\\Lib\\MT6261\\Drivers\\gpt.c"
                                                ;
                GPT_TryUnregisterInterrupt();
            }
            break;
...
{
    return (GPTStatus.GPT.GPT4_Enabled) ? (*(volatile uint32_t *)(0xA00C0000 + 0x002C)) : 0;
}
...
boolean GPT_SetupTimer(TGPT Index, uint16_t Frequency, boolean Arepeat, void (*Handler)(void), boolean Start)
{
    ...
    case GP_TIMER1:
        if (!GPT_IsPoweredUp()) GPT_PowerUp();
        (*(volatile uint32_t *)(0xA00C0000 + 0x0000)) = 0;
        GPTStatus.GPT.GPT1_Enabled = !!((*(volatile uint32_t *)(0xA00C0000 + 0x0000)) & (1 << 15));

        if (Frequency > (16384 >> 1)) break;
        if (!Frequency)
        {
            GPTStatus.GPT.GPT1_Handler = 
# 203 "Source\\Lib\\MT6261\\Drivers\\gpt.c" 3 4
                                        ((void *)0)
# 203 "Source\\Lib\\MT6261\\Drivers\\gpt.c"
                                            ;
            GPT_TryUnregisterInterrupt();
            break;
        }

        GPTValue = 16384 / Frequency - 1;
        if ((16384 % Frequency) >= (Frequency >> 1)) GPTValue++;

        GPTStatus.GPT.GPT1_Handler = Handler;
        GPTStatus.GPT.GPT1_AutoRep = Arepeat;
        GPTStatus.GPT.GPT1_Prescaler = 0;
        GPTStatus.GPT.GPT1_Value = GPTValue;

        (*(volatile uint32_t *)(0xA00C0000 + 0x0014)) = (((GPTStatus.GPT.GPT1_Prescaler) & 0x07) << 0);
        (*(volatile uint32_t *)(0xA00C0000 + 0x0004)) = GPTStatus.GPT.GPT1_Value;

        if (!GPTStatus.GPT.GPTIntsRegistered && (Handler != 
# 219 "Source\\Lib\\MT6261\\Drivers\\gpt.c" 3 4
                                                           ((void *)0)
# 219 "Source\\Lib\\MT6261\\Drivers\\gpt.c"
                                                               )) GPT_RegisterInterrupt();
        else GPT_TryUnregisterInterrupt();

        (*(volatile uint32_t *)(0xA00C0000 + 0x0000)) = ((Arepeat) ? (1 << 14) : (0 << 14));
        if (Start) (*(volatile uint32_t *)(0xA00C0000 + 0x0000)) |= (1 << 15);
        GPTStatus.GPT.GPT1_Enabled = !!((*(volatile uint32_t *)(0xA00C0000 + 0x0000)) & (1 << 15));
        Result = true;
        break;
    case GP_TIMER2:
        if (!GPT_IsPoweredUp()) GPT_PowerUp();
        (*(volatile uint32_t *)(0xA00C0000 + 0x0008)) = 0;
        GPTStatus.GPT.GPT2_Enabled = !!((*(volatile uint32_t *)(0xA00C0000 + 0x0008)) & (1 << 15));

        if (Frequency > (16384 >> 1)) break;
        if (!Frequency)
        {
            GPTStatus.GPT.GPT2_Handler = 
# 235 "Source\\Lib\\MT6261\\Drivers\\gpt.c" 3 4
                                        ((void *)0)
# 235 "Source\\Lib\\MT6261\\Drivers\\gpt.c"
                                            ;
            GPT_TryUnregisterInterrupt();
            break;
        }
        ...
        GPTStatus.GPT.GPT2_Prescaler = 0;
        GPTStatus.GPT.GPT2_Value = GPTValue;

        (*(volatile uint32_t *)(0xA00C0000 + 0x0018)) = (((GPTStatus.GPT.GPT2_Prescaler) & 0x07) << 0);
        (*(volatile uint32_t *)(0xA00C0000 + 0x000C)) = GPTStatus.GPT.GPT2_Value;

        if (!GPTStatus.GPT.GPTIntsRegistered && (Handler != 
# 251 "Source\\Lib\\MT6261\\Drivers\\gpt.c" 3 4
                                                           ((void *)0)
# 251 "Source\\Lib\\MT6261\\Drivers\\gpt.c"
                                                               )) GPT_RegisterInterrupt();
        else GPT_TryUnregisterInterrupt();

        (*(volatile uint32_t *)(0xA00C0000 + 0x0008)) = ((Arepeat) ? (1 << 14) : (0 << 14));
        if (Start) (*(volatile uint32_t *)(0xA00C0000 + 0x0008)) |= (1 << 15);
        GPTStatus.GPT.GPT2_Enabled = !!((*(volatile uint32_t *)(0xA00C0000 + 0x0008)) & (1 << 15));
        Result = true;
        break;
    default:
...
void GPT_SleepTimers(void)
{
    ...
    {
        if (GPTStatus.GPT.GPT1_Enabled) (*(volatile uint32_t *)(0xA00C0000 + 0x0000)) &= ~(1 << 15);
        if (GPTStatus.GPT.GPT2_Enabled) (*(volatile uint32_t *)(0xA00C0000 + 0x0008)) &= ~(1 << 15);
        if (!((*(volatile uint32_t *)(0xA00C0000 + 0x0028)) & (1 << 1)) && GPTStatus.GPT.GPT4_Enabled) (*(volatile uint32_t *)(0xA00C0000 + 0x0028)) &= ~(1 << 0);
        GPT_PowerDown();

        if (GPTStatus.GPT.GPTIntsRegistered) NVIC_DisableIRQ(0x17);
...
void GPT_ResumeTimers(void)
{
    if (GPTStatus.GPTEnabled)
    {
        ...
        if (GPTStatus.GPT.GPTIntsRegistered) NVIC_EnableIRQ(0x17);
