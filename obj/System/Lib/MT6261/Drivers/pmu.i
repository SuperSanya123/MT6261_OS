# 1 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
# 21 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
...
# 22 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 2
# 1 "Source\\Lib\\MT6261\\Drivers\\pmu.h" 1
# 23 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 2
# 42 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
typedef struct
{
    uint16_t Limit;
    uint8_t BitValue;
...
static uint16_t MathVBatArray[128];
static uint16_t MathISenseArray[128];
...
{
    return !!((*(volatile uint16_t *)(0xA0700000 + 0x0A00)) & (1 << 4));
}

static void PMU_ChargerEnable(boolean Enable)
{
    int8_t ParamIndex = PMU_GetChargingParams(200);

    (*(volatile uint16_t *)(0xA0700000 + 0x0A3C)) = (ParamIndex != -1) ? BatCurrentLimits[ParamIndex].USBDLMaxCurrent : 0;
    (*(volatile uint16_t *)(0xA0700000 + 0x0A00)) = (((0x09) & 0x0F) << 12) | (((0x02) & 0x0F) << 8);
    (*(volatile uint16_t *)(0xA0700000 + 0x0A04)) = (((0x10) & 0x1F) << 8) | (((0x00) & 0x03) << 4);
    (*(volatile uint16_t *)(0xA0700000 + 0x0A14)) = ((*(volatile uint16_t *)(0xA0700000 + 0x0A14)) & ~(((-1) & 0x07) << 4)) | (((1) & 0x07) << 4) | (1 << 1) | (1 << 0);
    (*(volatile uint16_t *)(0xA0700000 + 0x0A28)) = (1 << 4);
    (*(volatile uint16_t *)(0xA0700000 + 0x0A30)) = (((4) & 0x3F) << 8) | (1 << 7) | (1 << 6) | (1 << 2);

    (*(volatile uint16_t *)(0xA0700000 + 0x0A2C)) = (1 << 11);

    PMU_SetChargerWDTEnabled(false);

    if (Enable && (ParamIndex != -1) && PMU_IsChargerConnected())
    {
        (*(volatile uint16_t *)(0xA0700000 + 0x0A04)) |= (1 << 1) | (1 << 0);
        (*(volatile uint16_t *)(0xA0700000 + 0x0A08)) = (1 << 8) | (((BatCurrentLimits[ParamIndex].BitValue) & 0x0F) << 0);
        (*(volatile uint16_t *)(0xA0700000 + 0x0A10)) = (((3) & 0x07) << 12) | (((0) & 0x07) << 8) |
                   (((0) & 0x07) << 4) | (((0) & 0x07) << 0);
        (*(volatile uint16_t *)(0xA0700000 + 0x0A28)) |= (1 << 6) | (1 << 5);
        (*(volatile uint16_t *)(0xA0700000 + 0x0A00)) |= (1 << 4) | (1 << 3);
    }
    else
    {
        (*(volatile uint16_t *)(0xA0700000 + 0x0A00)) &= ~((1 << 3) | (1 << 4));
        (*(volatile uint16_t *)(0xA0700000 + 0x0A04)) &= ~((1 << 1) | (1 << 0));
        (*(volatile uint16_t *)(0xA0700000 + 0x0A08)) &= (1 << 8);
        (*(volatile uint16_t *)(0xA0700000 + 0x0A28)) &= ~((1 << 6) | (1 << 5));
    }
}
...
static void PMU_MeasureChargeParams(void)
{
    ...
    for(i = 0; i < 128; i++)
    {
        AUXADC_MeasureMultiple(tmpADCValues, (1 << 1) | (1 << 0));
        MathVBatArray[i] = tmpADCValues[0];
        MathISenseArray[i] = tmpADCValues[1];
    }

    tmpADCValues[0] = PMU_FilterADCMeasures(MathVBatArray, 128, 4);
    tmpADCValues[1] = PMU_FilterADCMeasures(MathISenseArray, 128, 4);

    VBat = (5600 * tmpADCValues[0]) / 0x03FF;
    tmpValue = (5600 * tmpADCValues[1]) / 0x03FF;
    ISense = (tmpValue >= VBat) ? 5 * (tmpValue - VBat) : 0;

    tmpValue = (VBat < 3100) ? 0 : VBat - 3100;
    tmpValue = ({ typeof((1000 * tmpValue) / (4000 - 3100)) _a = (1000 * tmpValue) / (4000 - 3100); typeof(1000) _b = 1000; (_a < _b) ? _a : _b; });
...
static void PMU_ChargerTimerHandler(pTIMER Timer)
{
    ...
    {
        do { printf("PMU charger %s!\r\n", (ChargerState) ? "connected" : "disconnected"); fflush(
# 202 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3
       (_impure_ptr->_stdout)
# 202 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
       ); } while(0);
    ...
    if (ChargerState)
    {
        if ((*(volatile uint16_t *)(0xA0700000 + 0x0A04)) & (1 << 2))
        {
            if ((*(volatile uint16_t *)(0xA0700000 + 0x0A04)) & (1 << 1))
                (*(volatile uint16_t *)(0xA0700000 + 0x0A04)) &= ~(1 << 1);
        }
        if (ISense)
        {
            if (ISense <= 25)
            {
                ...
                if (BatteryCharging)
                    do { printf("PMU charging complete!\r\n"); fflush(
# 222 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3
                   (_impure_ptr->_stdout)
# 222 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
                   ); } while(0);
            }
            else if (ChargeOnDebounce < (3 * 2)) ChargeOnDebounce++;
        }
        else
        {
            ...
            if (VBat < 3800)
            {
                ...
                {
                    do { printf("PMU restart charging!\r\n"); fflush(
# 234 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3
                   (_impure_ptr->_stdout)
# 234 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
                   ); } while(0);
                    if (PMU_IsChargerEnabled()) PMU_ChargerEnable(false);
                    PMU_ChargerEnable(true);
                    RechargeTimeout = (10 * 2);
                }
            }
    ...
    if (BatteryCharging != (ChargeOnDebounce == (3 * 2)))
    {
        if (!BatteryCharging && (ChargeOnDebounce == (3 * 2)))
        {
            BatteryCharging = true;
            do { printf("PMU charging started!\r\n"); fflush(
# 250 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3
           (_impure_ptr->_stdout)
# 250 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
           ); } while(0);
        }
...
static void PMU_PWRKeyInterruptHandler(void)
{
    ...
    if (PWRKEYAppHandler != 
# 266 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3 4
                           ((void *)0)
# 266 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
                               )
...
{
    return ((*(volatile uint16_t *)(0xA0700000 + 0x0A80)) & (1 << 15)) ? false : true;
}
...
void PMU_SetPWRKEYLongPressFunction(TLPFUNC Function, boolean Enabled)
{
    ...
    do { printf("PWRKEY long press function set to "); fflush(
# 290 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3
   (_impure_ptr->_stdout)
# 290 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
   ); } while(0);

    if (Function == LPF_REBOOT) (*(volatile uint16_t *)(0xA0700000 + 0x0F00)) &= ~(1 << 6);
    else if (Function == LPF_SHUTDOWN) (*(volatile uint16_t *)(0xA0700000 + 0x0F00)) |= (1 << 6);
    else return;

    (*(volatile uint16_t *)(0xA0700000 + 0x0F00)) = ((*(volatile uint16_t *)(0xA0700000 + 0x0F00)) & ~(1 << 0)) | (Enabled) ? (1 << 0) : 0;

    (*(volatile uint16_t *)(0xA0700000 + 0x0F00)) &= ~(1 << 4);
    (*(volatile uint16_t *)(0xA0700000 + 0x0F00)) |= (1 << 4);
    (*(volatile uint16_t *)(0xA0700000 + 0x0F00)) &= ~(1 << 4);

    do { printf("%s\r\n", (Function == LPF_REBOOT) ? "LPF_REBOOT" : "LPF_SHUTDOWN"); fflush(
# 302 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3
   (_impure_ptr->_stdout)
# 302 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
   ); } while(0);
...
{
    (*(volatile uint16_t *)(0xA0700000 + 0x0A24)) |= (1 << 5);
    if (Enabled) (*(volatile uint16_t *)(0xA0700000 + 0x0A24)) |= (1 << 4);
    else (*(volatile uint16_t *)(0xA0700000 + 0x0A24)) &= ~(1 << 4);

    while((*(volatile uint16_t *)(0xA0700000 + 0x0A24)) & (1 << 15)) {}

    (*(volatile uint16_t *)(0xA0700000 + 0x0A24)) |= (1 << 9);
}

void PMU_SetChargerWDTInterval(uint8_t Interval)
{
    (*(volatile uint16_t *)(0xA0700000 + 0x0A24)) = ((*(volatile uint16_t *)(0xA0700000 + 0x0A24)) & ~(((-1) & 0x0F) << 0)) | (((Interval) & 0x0F) << 0) | (1 << 5);
...
{
    return ((*(volatile uint16_t *)(0xA0700000 + 0x0A00)) & (1 << 5)) ? true : false;
}
...
{
    (*(volatile uint16_t *)(0xA0700000 + 0x0A28)) &= ~((1 << 15) | (1 << 14));
    (*(volatile uint16_t *)(0xA0700000 + 0x0A80)) |= (1 << 4);
}
...
void PMU_DisableUSBDLMode(void)
{
    ...
    (*(volatile uint16_t *)(0xA0700000 + 0x0A28)) = ((*(volatile uint16_t *)(0xA0700000 + 0x0A28)) & ~(1 << 15)) | (1 << 14);
...
void PMU_SetVibrationOutput(boolean Enable)
{
    ...
    uint16_t En = (Enable) ? (1 << 0) : 0;


    (*(volatile uint16_t *)(0xA0700000 + 0x01B0)) = (((0) & 0x03) << 4) | (1 << 1) | En;
...
{
    if (UsePWM) (*(volatile uint16_t *)(0xA0700000 + 0x0C00)) = (0 << 0);
    else (*(volatile uint16_t *)(0xA0700000 + 0x0C00)) = (1 << 0);
}
...
void PMU_SetISINKOutput(ISINKCHNL Channel, boolean Enable)
{
    ...
    if (Channel == ISINK_CH0) ISINK_CON = &(*(volatile uint16_t *)(0xA0700000 + 0x0C10));
    else if (Channel == ISINK_CH1) ISINK_CON = &(*(volatile uint16_t *)(0xA0700000 + 0x0C20));
    else return;

    if (Enable) *ISINK_CON |= (1 << 0);
    else *ISINK_CON &= ~(1 << 0);
...
void PMU_SetISINKParameters(ISINKCHNL Channel, ICVAL Value, boolean Enable)
{
    ...
    {
    case IC_4mA:
        *ISINK_CON = (((0) & 0x07) << 4) | En;
        break;
    case IC_8mA:
        *ISINK_CON = (((1) & 0x07) << 4) | En;
        break;
    case IC_12mA:
        *ISINK_CON = (((2) & 0x07) << 4) | En;
        break;
    case IC_16mA:
        *ISINK_CON = (((3) & 0x07) << 4) | En;
        break;
    case IC_20mA:
        *ISINK_CON = (((6) & 0x07) << 4) | En;
        break;
    case IC_24mA:
        *ISINK_CON = (((7) & 0x07) << 4) | En;
        break;
    case IC_32mA:
        *ISINK_CON = (((3) & 0x07) << 4) | (1 << 8) | En;
        break;
    case IC_40mA:
        *ISINK_CON = (((6) & 0x07) << 4) | (1 << 8) | En;
        break;
    case IC_48mA:
        *ISINK_CON = (((7) & 0x07) << 4) | (1 << 8) | En;
        break;
    }
}
...
{
    if (Enable) (*(volatile uint16_t *)(0xA0700000 + 0x0160)) |= (1 << 0);
    else (*(volatile uint16_t *)(0xA0700000 + 0x0160)) &= ~(1 << 0);
}
...
void PMU_TurnOnVMC(boolean Enable)
{
    ...
    (*(volatile uint16_t *)(0xA0700000 + 0x01C0)) = ((*(volatile uint16_t *)(0xA0700000 + 0x01C0)) & ~(1 << 0)) | (1 << 1) | En;
    if (En)
    {
...
boolean PMU_SetVoltageVMC(TVMC Voltage)
{
    ...
    case VMC_VO30V:
    case VMC_VO33V:
        (*(volatile uint16_t *)(0xA0700000 + 0x01C0)) = ((*(volatile uint16_t *)(0xA0700000 + 0x01C0)) & ~(((-1) & 0x07) << 4)) | (((Voltage) & 0x07) << 4);
...
{
    TVMC VMC = ((*(volatile uint16_t *)(0xA0700000 + 0x01C0)) & (((-1) & 0x07) << 4)) >> 4;
...
boolean PMU_Initialize(void)
{
    ...
    do { printf(":\r\n"); fflush(
# 509 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3
   (_impure_ptr->_stdout)
# 509 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
   ); } while(0);
    ...
    do
    {
        do { printf(" Battery charger..."); fflush(
# 518 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3
       (_impure_ptr->_stdout)
# 518 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
       ); } while(0);

        if (!AUXADC_Enable())
        {
            do { printf("Failed! Can not enable AUXADC.\r\n"); fflush(
# 522 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3
           (_impure_ptr->_stdout)
# 522 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
           ); } while(0);
            Result = false;
            break;
        }
        if (ChargerTimer == 
# 526 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3 4
                           ((void *)0)
# 526 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
                               )
        {
            ChargerTimer = LRT_Create(500, PMU_ChargerTimerHandler, TF_AUTOREPEAT | TF_ENABLED);
            if (ChargerTimer == 
# 529 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3 4
                               ((void *)0)
# 529 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
                                   )
            {
                do { printf("Failed! Can not create timer.\r\n"); fflush(
# 531 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3
               (_impure_ptr->_stdout)
# 531 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
               ); } while(0);
                Result = false;
                break;
            }
        }
        if (!NVIC_RegisterEINT((0x01 + 0x19), PMU_InterruptHandler,
                               0, 1, 0, false) ||
                !NVIC_EnableEINT((0x01 + 0x19)))
        {
            do { printf("Failed! Can not register interrupt.\r\n"); fflush(
# 540 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3
           (_impure_ptr->_stdout)
# 540 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
           ); } while(0);
            Result = false;
            break;
        }
    ...
    if (Result) do { printf("Complete.\r\n"); fflush(
# 547 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3
               (_impure_ptr->_stdout)
# 547 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
               ); } while(0);
    else
    {
        NVIC_UnregisterEINT((0x01 + 0x19));
        AUXADC_Disable();
        if (ChargerTimer != 
# 552 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3 4
                           ((void *)0)
# 552 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
                               )
        {
            LRT_Destroy(ChargerTimer);
            ChargerTimer = 
# 555 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3 4
                          ((void *)0)
# 555 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
                              ;
        }
    }
    ...
    do { printf(" Registering powerkey handler..."); fflush(
# 564 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3
   (_impure_ptr->_stdout)
# 564 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
   ); } while(0);
    if (NVIC_RegisterEINT((0x00 + 0x19), PMU_PWRKeyInterruptHandler,
                          0, 0, 0, true))
        do { printf("Complete.\r\n"); fflush(
# 567 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3
       (_impure_ptr->_stdout)
# 567 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
       ); } while(0);
    else
    {
        do { printf("Failed!\r\n"); fflush(
# 570 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3
       (_impure_ptr->_stdout)
# 570 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
       ); } while(0);
        Result = false;
    }


    if (!Result) do { printf("PMU initialization Failed!\r\n"); fflush(
# 575 "Source\\Lib\\MT6261\\Drivers\\pmu.c" 3
                (_impure_ptr->_stdout)
# 575 "Source\\Lib\\MT6261\\Drivers\\pmu.c"
                ); } while(0);
