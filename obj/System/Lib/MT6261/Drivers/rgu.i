# 1 "Source\\Lib\\MT6261\\Drivers\\rgu.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\Lib\\MT6261\\Drivers\\rgu.c"
# 21 "Source\\Lib\\MT6261\\Drivers\\rgu.c"
...
# 22 "Source\\Lib\\MT6261\\Drivers\\rgu.c" 2
# 1 "Source\\Lib\\MT6261\\Drivers\\rgu.h" 1
# 23 "Source\\Lib\\MT6261\\Drivers\\rgu.c" 2

void RGU_SetWDTInterval(uint8_t Interval, boolean Enable)
{
    Interval = ({ typeof(Interval) _a = Interval; typeof(31) _b = 31; (_a < _b) ? _a : _b; });

    (*(volatile uint16_t *)(0xA0030000 + 0x0000)) = 0x2200;
    (*(volatile uint16_t *)(0xA0030000 + 0x0004)) = 0x0008 | (((((Interval) * 32768) / 512) & 0x07FF) << 5);
    RGU_RestartWDT();
    if (Enable) (*(volatile uint16_t *)(0xA0030000 + 0x0000)) = 0x2200 | (1 << 0);
}

void RGU_EnableWDT(void)
{
    if ((*(volatile uint16_t *)(0xA0030000 + 0x0000)) & (1 << 0)) return;
    (*(volatile uint16_t *)(0xA0030000 + 0x0000)) = 0x2200;
    RGU_RestartWDT();
    (*(volatile uint16_t *)(0xA0030000 + 0x0000)) = 0x2200 | (1 << 0);
}
...
{
    if ((*(volatile uint16_t *)(0xA0030000 + 0x000C)) & (1 << 15)) return WDT_REASON_HW;
    else if ((*(volatile uint16_t *)(0xA0030000 + 0x000C)) & (1 << 14)) return WDT_REASON_SW;
...
{
    (*(volatile uint16_t *)(0xA0030000 + 0x0008)) = 0x1971;
}

void RGU_RaiseWDTSWReset(void)
{
    (*(volatile uint16_t *)(0xA0030000 + 0x001C)) = 0x1209;
}
