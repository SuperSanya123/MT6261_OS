# 1 "Source\\Lib\\MT6261\\Drivers\\sfi.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\Lib\\MT6261\\Drivers\\sfi.c"
# 21 "Source\\Lib\\MT6261\\Drivers\\sfi.c"
...
# 22 "Source\\Lib\\MT6261\\Drivers\\sfi.c" 2
# 1 "Source\\Lib\\MT6261\\Drivers\\sfi.h" 1
# 23 "Source\\Lib\\MT6261\\Drivers\\sfi.c" 2

static void __attribute__((section(".ramfunc"))) SFI_MaskAHBChannel(boolean Mask)
{
    if (Mask) (*(volatile uint32_t *)(0xA0140000 + 0x0044)) = (*(volatile uint32_t *)(0xA0140000 + 0x0044)) | (1 << 9);
    else (*(volatile uint32_t *)(0xA0140000 + 0x0044)) = (*(volatile uint32_t *)(0xA0140000 + 0x0044)) & ~(1 << 9);
}

static void __attribute__((section(".ramfunc"))) SFI_MACEnable(TSFI_CS CS)
{
    uint32_t Value;

    SFI_MaskAHBChannel(true);

    Value = (*(volatile uint32_t *)(0xA0140000 + 0x0000));
    if (SFI_GetInterfaceMode(CS) == SFM_QPI)
        Value |= (1 << 4);

    Value |= (1 << 3);

    while(!((*(volatile uint32_t *)(0xA0140000 + 0x0044)) & (1 << 13))) {}
    while(!((*(volatile uint32_t *)(0xA0140000 + 0x0008)) & (1 << 8))) {}

    (*(volatile uint32_t *)(0xA0140000 + 0x0000)) = Value;
}

static void __attribute__((section(".ramfunc"))) SFI_MACTrigger(TSFI_CS CS)
{
    (*(volatile uint32_t *)(0xA0140000 + 0x0000)) = (*(volatile uint32_t *)(0xA0140000 + 0x0000)) | (1 << 2) | (1 << 3);

    while(!((*(volatile uint32_t *)(0xA0140000 + 0x0000)) & (1 << 1))) {}
    while((*(volatile uint32_t *)(0xA0140000 + 0x0000)) & (1 << 0)) {}
}

static void __attribute__((section(".ramfunc"))) SFI_MACLeave(void)
{
    (*(volatile uint32_t *)(0xA0140000 + 0x0000)) &= ~((1 << 2) | (1 << 4) | (1 << 28));
    while((*(volatile uint32_t *)(0xA0140000 + 0x0000)) & (1 << 1)) {}

    (*(volatile uint32_t *)(0xA0140000 + 0x0000)) &= ~(1 << 3);
    while((*(volatile uint32_t *)(0xA0140000 + 0x0000)) & (1 << 3)) {}

    SFI_MaskAHBChannel(false);
}

static void __attribute__((section(".ramfunc"))) SFI_MACWaitReady(TSFI_CS CS)
{
    SFI_MACTrigger(CS);
    SFI_MACLeave();
}

static void __attribute__((section(".ramfunc"))) SFI_SendCmdList(TSFI_CS CS, uint8_t *CmdList)
{
    while(*CmdList)
    {
...
TSFIMODE __attribute__((section(".ramfunc"))) SFI_GetInterfaceMode(TSFI_CS CS)
{
    if (CS == SFI_CS0) return ((*(volatile uint32_t *)(0xA0140000 + 0x0004)) & (1 << 0)) ? SFM_QPI : SFM_SPI;
    else return SFM_UNKNOWN;
}

boolean __attribute__((section(".ramfunc"))) SFI_DeviceCommandRead(TSFI_CS CS, uint8_t Command, uint8_t *InData, size_t InCount)
{
    if (CS < SFI_CSNUM)
    {
        if (InData == 
# 92 "Source\\Lib\\MT6261\\Drivers\\sfi.c" 3 4
                     ((void *)0)
# 92 "Source\\Lib\\MT6261\\Drivers\\sfi.c"
                         ) InCount = 0;
        else if (InCount >= 0x00A0 - 1)
            InCount = 0x00A0 - 1;

        (*(volatile uint32_t *)(0xA0140000 + 0x0800 + 4 * (0))) = Command;
        (*(volatile uint32_t *)(0xA0140000 + 0x0010)) = 1;
        (*(volatile uint32_t *)(0xA0140000 + 0x0014)) = InCount;
        SFI_MACEnable(CS);
        SFI_MACWaitReady(CS);

        if ((InData != 
# 102 "Source\\Lib\\MT6261\\Drivers\\sfi.c" 3 4
                      ((void *)0)
# 102 "Source\\Lib\\MT6261\\Drivers\\sfi.c"
                          ) && InCount)
        {
            uint32_t GPRAMPtr = 0;
            uint32_t i = 1, tmpData = (*(volatile uint32_t *)(0xA0140000 + 0x0800 + 4 * (GPRAMPtr++))) >> 8;
            ...
            while(InCount)
            {
                ...
                i = 0;
                tmpData = (*(volatile uint32_t *)(0xA0140000 + 0x0800 + 4 * (GPRAMPtr++)));
            }
        }
        return true;
    }
...
boolean __attribute__((section(".ramfunc"))) SFI_DeviceCommandWrite(TSFI_CS CS, uint8_t Command, uint8_t *OutData, size_t OutCount)
{
    if (CS < SFI_CSNUM)
    {
        ...
        if ((OutData != 
# 129 "Source\\Lib\\MT6261\\Drivers\\sfi.c" 3 4
                       ((void *)0)
# 129 "Source\\Lib\\MT6261\\Drivers\\sfi.c"
                           ) && OutCount)
        {
            uint32_t tmpData = Command, GPRAMPtr = 0;
            uint32_t i = 8;

            if (OutCount >= 0x00A0 - TotalLength)
                OutCount = 0x00A0 - TotalLength;
            ...
            while(OutCount)
            {
                ...
                i = 0;
                (*(volatile uint32_t *)(0xA0140000 + 0x0800 + 4 * (GPRAMPtr++))) = tmpData;
                tmpData = 0;
            }
        }
        else (*(volatile uint32_t *)(0xA0140000 + 0x0800 + 4 * (0))) = Command;

        SFI_MACEnable(CS);
        (*(volatile uint32_t *)(0xA0140000 + 0x0010)) = TotalLength;
        (*(volatile uint32_t *)(0xA0140000 + 0x0014)) = 0;
        SFI_MACWaitReady(CS);
...
boolean __attribute__((section(".ramfunc"))) SFI_DeviceCmdAddr3Write(TSFI_CS CS, uint8_t Command, uint32_t Address,
        uint8_t *OutData, size_t OutCount)
{
    if (CS < SFI_CSNUM)
    {
        uint32_t GPRAMPtr = 0;
        uint32_t tmpData = ((uint32_t)( (((uint32_t)(Address) & (uint32_t)0x000000ffUL) << 24) | (((uint32_t)(Address) & (uint32_t)0x0000ff00UL) << 8) | (((uint32_t)(Address) & (uint32_t)0x00ff0000UL) >> 8) | (((uint32_t)(Address) & (uint32_t)0xff000000UL) >> 24))) & ~0x000000FF | Command;
        size_t TotalLength = 4;

        (*(volatile uint32_t *)(0xA0140000 + 0x0800 + 4 * (GPRAMPtr++))) = tmpData;

        if ((OutData != 
# 173 "Source\\Lib\\MT6261\\Drivers\\sfi.c" 3 4
                       ((void *)0)
# 173 "Source\\Lib\\MT6261\\Drivers\\sfi.c"
                           ) && OutCount)
        {
            uint32_t i;
...
boolean __attribute__((section(".ramfunc"))) SFI_DeviceCmdAddr4Write(TSFI_CS CS, uint8_t Command, uint32_t Address,
        uint8_t *OutData, size_t OutCount)
{
    if (CS < SFI_CSNUM)
    {
        ...
        Address = ((uint32_t)( (((uint32_t)(Address) & (uint32_t)0x000000ffUL) << 24) | (((uint32_t)(Address) & (uint32_t)0x0000ff00UL) << 8) | (((uint32_t)(Address) & (uint32_t)0x00ff0000UL) >> 8) | (((uint32_t)(Address) & (uint32_t)0xff000000UL) >> 24)));
        (*(volatile uint32_t *)(0xA0140000 + 0x0800 + 4 * (GPRAMPtr++))) = (Address << 8) | Command;

        if ((OutData != 
# 215 "Source\\Lib\\MT6261\\Drivers\\sfi.c" 3 4
                       ((void *)0)
# 215 "Source\\Lib\\MT6261\\Drivers\\sfi.c"
                           ) && OutCount)
        {
            uint32_t i = 8;
        ...
        else (*(volatile uint32_t *)(0xA0140000 + 0x0800 + 4 * (0))) = tmpData;
...
boolean __attribute__((section(".ramfunc"))) SFI_ConfigureInterface(TSFI_CS CS, pDFCONFIG Config)
{
    if ((CS < SFI_CSNUM) && (Config != 
# 249 "Source\\Lib\\MT6261\\Drivers\\sfi.c" 3 4
                                      ((void *)0)
# 249 "Source\\Lib\\MT6261\\Drivers\\sfi.c"
                                          ))
    {
        ...
        (*(volatile uint32_t *)(0xA0140000 + 0x0000)) = NewConfig.SFI_MAC_CTL;
        (*(volatile uint32_t *)(0xA0140000 + 0x0004)) = NewConfig.SFI_DIRECT_CTL;
        (*(volatile uint32_t *)(0xA0140000 + 0x0008)) = NewConfig.SFI_MISC_CTL;
        (*(volatile uint32_t *)(0xA0140000 + 0x000C)) = NewConfig.SFI_MISC_CTL2;
        (*(volatile uint32_t *)(0xA0140000 + 0x0024)) = NewConfig.SFI_DLY_CTL_2;
        (*(volatile uint32_t *)(0xA0140000 + 0x0028)) = NewConfig.SFI_DLY_CTL_3;

        tmpValue = (*(volatile uint32_t *)(0xA0010000 + 0x0600)) & 0xFFF8FFF8;
        (*(volatile uint32_t *)(0xA0010000 + 0x0600)) = tmpValue | NewConfig.DRIVING;
        tmpValue = (*(volatile uint32_t *)(0xA0010000 + 0x0604)) & 0xFFF8FFF8;
        (*(volatile uint32_t *)(0xA0010000 + 0x0604)) = tmpValue | NewConfig.DRIVING;
        tmpValue = (*(volatile uint32_t *)(0xA0010000 + 0x0608)) & 0xFFF8FFF8;
        (*(volatile uint32_t *)(0xA0010000 + 0x0608)) = tmpValue | NewConfig.DRIVING;
