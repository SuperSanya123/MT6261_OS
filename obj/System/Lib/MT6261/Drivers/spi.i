# 1 "Source\\Lib\\MT6261\\Drivers\\spi.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\Lib\\MT6261\\Drivers\\spi.c"
# 21 "Source\\Lib\\MT6261\\Drivers\\spi.c"
...
# 22 "Source\\Lib\\MT6261\\Drivers\\spi.c" 2
# 1 "Source\\Lib\\MT6261\\Drivers\\spi.h" 1
# 23 "Source\\Lib\\MT6261\\Drivers\\spi.c" 2
...
{
    while(!((*(volatile uint32_t *)(0xA01E0000 + 0x0020)) & (1 << 0))) {}
...
{
    if (PCTL_GetPeripheralPowerStatus((0x17)))
    {
        (*(volatile uint32_t *)(0xA01E0000 + 0x0018)) |= (1 << 2);
        (*(volatile uint32_t *)(0xA01E0000 + 0x0018)) &= ~(1 << 2);
    }
}
...
static boolean SPI_SetupRXTX_DMA(void *RX_Dst, void *TX_Src)
{
    ...
    if (RX_Dst != 
# 47 "Source\\Lib\\MT6261\\Drivers\\spi.c" 3 4
                 ((void *)0)
# 47 "Source\\Lib\\MT6261\\Drivers\\spi.c"
                     )
    {
        (*(volatile uint32_t *)(0xA01E0000 + 0x000C)) = (uint32_t)RX_Dst;
        (*(volatile uint32_t *)(0xA01E0000 + 0x0018)) |= (1 << 10);
        Result = true;
    }
    else (*(volatile uint32_t *)(0xA01E0000 + 0x0018)) &= ~(1 << 10);

    if (TX_Src != 
# 55 "Source\\Lib\\MT6261\\Drivers\\spi.c" 3 4
                 ((void *)0)
# 55 "Source\\Lib\\MT6261\\Drivers\\spi.c"
                     )
    {
        (*(volatile uint32_t *)(0xA01E0000 + 0x0008)) = (uint32_t)TX_Src;
        (*(volatile uint32_t *)(0xA01E0000 + 0x0018)) |= (1 << 11);
        Result = true;
    }
    else (*(volatile uint32_t *)(0xA01E0000 + 0x0018)) &= ~(1 << 11);
...
{
    do { typeof((0x17)) _x = (0x17); if (_x <= (0x2E)) { (*(volatile uint16_t *)(0xA0010000 + 0x0320 + 0x04 * (_x >> 4))) = (1UL << (_x & 0x0F)); } else if (_x <= (0x34)) { (*(volatile uint16_t *)(0xA0730000 + 0x0010)) = (1UL << (_x & 0x0F)); } } while(0);
    SPI_Reset();
}
...
{
    SPI_Reset();
    do { typeof((0x17)) _x = (0x17); if (_x <= (0x2E)) { (*(volatile uint16_t *)(0xA0010000 + 0x0310 + 0x04 * (_x >> 4))) = (1UL << (_x & 0x0F)); } else if (_x <= (0x34)) { (*(volatile uint16_t *)(0xA0730000 + 0x000C)) = (1UL << (_x & 0x0F)); } } while(0);
}

void SPI_SetupCS(uint8_t CSSetTime, uint8_t CSHoldTime, uint8_t CSIdleTime)
{
    if (PCTL_GetPeripheralPowerStatus((0x17)) && SPI_WaitBusy())
        (*(volatile uint32_t *)(0xA01E0000 + 0x0000)) = ((*(volatile uint32_t *)(0xA01E0000 + 0x0000)) & ~((((-1) & 0xFF) << 24) | (((-1) & 0xFF) << 16)) | (((-1) & 0xFF) << 0)) |
                   (((CSSetTime) & 0xFF) << 24) | (((CSHoldTime) & 0xFF) << 16) | (((CSIdleTime) & 0xFF) << 0);
}
...
void SPI_SetupSpeed(uint32_t Speed)
{
    if (PCTL_GetPeripheralPowerStatus((0x17)) && SPI_WaitBusy())
    {
        ...
        Speed = ({ typeof(Speed) _a = Speed; typeof(32000000) _b = 32000000; (_a < _b) ? _a : _b; });
        nTicks = ({ typeof(510) _a = 510; typeof(((2 * 32000000 + Speed / 2) / Speed) - 2) _b = ((2 * 32000000 + Speed / 2) / Speed) - 2; (_a < _b) ? _a : _b; });
        (*(volatile uint32_t *)(0xA01E0000 + 0x0000)) = ((*(volatile uint32_t *)(0xA01E0000 + 0x0000)) & ~((((-1) & 0xFF) << 0) | (((-1) & 0xFF) << 8))) |
                   (((nTicks / 2) & 0xFF) << 0) | (((nTicks / 2 + (nTicks & 1)) & 0xFF) << 8);
    }
}
...
void SPI_SetupEndian(boolean RXReverse, boolean TXReverse, boolean RXMSB, boolean TXMSB)
{
    if (PCTL_GetPeripheralPowerStatus((0x17)) && SPI_WaitBusy())
    {
        uint32_t tmpCMD = (*(volatile uint32_t *)(0xA01E0000 + 0x0018)) & ~((1 << 14) | (1 << 15) |
                                      (1 << 13) | (1 << 12));

        if (RXReverse) tmpCMD |= (1 << 14);
        if (TXReverse) tmpCMD |= (1 << 15);
        if (RXMSB) tmpCMD |= (1 << 13);
        if (TXMSB) tmpCMD |= (1 << 12);
        (*(volatile uint32_t *)(0xA01E0000 + 0x0018)) = tmpCMD;
    }
}
...
void SPI_SetupInterface(TSCPOL CPOL, TSCPHA CPHA, boolean CSDeassertEn)
{
    if (PCTL_GetPeripheralPowerStatus((0x17)) && SPI_WaitBusy())
    {
        uint32_t tmpCMD = (*(volatile uint32_t *)(0xA01E0000 + 0x0018)) & ~((1 << 8) | (1 << 9) |
                                      (1 << 5));

        if (CPOL == CPOL_1) tmpCMD |= (1 << 9);
        if (CPHA == CPHA_1) tmpCMD |= (1 << 8);
        if (CSDeassertEn) tmpCMD |= (1 << 5);
        (*(volatile uint32_t *)(0xA01E0000 + 0x0018)) = tmpCMD;
    }
}
...
boolean SPI_RXTXDataBufferDMA(void *RXData, void *TXData, uint32_t Count)
{
    ...
    {
        uint32_t Status;
        uint32_t nBytes = ({ typeof(Count) _a = Count; typeof(1024) _b = 1024; (_a < _b) ? _a : _b; });

        if (SPI_SetupRXTX_DMA(RXData, TXData))
        {
            if (Count > 1024) (*(volatile uint32_t *)(0xA01E0000 + 0x0018)) |= (1 << 4);
            else (*(volatile uint32_t *)(0xA01E0000 + 0x0018)) &= ~(1 << 4);

            (*(volatile uint32_t *)(0xA01E0000 + 0x0004)) = ((*(volatile uint32_t *)(0xA01E0000 + 0x0004)) & ~(((-1) & 0x03FF) << 16)) | (((nBytes - 1) & 0x03FF) << 16);
            (*(volatile uint32_t *)(0xA01E0000 + 0x0018)) |= (1 << 0);

            do
            {
                Status = (*(volatile uint32_t *)(0xA01E0000 + 0x001C));
                if (Status & (1 << 1))
                {
                    Count -= nBytes;
                    nBytes = ({ typeof(Count) _a = Count; typeof(1024) _b = 1024; (_a < _b) ? _a : _b; });
                    if (Count <= 1024)
                    {
                        (*(volatile uint32_t *)(0xA01E0000 + 0x0004)) = ((*(volatile uint32_t *)(0xA01E0000 + 0x0004)) & ~(((-1) & 0x03FF) << 16)) | (((nBytes - 1) & 0x03FF) << 16);
                        (*(volatile uint32_t *)(0xA01E0000 + 0x0018)) &= ~(1 << 4);
                    }
                    (*(volatile uint32_t *)(0xA01E0000 + 0x0018)) |= (1 << 1);
                }
            }
            while(!(Status & (1 << 0)));
