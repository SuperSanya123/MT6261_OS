# 1 "Source\\Lib\\MT6261\\Drivers\\tcmcache.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\Lib\\MT6261\\Drivers\\tcmcache.c"
# 21 "Source\\Lib\\MT6261\\Drivers\\tcmcache.c"
...
# 22 "Source\\Lib\\MT6261\\Drivers\\tcmcache.c" 2
# 1 "Source\\Lib\\MT6261\\Drivers\\tcmcache.h" 1
# 23 "Source\\Lib\\MT6261\\Drivers\\tcmcache.c" 2
...
void MPU_Initialize(void)
{
    ...
    (*(volatile uint16_t *)(0xA0530000 + 0x0000)) = (((3) & 0x0003) << 8);



    (*(volatile uint32_t *)(0xA0530000 + 0x0004)) = (((0x01) & 0x000F) << 1) | (1 << 0);
    (*(volatile uint16_t *)(0xA0530000 + 0x002C)) = 0;

    for(i = 0; i < 16; i++)
    {
        (*(volatile uint32_t *)(0xA0540000 + 0x0000 + 4 * (i))) = 0;
        (*(volatile uint32_t *)(0xA0540000 + 0x0040 + 4 * (i))) = 0;
    }

    memset(&MpuInfo, 0x00, sizeof(TMPUINFO));

    MPU_AddRegion((uint32_t)&__ROMImageBase, (uint32_t)&__ROMImageLimit, true, 0);
}
...
boolean MPU_AddRegion(uint32_t RegionStart, uint32_t RegionEnd, boolean Cacheable, uint8_t AccessRights)
{
    ...
    RegionStart &= ~0x00000FFF;
    RegionEnd = (RegionEnd + 0x00000FFF) & ~0x00000FFF;
    ...
    if (RegionStart < RegionEnd)
    {
        ...
        if (FreeRegionIdx != -1)
        {
            (*(volatile uint16_t *)(0xA0530000 + 0x002C)) &= ~(1 << FreeRegionIdx);
            Attr = ((Cacheable) ? (1 << 8) : 0) | (((AccessRights) & 0x07) << 5);
            (*(volatile uint32_t *)(0xA0540000 + 0x0000 + 4 * (FreeRegionIdx))) = RegionStart | Attr;
            (*(volatile uint32_t *)(0xA0540000 + 0x0040 + 4 * (FreeRegionIdx))) = RegionEnd;
            (*(volatile uint32_t *)(0xA0530000 + 0x0004)) = (((0x01) & 0x000F) << 1) | (1 << 0);
            (*(volatile uint16_t *)(0xA0530000 + 0x002C)) |= (1 << FreeRegionIdx);
            (*(volatile uint16_t *)(0xA0530000 + 0x0000)) |= (1 << 1) | (1 << 0);
            ...
            MpuInfo.RegionsUsed++;
            do { printf("Region 0x%08X...0x%08X added to cache. Rights: %s\r\n", RegionStart, RegionEnd - 1, AccRightsStr[AccessRights & 0x07]); fflush(
# 98 "Source\\Lib\\MT6261\\Drivers\\tcmcache.c" 3
           (_impure_ptr->_stdout)
# 98 "Source\\Lib\\MT6261\\Drivers\\tcmcache.c"
           ); } while(0)
                                                                                              ;
            return true;
        }
    }
    do { printf("Unable to add region 0x%08X...0x%08X to cache.\r\n", RegionStart, RegionEnd - 1); fflush(
# 103 "Source\\Lib\\MT6261\\Drivers\\tcmcache.c" 3
   (_impure_ptr->_stdout)
# 103 "Source\\Lib\\MT6261\\Drivers\\tcmcache.c"
   ); } while(0);
    return false;
}
...
{
    boolean IsCacheEnabled = !!((*(volatile uint16_t *)(0xA0530000 + 0x0000)) & (1 << 0));

    (*(volatile uint16_t *)(0xA0530000 + 0x0000)) &= ~(1 << 0);
...
{
    uint16_t tmpCACHE_EN = (*(volatile uint16_t *)(0xA0530000 + 0x002C));

    (*(volatile uint16_t *)(0xA0530000 + 0x002C)) = 0x0000;
    (*(volatile uint32_t *)(0xA0530000 + 0x0004)) = (((0x01) & 0x000F) << 1) | (1 << 0);
    (*(volatile uint16_t *)(0xA0530000 + 0x0000)) = ((*(volatile uint16_t *)(0xA0530000 + 0x0000)) & ~(1 << 0)) | ((State) ? (1 << 0) : 0);
    (*(volatile uint16_t *)(0xA0530000 + 0x002C)) = tmpCACHE_EN;
}
