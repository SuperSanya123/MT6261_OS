# 1 "Source\\Lib\\MT6261\\Drivers\\gpio.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\Lib\\MT6261\\Drivers\\gpio.c"
# 21 "Source\\Lib\\MT6261\\Drivers\\gpio.c"
...
# 22 "Source\\Lib\\MT6261\\Drivers\\gpio.c" 2
# 1 "Source\\Lib\\MT6261\\Drivers\\gpio.h" 1
# 23 "Source\\Lib\\MT6261\\Drivers\\gpio.c" 2

void GPIO_Initialize(void)
{
    (*(volatile uint32_t *)(0xA0020000 + 0x0008)) = 0xFFFFFFFF;
    (*(volatile uint32_t *)(0xA0020000 + 0x0018)) = 0x00CFFFFFF;

    (*(volatile uint32_t *)(0xA0020000 + 0x0108)) = 0x43C00BFF;
    (*(volatile uint32_t *)(0xA0020000 + 0x0118)) = 0x00F01800;
    (*(volatile uint32_t *)(0xA0020000 + 0x0B08)) = 0xBC3FF400;
    (*(volatile uint32_t *)(0xA0020000 + 0x0B18)) = 0x000FE7FF;
    (*(volatile uint32_t *)(0xA0020000 + 0x0B28)) = 0xBC3FF400;
    (*(volatile uint32_t *)(0xA0020000 + 0x0B38)) = 0x000FE7FF;

    (*(volatile uint32_t *)(0xA0020000 + 0x0C08)) = ((0x0F << 0) | (0x0F << 4) | (0x0F << 8) | (0x0F << 12) | (0x07 << 16) | (0x07 << 20) | (0x07 << 24) | (0x07 << 28));
    (*(volatile uint32_t *)(0xA0020000 + 0x0C18)) = ((0x07 << 0) | (0x07 << 4) | (0x07 << 8) | (0x07 << 12) | (0x07 << 16) | (0x07 << 20) | (0x07 << 24) | (0x07 << 28));
    (*(volatile uint32_t *)(0xA0020000 + 0x0C28)) = ((0x07 << 0) | (0x07 << 4) | (0x07 << 8) | (0x07 << 12) | (0x07 << 16) | (0x07 << 20) | (0x07 << 24) | (0x07 << 28));
    (*(volatile uint32_t *)(0xA0020000 + 0x0C38)) = ((0x07 << 0) | (0x07 << 4) | (0x07 << 8) | (0x0F << 12) | (0x0F << 16) | (0x0F << 20) | (0x07 << 24) | (0x07 << 28));
    (*(volatile uint32_t *)(0xA0020000 + 0x0C48)) = ((0x07 << 0) | (0x07 << 4) | (0x07 << 8) | (0x07 << 12) | (0x07 << 16) | (0x07 << 20) | (0x07 << 24) | (0x07 << 28));
    (*(volatile uint32_t *)(0xA0020000 + 0x0C58)) = ((0x07 << 0) | (0x07 << 4) | (0x07 << 8) | (0x07 << 12) | (0x07 << 16) | (0x07 << 20) | (0x07 << 24) | (0x07 << 28));
    (*(volatile uint32_t *)(0xA0020000 + 0x0C68)) = ((0x07 << 0) | (0x07 << 4) | (0x0F << 8) | (0x07 << 12) | (0x07 << 16) | (0x07 << 20) | (0x07 << 24) | (0x07 << 28));

    GPIO_Setup((0x33), (((0x01) & 0x0F) << 8));

    GPIO_Setup((0x0A), (((0x01) & 0x0F) << 8));
    GPIO_Setup((0x0B), (((0x01) & 0x0F) << 8));
...
void GPIO_Setup(uint32_t Pin, uint32_t Flags)
{
    if (Pin <= (0x37))
    {
        if (Flags & (1 << 0)) do { typeof(Pin) p = Pin; if (p < 0x20) (*(volatile uint32_t *)(0xA0020000 + 0x0004)) = (1UL << p); else if (p < 0x40) (*(volatile uint32_t *)(0xA0020000 + 0x0014)) = (1UL << (p - 0x20)); } while(0);
        else do { typeof(Pin) p = Pin; if (p < 0x20) (*(volatile uint32_t *)(0xA0020000 + 0x0008)) = (1UL << p); else if (p < 0x40) (*(volatile uint32_t *)(0xA0020000 + 0x0018)) = (1UL << (p - 0x20)); } while(0);

        if (Flags & (1 << 1)) do { typeof(Pin) p = Pin; uint32_t v; if (p < 0x20) { v = 1UL << p; if (v & 0x43C00BFF) (*(volatile uint32_t *)(0xA0020000 + 0x0904)) = (1UL << p); } else if (p < 0x40) { v = 1UL << (p - 0x20); if (v & 0x00001FE0) (*(volatile uint32_t *)(0xA0020000 + 0x0914)) = (1UL << (p - 0x20)); } } while(0);
        else do { typeof(Pin) p = Pin; uint32_t v; if (p < 0x20) { v = 1UL << p; if (v & 0x43C00BFF) (*(volatile uint32_t *)(0xA0020000 + 0x0908)) = (1UL << p); } else if (p < 0x40) { v = 1UL << (p - 0x20); if (v & 0x00001FE0) (*(volatile uint32_t *)(0xA0020000 + 0x0918)) = (1UL << (p - 0x20)); } } while(0);

        if (Flags & (1 << 3)) do { typeof(Pin) p = Pin; uint32_t v; if (p < 0x20) { v = (1UL << p); if (v & 0x43C00BFF) (*(volatile uint32_t *)(0xA0020000 + 0x0508)) = v; else if (v & 0xBC3FF400) (*(volatile uint32_t *)(0xA0020000 + 0x0A04)) = v; } else if (p < 0x40) { v = (1UL << (p - 0x20)); if (v & 0x00F01800) (*(volatile uint32_t *)(0xA0020000 + 0x0518)) = v; else if (v & 0x000FE7FF) (*(volatile uint32_t *)(0xA0020000 + 0x0A14)) = v; } } while(0);
        else do { typeof(Pin) p = Pin; uint32_t v; if (p < 0x20) { v = (1UL << p); if (v & 0x43C00BFF) (*(volatile uint32_t *)(0xA0020000 + 0x0504)) = v; else if (v & 0xBC3FF400) (*(volatile uint32_t *)(0xA0020000 + 0x0A08)) = v; } else if (p < 0x40) { v = (1UL << (p - 0x20)); if (v & 0x00F01800) (*(volatile uint32_t *)(0xA0020000 + 0x0514)) = v; else if (v & 0x000FE7FF) (*(volatile uint32_t *)(0xA0020000 + 0x0A18)) = v; } } while(0);

        if (Flags & (1 << 2)) do { typeof(Pin) p = Pin; uint32_t v; if (p < 0x20) { v = (1UL << p); if (v & 0x43C00BFF) (*(volatile uint32_t *)(0xA0020000 + 0x0104)) = v; else if (v & 0xBC3FF400) (*(volatile uint32_t *)(0xA0020000 + 0x0B04)) = v; } else if (p < 0x40) { v = (1UL << (p - 0x20)); if (v & 0x00F01800) (*(volatile uint32_t *)(0xA0020000 + 0x0114)) = v; else if (v & 0x000FE7FF) (*(volatile uint32_t *)(0xA0020000 + 0x0B14)) = v; } } while(0);
        else do { typeof(Pin) p = Pin; uint32_t v; if (p < 0x20) { v = (1UL << p); if (v & 0x43C00BFF) (*(volatile uint32_t *)(0xA0020000 + 0x0108)) = v; else if (v & 0xBC3FF400) (*(volatile uint32_t *)(0xA0020000 + 0x0B08)) = v; } else if (p < 0x40) { v = (1UL << (p - 0x20)); if (v & 0x00F01800) (*(volatile uint32_t *)(0xA0020000 + 0x0118)) = v; else if (v & 0x000FE7FF) (*(volatile uint32_t *)(0xA0020000 + 0x0B18)) = v; } } while(0);

        if (Flags & (1 << 4)) do { typeof(Pin) p = Pin; uint32_t v; if (p < 0x20) { v = 1UL << p; if (v & 0xFFFFFFFF) (*(volatile uint32_t *)(0xA0020000 + 0x0604)) = (1UL << p); } else if (p < 0x40) { v = 1UL << (p - 0x20); if (v & 0x00001FE0) (*(volatile uint32_t *)(0xA0020000 + 0x0614)) = (1UL << (p - 0x20)); } } while(0);
        else do { typeof(Pin) p = Pin; uint32_t v; if (p < 0x20) { v = 1UL << p; if (v & 0xFFFFFFFF) (*(volatile uint32_t *)(0xA0020000 + 0x0608)) = (1UL << p); } else if (p < 0x40) { v = 1UL << (p - 0x20); if (v & 0x00001FE0) (*(volatile uint32_t *)(0xA0020000 + 0x0618)) = (1UL << (p - 0x20)); } } while(0);

        do { typeof(Pin) p = Pin; if (p <= (0x37)) { uint8_t RegIdx = (p >> 3) & 0x07; uint8_t ModePos = (p & 0x07) << 2; uint32_t Mask = 0; if (p < 8) Mask = ((0x0F << 0) | (0x0F << 4) | (0x0F << 8) | (0x0F << 12) | (0x07 << 16) | (0x07 << 20) | (0x07 << 24) | (0x07 << 28)); else if (p < 16) Mask = ((0x07 << 0) | (0x07 << 4) | (0x07 << 8) | (0x07 << 12) | (0x07 << 16) | (0x07 << 20) | (0x07 << 24) | (0x07 << 28)); else if (p < 24) Mask = ((0x07 << 0) | (0x07 << 4) | (0x07 << 8) | (0x07 << 12) | (0x07 << 16) | (0x07 << 20) | (0x07 << 24) | (0x07 << 28)); else if (p < 32) Mask = ((0x07 << 0) | (0x07 << 4) | (0x07 << 8) | (0x0F << 12) | (0x0F << 16) | (0x0F << 20) | (0x07 << 24) | (0x07 << 28)); else if (p < 40) Mask = ((0x07 << 0) | (0x07 << 4) | (0x07 << 8) | (0x07 << 12) | (0x07 << 16) | (0x07 << 20) | (0x07 << 24) | (0x07 << 28)); else if (p < 48) Mask = ((0x07 << 0) | (0x07 << 4) | (0x07 << 8) | (0x07 << 12) | (0x07 << 16) | (0x07 << 20) | (0x07 << 24) | (0x07 << 28)); else if (p < 56) Mask = ((0x07 << 0) | (0x07 << 4) | (0x0F << 8) | (0x07 << 12) | (0x07 << 16) | (0x07 << 20) | (0x07 << 24) | (0x07 << 28)); (*(volatile uint32_t *)(0xA0020000 + 0x0C00 + 0x10 * (RegIdx))) = ((*(volatile uint32_t *)(0xA0020000 + 0x0C00 + 0x10 * (RegIdx))) & ~(0x0FUL << ModePos)) | ((((Flags >> 8)) & Mask) << ModePos); } } while(0);
    }
}
