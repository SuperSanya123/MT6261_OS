# 1 "Source\\Lib\\MT6261\\Drivers\\rtc.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\Lib\\MT6261\\Drivers\\rtc.c"
# 21 "Source\\Lib\\MT6261\\Drivers\\rtc.c"
...
# 22 "Source\\Lib\\MT6261\\Drivers\\rtc.c" 2
# 1 "Source\\Lib\\MT6261\\Drivers\\rtc.h" 1
# 23 "Source\\Lib\\MT6261\\Drivers\\rtc.c" 2

static const uint8_t DayInMonth[13] = {0, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};

static void RTC_WaitCBUSY(void)
{
    while((*(volatile uint16_t *)(0xA0710000 + 0x0000)) & (1 << 6));
}

static void RTC_UpdateContext(void)
{
    (*(volatile uint16_t *)(0xA0710000 + 0x0074)) = (1 << 0);
    RTC_WaitCBUSY();
}

static void RTC_Unprotect(void)
{
    (*(volatile uint16_t *)(0xA0710000 + 0x0068)) = 0x586A;
    RTC_UpdateContext();
    (*(volatile uint16_t *)(0xA0710000 + 0x0068)) = 0x9136;
    RTC_UpdateContext();
}

static void RTC_SetPowerkey(void)
{
    (*(volatile uint16_t *)(0xA0710000 + 0x0050)) = 0xA357;
    (*(volatile uint16_t *)(0xA0710000 + 0x0054)) = 0x67D2;
    RTC_UpdateContext();
}

static void RTC_SetOSC32CON(uint16_t Data)
{
    (*(volatile uint16_t *)(0xA0710000 + 0x004C)) = 0x1A57;
    RTC_WaitCBUSY();
    (*(volatile uint16_t *)(0xA0710000 + 0x004C)) = 0x2B68;
    RTC_WaitCBUSY();
    (*(volatile uint16_t *)(0xA0710000 + 0x004C)) = Data;
    RTC_WaitCBUSY();
}
...
{
    RTC_SetOSC32CON(0x0400 | (((0) & 0x07) << 6) | (((0x0F) & 0x1F) << 0));
    RTC_Unprotect();
    ...
    if (!RTC_IsValidState())
    {
        ...
        do { printf("settings invalid - "); fflush(
# 84 "Source\\Lib\\MT6261\\Drivers\\rtc.c" 3
       (_impure_ptr->_stdout)
# 84 "Source\\Lib\\MT6261\\Drivers\\rtc.c"
       ); } while(0);

        RTC_SetPowerkey();

        (*(volatile uint16_t *)(0xA0710000 + 0x0000)) = 0x4300;
        RTC_UpdateContext();

        (*(volatile uint16_t *)(0xA0710000 + 0x0078)) = (((1) & 0x03) << 1) | (1 << 15);
        RTC_UpdateContext();
        (*(volatile uint16_t *)(0xA0710000 + 0x0078)) = (((1) & 0x03) << 1) | (1 << 3);
        RTC_UpdateContext();
        (*(volatile uint16_t *)(0xA0710000 + 0x0078)) = (((1) & 0x03) << 1);
        RTC_UpdateContext();

        (*(volatile uint16_t *)(0xA0710000 + 0x000C)) = 0;
        (*(volatile uint16_t *)(0xA0710000 + 0x0008)) = 0;
        (*(volatile uint16_t *)(0xA0710000 + 0x0010)) = (1 << 6) | (1 << 5) | (1 << 3) | (1 << 4) | (1 << 2) | (1 << 1) | (1 << 0);
        RTC_UpdateContext();
        if ((*(volatile uint16_t *)(0xA0710000 + 0x0004))) {}
        ...
        do { printf("reconfigured!\r\n"); fflush(
# 112 "Source\\Lib\\MT6261\\Drivers\\rtc.c" 3
       (_impure_ptr->_stdout)
# 112 "Source\\Lib\\MT6261\\Drivers\\rtc.c"
       ); } while(0);
        return true;
    }
    do { printf("Complete.\r\n"); fflush(
# 115 "Source\\Lib\\MT6261\\Drivers\\rtc.c" 3
   (_impure_ptr->_stdout)
# 115 "Source\\Lib\\MT6261\\Drivers\\rtc.c"
   ); } while(0);
    return true;
}
...
{
    (*(volatile uint16_t *)(0xA0710000 + 0x0000)) = 0x4300 | (1 << 3) | (((*(volatile uint16_t *)(0xA0710000 + 0x0000)) | (1 << 2)) & 0xFF);
    RTC_UpdateContext();
    return ((*(volatile uint16_t *)(0xA0710000 + 0x0000)) & (1 << 2)) ? true : false;
}

boolean RTC_UnlockBBPower(void)
{
    (*(volatile uint16_t *)(0xA0710000 + 0x0000)) = 0x4300 | (((*(volatile uint16_t *)(0xA0710000 + 0x0000)) & ~(1 << 2)) & 0xFF);
    RTC_UpdateContext();
    return ((*(volatile uint16_t *)(0xA0710000 + 0x0000)) & (1 << 2)) ? false : true;
}

boolean RTC_EnablePowerUp(void)
{
    (*(volatile uint16_t *)(0xA0710000 + 0x0000)) = 0x4300 | (((*(volatile uint16_t *)(0xA0710000 + 0x0000)) | (1 << 0)) & 0xFF);
    RTC_UpdateContext();
    return ((*(volatile uint16_t *)(0xA0710000 + 0x0000)) & (1 << 0)) ? true : false;
}
...
boolean RTC_DisablePowerUp(void)
{
    (*(volatile uint16_t *)(0xA0710000 + 0x0000)) = 0x4300 | (((*(volatile uint16_t *)(0xA0710000 + 0x0000)) & ~(1 << 0)) & 0xFF);
    RTC_UpdateContext();
    return ((*(volatile uint16_t *)(0xA0710000 + 0x0000)) & (1 << 0)) ? false : true;
}

boolean RTC_IsValidState(void)
{
    return (((*(volatile uint16_t *)(0xA0710000 + 0x0078)) & (1 << 0)) ||
            ((*(volatile uint16_t *)(0xA0710000 + 0x0050)) != 0xA357) ||
            ((*(volatile uint16_t *)(0xA0710000 + 0x0054)) != 0x67D2)) ? false : true;
}
...
boolean RTC_IsAlarmActive(void)
{
    ...
    AlmSTA = (*(volatile uint16_t *)(0xA0710000 + 0x0008)) & (*(volatile uint16_t *)(0xA0710000 + 0x0004));

    return (((*(volatile uint16_t *)(0xA0710000 + 0x0000)) & (1 << 0)) && (AlmSTA & (1 << 0))) ? true : false;
}
...
TDATETIME RTC_GetDateTime(void)
{
    ...
    DateTime.Time.Sec = (*(volatile uint16_t *)(0xA0710000 + 0x0014));
    DateTime.Time.Min = (*(volatile uint16_t *)(0xA0710000 + 0x0018));
    DateTime.Time.Hour = (*(volatile uint16_t *)(0xA0710000 + 0x001C));

    DateTime.Date.Day = (*(volatile uint16_t *)(0xA0710000 + 0x0020));
    DateTime.Date.DoW = (*(volatile uint16_t *)(0xA0710000 + 0x0024));
    DateTime.Date.Month = (*(volatile uint16_t *)(0xA0710000 + 0x0028));
    DateTime.Date.Year = (*(volatile uint16_t *)(0xA0710000 + 0x002C)) + 2000;
...
boolean RTC_SetDateTime(pDATETIME DateTime)
{
    ...
    if (DateTime == 
# 185 "Source\\Lib\\MT6261\\Drivers\\rtc.c" 3 4
                   ((void *)0)
# 185 "Source\\Lib\\MT6261\\Drivers\\rtc.c"
                       ) return false;
    if (DateTime->Date.Year > (2000 + 127)) return false;
    ...
    {
        (*(volatile uint16_t *)(0xA0710000 + 0x0014)) = DateTime->Time.Sec;
        (*(volatile uint16_t *)(0xA0710000 + 0x0018)) = DateTime->Time.Min;
        (*(volatile uint16_t *)(0xA0710000 + 0x001C)) = DateTime->Time.Hour;
        (*(volatile uint16_t *)(0xA0710000 + 0x002C)) = DateTime->Date.Year - 2000;
        (*(volatile uint16_t *)(0xA0710000 + 0x0028)) = DateTime->Date.Month;
        (*(volatile uint16_t *)(0xA0710000 + 0x0024)) = RTC_DayOfWeek(&DateTime->Date);
        (*(volatile uint16_t *)(0xA0710000 + 0x0020)) = DateTime->Date.Day;
...
TDATETIME RTC_GetAlarmDateTime(void)
{
    ...
    DateTime.Time.Sec = (*(volatile uint16_t *)(0xA0710000 + 0x0030));
    DateTime.Time.Min = (*(volatile uint16_t *)(0xA0710000 + 0x0034));
    DateTime.Time.Hour = (*(volatile uint16_t *)(0xA0710000 + 0x0038));

    DateTime.Date.Day = (*(volatile uint16_t *)(0xA0710000 + 0x003C));
    DateTime.Date.DoW = (*(volatile uint16_t *)(0xA0710000 + 0x0040));
    DateTime.Date.Month = (*(volatile uint16_t *)(0xA0710000 + 0x0044));
    DateTime.Date.Year = (*(volatile uint16_t *)(0xA0710000 + 0x0048)) + 2000;
...
boolean RTC_SetAlarmDateTime(pDATETIME DateTime, boolean UseInterrupt)
{
    ...
    if (DateTime == 
# 232 "Source\\Lib\\MT6261\\Drivers\\rtc.c" 3 4
                   ((void *)0)
# 232 "Source\\Lib\\MT6261\\Drivers\\rtc.c"
                       ) return false;
            ...
            (DateTime->Time.Sec < 60))
    {
        ...
        if (DateTime->Date.Day && (DateTime->Date.Day <= DayInMonth[DateTime->Date.Month] + leap))
        {
            ...
            (*(volatile uint16_t *)(0xA0710000 + 0x0038)) = DateTime->Time.Hour;
            (*(volatile uint16_t *)(0xA0710000 + 0x0034)) = DateTime->Time.Min;
            (*(volatile uint16_t *)(0xA0710000 + 0x0030)) = DateTime->Time.Sec;

            (*(volatile uint16_t *)(0xA0710000 + 0x0048)) = DateTime->Date.Year - 2000;
            (*(volatile uint16_t *)(0xA0710000 + 0x0044)) = DateTime->Date.Month;
            (*(volatile uint16_t *)(0xA0710000 + 0x0040)) = RTC_DayOfWeek(&DateTime->Date);
            (*(volatile uint16_t *)(0xA0710000 + 0x003C)) = DateTime->Date.Day;

            intflags = __disable_interrupts();

            (*(volatile uint16_t *)(0xA0710000 + 0x0008)) = (UseInterrupt) ? (*(volatile uint16_t *)(0xA0710000 + 0x0008)) | (1 << 0) : (*(volatile uint16_t *)(0xA0710000 + 0x0008)) & ~(1 << 0);
            (*(volatile uint16_t *)(0xA0710000 + 0x0010)) = ~((1 << 6) | (1 << 5) | (1 << 3) | (1 << 2) | (1 << 1) | (1 << 0)) & 0x7F;
...
void RTC_SetCIIEnable(uint16_t Intervals, boolean Enable)
{
    ...
    Intervals &= ((1 << 9) | (1 << 8) | (1 << 7) | (1 << 6) |
                  (1 << 5) | (1 << 4) | (1 << 3) | (1 << 2) | (1 << 1) | (1 << 0));

    intflags = __disable_interrupts();
    (*(volatile uint16_t *)(0xA0710000 + 0x000C)) = Intervals;
    (*(volatile uint16_t *)(0xA0710000 + 0x0008)) = (Enable) ? (*(volatile uint16_t *)(0xA0710000 + 0x0008)) | (1 << 1) : (*(volatile uint16_t *)(0xA0710000 + 0x0008)) & ~(1 << 1);
    RTC_UpdateContext();
    __restore_interrupts(intflags);
}
