# 1 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
# 21 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
...
# 22 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 2
# 1 "Source\\Lib\\MT6261\\Drivers\\lcdif.h" 1
# 23 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 2

const uint8_t CFormatToBPP[] = {1, 2, 0, 3, 4, 4, 4};

pLAYER LCDIF_LAYER[LCDIF_NUMLAYERS] = {(volatile pLAYER) &(*(volatile TLAYER*)(0xA0450000 + 0x00B0)),
                                       (volatile pLAYER) &(*(volatile TLAYER*)(0xA0450000 + 0x00E0)),
                                       (volatile pLAYER) &(*(volatile TLAYER*)(0xA0450000 + 0x0110)),
                                       (volatile pLAYER) &(*(volatile TLAYER*)(0xA0450000 + 0x0140))
                                      };
...
{
    (*(volatile uint32_t *)(0xA0450000 + 0x0F80)) = Cmd;
}

void LCDIF_WriteData(uint8_t Data)
{
    (*(volatile uint32_t *)(0xA0450000 + 0x0F90)) = Data;
}

uint8_t LCDIF_ReadData(void)
{
    return (*(volatile uint32_t *)(0xA0450000 + 0x0F90));
}

void LCDIF_SetClock(TLCDSCLOCK Clock)
{
    (*(volatile uint32_t *)(0xA0010000 + 0x011C)) = ((*(volatile uint32_t *)(0xA0010000 + 0x011C)) & ~(((-1) & 0x07) << 4)) | (((Clock) & 0x07) << 4);
}

void LCDIF_StartLCDTransfer(void)
{
    (*(volatile uint16_t *)(0xA0450000 + 0x000C)) = 0;
    (*(volatile uint16_t *)(0xA0450000 + 0x000C)) = (1 << 15);
}

boolean LCDIF_IsQueueRunning(void)
{
    return ((*(volatile uint16_t *)(0xA0450000 + 0x000C)) & (1 << 15)) != 0;
}
...
void LCDIF_DeleteCommandFromQueue(void)
{
    ...
    if (tmpItem != 
# 70 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3 4
                  ((void *)0)
# 70 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
                      )
...
boolean LCDIF_GetCommandFromQueue(void)
{
    ...
    while((tmpItem = DL_GetFirstItem(LCDIFQueue)) != 
# 78 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3 4
                                                    ((void *)0)
# 78 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
                                                        )
    {
        pLCDCMD CMD = tmpItem->Data;

        if (CMD != 
# 82 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3 4
                  ((void *)0)
# 82 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
                      )
        {
            (*(volatile uint32_t *)(0xA0450000 + 0x0084)) = (((CMD->UpdateRect.l + LCDScreen.ScreenOffset.x) & 0x03FF) << 0) |
                              (((CMD->UpdateRect.t + LCDScreen.ScreenOffset.y) & 0x03FF) << 16);
            (*(volatile uint32_t *)(0xA0450000 + 0x0090)) = (((CMD->UpdateRect.r - CMD->UpdateRect.l + 1) & 0x07FF) << 0) |
                              (((CMD->UpdateRect.b - CMD->UpdateRect.t + 1) & 0x07FF) << 16);

            if (CMD->CMDCount)
            {
                uint32_t i;

                for(i = 0; i < CMD->CMDCount; i++) (*(volatile uint32_t *)(0xA0450000 + 0x0C00 + 4 * (i))) = CMD->CmdArray[i];
                (*(volatile uint32_t *)(0xA0450000 + 0x0080)) &= ~((64 - 1) << 8);
                (*(volatile uint32_t *)(0xA0450000 + 0x0080)) |= (((CMD->CMDCount - 1) & 0x003F) << 8) | (1 << 15);
            }
            else (*(volatile uint32_t *)(0xA0450000 + 0x0080)) &= ~(1 << 15);
...
{
    if ((CMD != 
# 118 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3 4
               ((void *)0)
# 118 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
                   ) && DL_AddItemPtr(LCDIFQueue, &CMD->ListHeader))
    {
        LCDIF_RestartQueue();
        while(DL_GetItemsCount(LCDIFQueue) >= 128);
        return true;
    }
    free(CMD);
...
void LCDIF_ISR(void)
{
    ...
    (*(volatile uint16_t *)(0xA0450000 + 0x000C)) = 0;
    if ((IntID = (*(volatile uint16_t *)(0xA0450000 + 0x0008))) & (1 << 0))
    {
        if (LCDIF_GetCommandFromQueue()) (*(volatile uint16_t *)(0xA0450000 + 0x000C)) = (1 << 15);
    }
    else do { printf("Unsolicited LCDIF interrupt code 0x%04X!\r\n", IntID); fflush(
# 138 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3
        (_impure_ptr->_stdout)
# 138 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
        ); } while(0);
}

boolean LCDIF_RegisterISR(void)
{
    return NVIC_RegisterIRQ(0x1C, LCDIF_ISR, 1, true, true);
}

boolean LCDIF_UnregisterISR(void)
{
    return NVIC_UnregisterIRQ(0x1C);
}
...
void LCDIF_DisableInterface(void)
{
    ...
    (*(volatile uint16_t *)(0xA0450000 + 0x0004)) = 0;
    (*(volatile uint16_t *)(0xA0450000 + 0x000C)) = (1 << 0);

    LCDIF_UnregisterISR();

    ILI9341_SleepLCD();
    do { typeof((0x00)) _x = (0x00); if (_x <= (0x2E)) { (*(volatile uint16_t *)(0xA0010000 + 0x0310 + 0x04 * (_x >> 4))) = (1UL << (_x & 0x0F)); } else if (_x <= (0x34)) { (*(volatile uint16_t *)(0xA0730000 + 0x000C)) = (1UL << (_x & 0x0F)); } } while(0);
    do { typeof((0x07)) _x = (0x07); if (_x <= (0x2E)) { (*(volatile uint16_t *)(0xA0010000 + 0x0310 + 0x04 * (_x >> 4))) = (1UL << (_x & 0x0F)); } else if (_x <= (0x34)) { (*(volatile uint16_t *)(0xA0730000 + 0x000C)) = (1UL << (_x & 0x0F)); } } while(0);
...
boolean LCDIF_Initialize(void)
{
    ...
    GPIO_Setup((0x2D), (((0x01) & 0x0F) << 8));
    GPIO_Setup( (0x2E), (((0x01) & 0x0F) << 8));
    GPIO_Setup( (0x2F), (((0x01) & 0x0F) << 8));
    GPIO_Setup( (0x30), (((0x01) & 0x0F) << 8));

    LCDIF_SetClock(LCD_MUX_MPLL_DIV4);
    do { typeof((0x07)) _x = (0x07); if (_x <= (0x2E)) { (*(volatile uint16_t *)(0xA0010000 + 0x0320 + 0x04 * (_x >> 4))) = (1UL << (_x & 0x0F)); } else if (_x <= (0x34)) { (*(volatile uint16_t *)(0xA0730000 + 0x0010)) = (1UL << (_x & 0x0F)); } } while(0);
    do { typeof((0x00)) _x = (0x00); if (_x <= (0x2E)) { (*(volatile uint16_t *)(0xA0010000 + 0x0320 + 0x04 * (_x >> 4))) = (1UL << (_x & 0x0F)); } else if (_x <= (0x34)) { (*(volatile uint16_t *)(0xA0730000 + 0x0010)) = (1UL << (_x & 0x0F)); } } while(0);

    LCDScreen.ScreenRgn = Rect(0, 0, 240 - 1, 320 - 1);
    LCDScreen.ScreenOffset = Point(0, 0);
    LCDScreen.ScreenCount = 1;
    LCDScreen.ScreenIndex = 0;

    LCDScreen.VLayer[0].LayerEnMask = (1UL << 31);
    LCDScreen.VLayer[1].LayerEnMask = (1 << 30);
    LCDScreen.VLayer[2].LayerEnMask = (1 << 29);
    LCDScreen.VLayer[3].LayerEnMask = (1 << 28);
    ...
    if (LCDIFQueue == 
# 193 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3 4
                     ((void *)0)
# 193 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
                         ) LCDIFQueue = DL_Create();
    if ((LCDIFQueue == 
# 194 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3 4
                      ((void *)0)
# 194 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
                          ) || !LCDIF_RegisterISR())
    {
        if (LCDIFQueue == 
# 196 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3 4
                         ((void *)0)
# 196 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
                             )
        {
            do { printf("Failed! (Insufficient memory)\r\n"); fflush(
# 198 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3
           (_impure_ptr->_stdout)
# 198 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
           ); } while(0);
            do { printf(" Total used %uKiB\r\n", GetTotalUsedMemory() >> 10); fflush(
# 199 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3
           (_impure_ptr->_stdout)
# 199 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
           ); } while(0);
        }
        else do { printf("Failed! (Unable to register LCD ISR 0x%02X)\r\n", 0x1C); fflush(
# 201 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3
            (_impure_ptr->_stdout)
# 201 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
            ); } while(0);
        LCDIF_DisableInterface();
        return false;
    }

    (*(volatile uint16_t *)(0xA0450000 + 0x0010)) = (0 << 0);
    USC_Pause_us(1000);
    (*(volatile uint16_t *)(0xA0450000 + 0x0010)) = (1 << 0);

    (*(volatile uint32_t *)(0xA0450000 + 0x001C)) = ((((0) & 0x000F) << 0) | (((0) & 0x000F) << 4) | (((0) & 0x000F) << 8) | (((0) & 0x000F) << 12) | (((0) & 0x000F) << 16) | (((0) & 0x000F) << 20));
    (*(volatile uint32_t *)(0xA0450000 + 0x0028)) = ((0 << 0) | (1 << 3) | (1 << 7) | (1 << 24));

    (*(volatile uint32_t *)(0xA0450000 + 0x0080)) = ((1 << 0) | (0 << 2) | (4 << 3) | (0 << 6));
    (*(volatile uint32_t *)(0xA0450000 + 0x0088)) = (0x08 << 4);
    (*(volatile uint32_t *)(0xA0450000 + 0x008C)) = (0x09 << 4);
    (*(volatile uint32_t *)(0xA0450000 + 0x0084)) = (((0) & 0x03FF) << 0) | (((0) & 0x03FF) << 16);
    (*(volatile uint32_t *)(0xA0450000 + 0x0090)) = (((240) & 0x07FF) << 0) | (((320) & 0x07FF) << 16);
    (*(volatile uint32_t *)(0xA0450000 + 0x009C)) = clBlack;

    if (ILI9341_Initialize())
    {
        (*(volatile uint16_t *)(0xA0450000 + 0x0004)) = (1 << 0);
        LCDScreen.Initialized = true;
        do { printf("Complete.\r\n"); fflush(
# 224 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3
       (_impure_ptr->_stdout)
# 224 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
       ); } while(0);
        return true;
    }

    LCDIF_DisableInterface();
    do { printf("Failed! (Can't initialize LCD driver)\r\n"); fflush(
# 229 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3
   (_impure_ptr->_stdout)
# 229 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
   ); } while(0);
    return false;
}
                         ...
                         TCFORMAT CFormat, uint8_t GlobalAlpha, uint32_t ForeColor)
{
    ...
    (*(volatile uint32_t *)(0xA0450000 + 0x0080)) &= ~LCDScreen.VLayer[Layer].LayerEnMask;
    if (LCDScreen.VLayer[Layer].FrameBuffer != 
# 241 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3 4
                                              ((void *)0)
# 241 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
                                                  )
    {
        free(LCDScreen.VLayer[Layer].FrameBuffer);
        LCDScreen.VLayer[Layer].FrameBuffer = 
# 244 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3 4
                                             ((void *)0)
# 244 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
                                                 ;
    }
    ...
    if (SizeX && SizeY && (CFormat < CF_NUM))
    {
        ...
        if (n)
        {
            ...
            if (LCDScreen.VLayer[Layer].FrameBuffer != 
# 260 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3 4
                                                      ((void *)0)
# 260 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
                                                          )
            {
                LCDIF_LAYER[Layer]->LCDIF_LWINCON = (((0x00) & 0x0007) << 11) | (((CFormat) & 0x07) << 20);
                if ((CFormat == 0x04) || (CFormat == 0x05) || (GlobalAlpha != 0xFF))
                    LCDIF_LAYER[Layer]->LCDIF_LWINCON |= (((GlobalAlpha) & 0x00FF) << 0) | (1 << 8);

                LCDIF_LAYER[Layer]->LCDIF_LWINOFFS = (((Offset.x) & 0x07FF) << 0) | (((Offset.y) & 0x07FF) << 16);
                LCDIF_LAYER[Layer]->LCDIF_LWINADD = (uint32_t)LCDScreen.VLayer[Layer].FrameBuffer;
                LCDIF_LAYER[Layer]->LCDIF_LWINSIZE = (((SizeX) & 0x07FF) << 0) | (((SizeY) & 0x07FF) << 16);
                LCDIF_LAYER[Layer]->LCDIF_LWINSCRL = (((0) & 0x07FF) << 0) | (((0) & 0x07FF) << 16);
                LCDIF_LAYER[Layer]->LCDIF_LWINMOFS = (((0) & 0x07FF) << 0) | (((0) & 0x07FF) << 16);
...
boolean LCDIF_SetLayerEnabled(TVLINDEX Layer, boolean Enabled, boolean UpdateScreen)
{
    ...
    {
        if (Enabled) (*(volatile uint32_t *)(0xA0450000 + 0x0080)) |= LCDScreen.VLayer[Layer].LayerEnMask;
        else (*(volatile uint32_t *)(0xA0450000 + 0x0080)) &= ~LCDScreen.VLayer[Layer].LayerEnMask;
...
boolean LCDIF_GetLayerPosition(TVLINDEX Layer, pRECT Position)
{
    ...
    if (Position != 
# 311 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3 4
                   ((void *)0)
# 311 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
                       )
...
boolean LCDIF_SetLayerPosition(TVLINDEX Layer, TRECT Position, boolean UpdateScreen)
{
            ...
            (Position.r >= 0) && (Position.b >= 0))
    {
        ...
        if (memcmp(&PrevLayerPosition, &Position, sizeof(TRECT)) != 0)
        {
            ...
            while(DL_GetItemsCount(LCDIFQueue) || LCDIF_IsQueueRunning()) {}
            ...
            if (CurrentFrameSize != NewFrameSize)
            {
                ...
                if (p == 
# 346 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3 4
                        ((void *)0)
# 346 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
                            ) return false;
            ...
            LCDIF_LAYER[Layer]->LCDIF_LWINOFFS = (((ModLayer->LayerOffset.x) & 0x07FF) << 0) |
                                                 (((ModLayer->LayerOffset.y) & 0x07FF) << 16);
            LCDIF_LAYER[Layer]->LCDIF_LWINADD = (uint32_t)ModLayer->FrameBuffer;
            LCDIF_LAYER[Layer]->LCDIF_LWINSIZE = (((ModLayer->LayerRgn.r + 1) & 0x07FF) << 0) |
                                                  (((ModLayer->LayerRgn.b + 1) & 0x07FF) << 16);
            ...
            if (UpdateScreen && ModLayer->Enabled)
            {
                ...
                if (UpdateRects != 
# 369 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3 4
                                  ((void *)0)
# 369 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
                                      )
                {
                    uint32_t i;
...
boolean LCDIF_SetScreenPosition(TRECT Position, boolean UpdateScreen)
{
    ...
    if (memcmp(&PrevPosition, &Position, sizeof(TRECT)) != 0)
    {
        ...
        (*(volatile uint32_t *)(0xA0450000 + 0x0084)) = (((LCDScreen.ScreenOffset.x) & 0x03FF) << 0) |
                        (((LCDScreen.ScreenOffset.y) & 0x03FF) << 16);
        (*(volatile uint32_t *)(0xA0450000 + 0x0090)) = (((LCDScreen.ScreenRgn.r - 1) & 0x07FF) << 0) |
                         (((LCDScreen.ScreenRgn.b - 1) & 0x07FF) << 16);
        __restore_interrupts(intflags);
...
void LCDIF_UpdateRectangle(TRECT Rct)
{
    ...
    {
        pLCDCMD Command = ILI9341_SetOutputWindow(&Rct);

        if (Command != 
# 427 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3 4
                      ((void *)0)
# 427 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
                          )
...
{
    if (Rct == 
# 434 "Source\\Lib\\MT6261\\Drivers\\lcdif.c" 3 4
              ((void *)0)
# 434 "Source\\Lib\\MT6261\\Drivers\\lcdif.c"
                  ) return;
