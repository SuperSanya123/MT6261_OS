# 1 "Source\\Lib\\MT6261\\Drivers\\afe.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\Lib\\MT6261\\Drivers\\afe.c"
# 21 "Source\\Lib\\MT6261\\Drivers\\afe.c"
...
# 22 "Source\\Lib\\MT6261\\Drivers\\afe.c" 2
# 1 "Source\\Lib\\MT6261\\Drivers\\afe.h" 1
# 23 "Source\\Lib\\MT6261\\Drivers\\afe.c" 2

static void AFE_SwitchHSon(void)
{
    uint16_t restore;

    (*(volatile uint16_t *)(0xA0720000 + 0x00AC)) |= 0x0003;
    (*(volatile uint16_t *)(0xA0720000 + 0x009C)) |= 0x0003;
    (*(volatile uint16_t *)(0xA0720000 + 0x0080)) |= ((1 << 5) | (1 << 6));
    (*(volatile uint16_t *)(0xA0720000 + 0x0084)) &= (~0x6000);
    (*(volatile uint16_t *)(0xA0720000 + 0x0084)) |= 0x6000;
    restore = (*(volatile uint16_t *)(0xA0720000 + 0x00B4));
    (*(volatile uint16_t *)(0xA0720000 + 0x00B4)) = (restore & ~0x7C00) | 0x2000;
    (*(volatile uint16_t *)(0xA0720000 + 0x00B0)) |= (1 << 0);
    (*(volatile uint16_t *)(0xA0720000 + 0x00B4)) = restore;
    (*(volatile uint16_t *)(0xA0720000 + 0x0084)) &= (~0x1FF0);
    (*(volatile uint16_t *)(0xA0720000 + 0x0084)) |= 0x0800;
    (*(volatile uint16_t *)(0xA0720000 + 0x0080)) |= (1 << 4);
}

static void AFE_SwitchHSoff(void)
{
    uint16_t OrgValue = (*(volatile uint16_t *)(0xA0720000 + 0x00B4));

    (*(volatile uint16_t *)(0xA0720000 + 0x00B0)) &= ~(1 << 0);
    (*(volatile uint16_t *)(0xA0720000 + 0x00B4)) = (0x001E << 10) | (OrgValue & 0x83FF);
    (*(volatile uint16_t *)(0xA0720000 + 0x0084)) &= ~0x1C00;
    (*(volatile uint16_t *)(0xA0720000 + 0x0080)) &= ~(1 << 4);
}
...
static void AFE_SwitchHPon(void)
{
    ...
    (*(volatile uint16_t *)(0xA0720000 + 0x0080)) |= ((1 << 5) | (1 << 6));
    (*(volatile uint16_t *)(0xA0720000 + 0x0084)) &= ~0x6000;
    (*(volatile uint16_t *)(0xA0720000 + 0x0084)) |= 0x4000;
    restore = (*(volatile uint16_t *)(0xA0720000 + 0x00B4));
    (*(volatile uint16_t *)(0xA0720000 + 0x00B4)) = (restore & ~0x03FF) | 0x02F7;
    (*(volatile uint16_t *)(0xA0720000 + 0x00B0)) |= (1 << 0);

    (*(volatile uint16_t *)(0xA0720000 + 0x0080)) |= (1 << 4);
    USC_Pause_us(10);
    (*(volatile uint16_t *)(0xA0720000 + 0x0094)) |= 0x0001;
    USC_Pause_us(10);
    (*(volatile uint16_t *)(0xA0720000 + 0x0080)) |= 0x0001;
    USC_Pause_us(10);
    (*(volatile uint16_t *)(0xA0720000 + 0x0088)) |= 0x0001;
    (*(volatile uint16_t *)(0xA0720000 + 0x0080)) |= 0x000C;
    (*(volatile uint16_t *)(0xA0720000 + 0x0088)) &= (~0x0001);

    tmp = (*(volatile uint16_t *)(0xA0720000 + 0x0084)) & ~0x1FF0;
    (*(volatile uint16_t *)(0xA0720000 + 0x0084)) = tmp | 0x0120;
    (*(volatile uint16_t *)(0xA0720000 + 0x0094)) &= ~0x0001;
    (*(volatile uint16_t *)(0xA0720000 + 0x0080)) &= ~(1 << 4);
    (*(volatile uint16_t *)(0xA0720000 + 0x0090)) &= ~((1 << 6) | (1 << 0));
    (*(volatile uint16_t *)(0xA0720000 + 0x00B4)) = restore;
}
...
static void AFE_SwitchHPoff(void)
{
    ...
    (*(volatile uint16_t *)(0xA0720000 + 0x0090)) |= (1 << 0);
    USC_Pause_us(10);
    (*(volatile uint16_t *)(0xA0720000 + 0x0090)) |= (1 << 6);
    USC_Pause_us(10);
    (*(volatile uint16_t *)(0xA0720000 + 0x00B0)) &= ~(1 << 0);
    (*(volatile uint16_t *)(0xA0720000 + 0x00B4)) = (0x000E << 1) | (0x000E << 6) | (OrgValue & 0xFC21);
    (*(volatile uint16_t *)(0xA0720000 + 0x0080)) &= ~((1 << 0) | (1 << 2) | (1 << 3));
    (*(volatile uint16_t *)(0xA0720000 + 0x0084)) &= ~0x03F0;
}
...
static void AFE_DCLKCtrlSeq(boolean TurnOn, boolean Audio, TAV_PATH Path)
{
    ...
    if (TurnOn)
    {
        *(volatile uint16_t *)(0xA001022C) = *(volatile uint16_t *)(0xA001022C) | 0x0013;
        ...
        (*(volatile uint16_t *)(0xA0720000 + 0x00A0)) |= (1 << 1);
        (*(volatile uint16_t *)(0xA0720000 + 0x00A8)) = (1 << 12) | 0x0406;
        (*(volatile uint16_t *)(0xA0720000 + 0x00A4)) |= 0x0001;
        (*(volatile uint16_t *)(0xA0720000 + 0x00AC)) |= 0x0003;
        USC_Pause_us(1);

        if (Audio) (*(volatile uint16_t *)(0xA0720000 + 0x009C)) |= 0x0003;
        else (*(volatile uint16_t *)(0xA0720000 + 0x009C)) = ((*(volatile uint16_t *)(0xA0720000 + 0x009C)) & ~0x0003) | 0x0002;

        (*(volatile uint16_t *)(0xA0720000 + 0x0080)) |= ((1 << 5) | (1 << 6));
        (*(volatile uint16_t *)(0xA0720000 + 0x00BC)) = 0x11A1;
        (*(volatile uint16_t *)(0xA0720000 + 0x00B8)) |= 0x0001;

        (*(volatile uint16_t *)(0x82C00000 + 0x0028)) = (1 << 8);

        if (Audio)
        {
            (*(volatile uint16_t *)(0x82CD0000 + 0x0214)) = ((*(volatile uint16_t *)(0x82CD0000 + 0x0214)) & ~((1 << 3) | (1 << 2) | (1 << 1) | (1 << 0))) | (1 << 3) | (1 << 2);
            (*(volatile uint16_t *)(0x82CD0000 + 0x0020)) |= (1 << 0);
        }
        else
        {
            if (Path == DL_PATH)
                ...
                (*(volatile uint16_t *)(0x82CD0000 + 0x0214)) = ((*(volatile uint16_t *)(0x82CD0000 + 0x0214)) & ~((1 << 3) | (1 << 2) | (1 << 1) | (1 << 0))) | (1 << 1) | (1 << 0);
            else (*(volatile uint16_t *)(0x82CD0000 + 0x0214)) |= ((1 << 3) | (1 << 2) | (1 << 1) | (1 << 0));

            (*(volatile uint16_t *)(0x82CD0000 + 0x0000)) |= (1 << 0);
        }
        (*(volatile uint16_t *)(0x82CD0000 + 0x0210)) = (1 << 0);
    }
    else
    {
        (*(volatile uint16_t *)(0xA0720000 + 0x0080)) &= ~((1 << 5) | (1 << 6));
        ...
        if (Audio) (*(volatile uint16_t *)(0x82CD0000 + 0x0020)) &= ~(1 << 0);
        else (*(volatile uint16_t *)(0x82CD0000 + 0x0000)) &= ~(1 << 0);

        (*(volatile uint16_t *)(0x82CD0000 + 0x0214)) &= ~((1 << 3) | (1 << 2) | (1 << 1) | (1 << 0));

        (*(volatile uint16_t *)(0x82C00000 + 0x0018)) = (1 << 8);

        (*(volatile uint16_t *)(0xA0720000 + 0x00B8)) &= ~0x0001;
        (*(volatile uint16_t *)(0xA0720000 + 0x00BC)) = 0x1021;
        (*(volatile uint16_t *)(0xA0720000 + 0x00A4)) &= ~0x0001;
...
static void AFE_SwitchIntAmp(boolean On)
{
    if (On)
    {
        ...
        (*(volatile uint16_t *)(0xA0700000 + 0x0D0C)) = 0x4800;
        (*(volatile uint16_t *)(0xA0700000 + 0x0D18)) = 0x0988;
        (*(volatile uint16_t *)(0xA0700000 + 0x0D1C)) = 0x0180;
        USC_Pause_us(2000);
        (*(volatile uint16_t *)(0xA0700000 + 0x0D1C)) = 0x0100;


        (*(volatile uint16_t *)(0xA0720000 + 0x0080)) |= (1 << 4);
        USC_Pause_us(10);
        (*(volatile uint16_t *)(0xA0720000 + 0x0084)) |= 0x0004;
        ...
        (*(volatile uint16_t *)(0xA0700000 + 0x0D1C)) |= (1 << 7);
        AFE_TurnOnSpeaker(true);
        USC_Pause_us(2000);
        (*(volatile uint16_t *)(0xA0700000 + 0x0D0C)) |= (1 << 14);
        (*(volatile uint16_t *)(0xA0700000 + 0x0D1C)) &= ~(1 << 7);

        {
            int16_t targ_gain = restore & 0x7C00;
            int16_t curr_gain = (*(volatile uint16_t *)(0xA0720000 + 0x00B4)) & 0x7C00;
            int16_t gain_step = targ_gain >= curr_gain ? 0x0400 : -0x0400;

            while (curr_gain != targ_gain)
            {
                curr_gain += gain_step;
                (*(volatile uint16_t *)(0xA0720000 + 0x00B4)) = curr_gain | (restore & ~0x7C00);
                USC_Pause_us(500);
            }
        }
        (*(volatile uint16_t *)(0xA0720000 + 0x00B4)) = restore;
    ...
    {
        (*(volatile uint16_t *)(0xA0720000 + 0x0084)) &= ~0x0004;
        (*(volatile uint16_t *)(0xA0700000 + 0x0D0C)) |= (1 << 11);
        AFE_TurnOnSpeaker(false);
        (*(volatile uint16_t *)(0xA0700000 + 0x0D0C)) &= ~(1 << 14);
        (*(volatile uint16_t *)(0xA0700000 + 0x0D1C)) &= ~(1 << 10);
    }
}
...
static void AFE_ChipInitialization(void)
{
    ...
    (*(volatile uint16_t *)(0x82CD0000 + 0x0024)) = 0x0C00 | (((0x08) & 0x0F) << 6) | (((0) & 0x03) << 4);
    (*(volatile uint16_t *)(0x82CD0000 + 0x0180)) = 0x0002;
    (*(volatile uint16_t *)(0x82CD0000 + 0x001C)) = 0x0002;
    (*(volatile uint16_t *)(0x82CD0000 + 0x0010)) = (1 << 11) | (((0x3C) & 0x3F) << 0);
    (*(volatile uint16_t *)(0x82CD0000 + 0x002C)) = (((0x3C) & 0x3F) << 0);
    (*(volatile uint16_t *)(0x82CD0000 + 0x000C)) = (1 << 7);

    (*(volatile uint16_t *)(0xA0720000 + 0x0050)) |= (((0x2) & 0x1F) << 6);


    (*(volatile uint16_t *)(0xA0720000 + 0x00A0)) |= ((1 << 1));
    (*(volatile uint16_t *)(0xA0720000 + 0x0090)) = 0x198 | (1 << 5) | (1 << 0);
    USC_Pause_us(10);
    (*(volatile uint16_t *)(0xA0720000 + 0x0090)) |= 0x0040;

    (*(volatile uint16_t *)(0xA0720000 + 0x00A8)) = (1 << 12) | 0x0406;
    (*(volatile uint16_t *)(0xA0720000 + 0x00A4)) |= 0x0001;


    AFE_SetSpeakerVolume(0);
# 257 "Source\\Lib\\MT6261\\Drivers\\afe.c"
}

void AFE_SetSpeakerVolume(uint8_t Volume)
{
    (*(volatile uint16_t *)(0xA0700000 + 0x0D00)) = ((*(volatile uint16_t *)(0xA0700000 + 0x0D00)) & ~(((-1) & 0x03) << 4)) | (((Volume) & 0x03) << 4);
}

void AFE_TurnOnSpeaker(boolean On)
{
    if (On) (*(volatile uint16_t *)(0xA0700000 + 0x0D00)) |= (1 << 0);
    else (*(volatile uint16_t *)(0xA0700000 + 0x0D00)) &= ~(1 << 0);
}
...
boolean AFE_SetAudioSampleRate(TASR Rate)
{
    ...
    case ASR_44KHZ:
    case ASR_48KHZ:
        (*(volatile uint16_t *)(0x82CD0000 + 0x0024)) = ((*(volatile uint16_t *)(0x82CD0000 + 0x0024)) & ~(((-1) & 0x0F) << 6)) | (((Rate) & 0x0F) << 6);
        return true;
    default:
        return false;
    }
...
void AFE_initialize(void)
{
    ...
    (*(volatile uint16_t *)(0xA0700000 + 0x0D00)) = (((3) & 0x03) << 4) | (1 << 0);

    (*(volatile uint16_t *)(0xA0720000 + 0x00B4)) = (((0x10) & 0x1F) << 10) | (((0x1F) & 0x1F) << 5) | (((0x1F) & 0x1F) << 0);
    USC_Pause_us(5000);
}

void Beep(void)
{
    (*(volatile uint16_t *)(0x82CD0000 + 0x0030)) = (1 << 15) | (1 << 14) | (((7) & 0x07) << 8) | (((22) & 0x00FF) << 0);
    USC_Pause_us(50000);
    (*(volatile uint16_t *)(0x82CD0000 + 0x0030)) &= ~((1 << 15) | (1 << 14));
}
