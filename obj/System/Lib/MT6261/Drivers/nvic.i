...
static TIRQHANDLER IRQHandlers[0x35];
static TEINTHANDLER EINTHandlers[0x19];

static TIRQHANDLER AIRQHandlers[0x04];
static TEINTHANDLER AEINTHandlers[0x0E];

static uint32_t NVIC_GetIRQStatus2(void)
{
    return (*(volatile uint32_t *)(0xA0060000 + 0x01A0));
}

static uint32_t NVIC_GetFIQStatus2(void)
{
    return (*(volatile uint32_t *)(0xA0060000 + 0x01A4));
}

static uint32_t NVIC_GetEINTStatus2(void)
{
    return __ctz((*(volatile uint32_t *)(0xA0060000 + 0x0300)));
}

static uint32_t NVIC_GetAIRQStatus2(void)
{
    return (*(volatile uint16_t *)(0xA0760000 + 0x01A0));
}

static uint32_t NVIC_GetAEINTStatus2(void)
{
    return __ctz((*(volatile uint16_t *)(0xA0760000 +0x0300)) & 0xFFFF);
}

static void NVIC_SetIRQ_EOI(uint32_t SourceIdx)
{
    if (SourceIdx < 0x35) (*(volatile uint32_t *)(0xA0060000 + 0x01A8)) = SourceIdx;
}

static void NVIC_SetAIRQ_EOI(uint32_t SourceIdx)
{
    if (SourceIdx < 0x04) (*(volatile uint16_t *)(0xA0760000 + 0x01A8)) = SourceIdx;
}

static void NVIC_SetEINT_EOI(uint32_t SourceIdx)
{
    if (SourceIdx < 0x19) (*(volatile uint32_t *)(0xA0060000 + 0x0308)) = (1 << SourceIdx);
}

static void NVIC_SetAEINT_EOI(uint32_t SourceIdx)
{
    if (SourceIdx < 0x0E) (*(volatile uint16_t *)(0xA0760000 +0x0308)) = (1 << SourceIdx);
}
...
static void NVIC_UnmaskIRQ2(uint32_t SourceIdx)
{
    if (SourceIdx < 0x35)
    {
        if (SourceIdx < 32)
        {
            (*(volatile uint32_t *)(0xA0060000 + 0x0040)) = (1 << SourceIdx);
            return;
        }
        SourceIdx -= 32;
        (*(volatile uint32_t *)(0xA0060000 + 0x0044)) = (1 << SourceIdx);
        return;
    }
    if ((SourceIdx >= 0x40) && (SourceIdx < (0x40 + 0x04)))
    {
        SourceIdx -= 0x40;
        (*(volatile uint16_t *)(0xA0760000 + 0x0040)) = (1 << SourceIdx);
    }
}
...
static void NVIC_MaskIRQ2(uint32_t SourceIdx)
{
    if (SourceIdx < 0x35)
    {
        if (SourceIdx < 32)
        {
            (*(volatile uint32_t *)(0xA0060000 + 0x0020)) = (1 << SourceIdx);
            return;
        }
        SourceIdx -= 32;
        (*(volatile uint32_t *)(0xA0060000 + 0x0024)) = (1 << SourceIdx);
        return;
    }
    if ((SourceIdx >= 0x40) && (SourceIdx < (0x40 + 0x04)))
    {
        SourceIdx -= 0x40;
        (*(volatile uint16_t *)(0xA0760000 + 0x0020)) = (1 << SourceIdx);
    }
}
...
static void NVIC_SetIRQSenseEdge(uint32_t SourceIdx)
{
    if (SourceIdx < 0x35)
    {
        if (SourceIdx < 32)
        {
            (*(volatile uint32_t *)(0xA0060000 + 0x00A0)) = (1 << SourceIdx);
            return;
        }
        SourceIdx -= 32;
        (*(volatile uint32_t *)(0xA0060000 + 0x00A4)) = (1 << SourceIdx);
        return;
    }
    if ((SourceIdx >= 0x40) && (SourceIdx < (0x40 + 0x04)))
    {
        SourceIdx -= 0x40;
        (*(volatile uint16_t *)(0xA0760000 + 0x00A0)) = (1 << SourceIdx);
    }
}
...
static void NVIC_SetIRQSenseLevel(uint32_t SourceIdx)
{
    if (SourceIdx < 0x35)
    {
        if (SourceIdx < 32)
        {
            (*(volatile uint32_t *)(0xA0060000 + 0x0080)) = (1 << SourceIdx);
            return;
        }
        SourceIdx -= 32;
        (*(volatile uint32_t *)(0xA0060000 + 0x0084)) = (1 << SourceIdx);
        return;
    }
    if ((SourceIdx >= 0x40) && (SourceIdx < (0x40 + 0x04)))
    {
        SourceIdx -= 0x40;
        (*(volatile uint16_t *)(0xA0760000 + 0x0080)) = (1 << SourceIdx);
    }
}
...
{
    if (SourceIdx < 0x19) (*(volatile uint32_t *)(0xA0060000 + 0x0328)) = (1 << SourceIdx);
    else if (SourceIdx < (0x19 + 0x0E))
    {
        SourceIdx -= 0x19;
        (*(volatile uint16_t *)(0xA0760000 + 0x0328)) = (1 << SourceIdx);
    }
}

static void NVIC_MaskEINT2(uint32_t SourceIdx)
{
    if (SourceIdx < 0x19) (*(volatile uint32_t *)(0xA0060000 + 0x0320)) = (1 << SourceIdx);
    else if (SourceIdx < (0x19 + 0x0E))
    {
        SourceIdx -= 0x19;
        (*(volatile uint16_t *)(0xA0760000 + 0x0320)) = (1 << SourceIdx);
    }
}

static void NVIC_SetEINTSenseEdge(uint32_t SourceIdx)
{
    if (SourceIdx < 0x19) (*(volatile uint32_t *)(0xA0060000 + 0x0340)) = (1 << SourceIdx);
    else if (SourceIdx < (0x19 + 0x0E))
    {
        SourceIdx -= 0x19;
        (*(volatile uint16_t *)(0xA0760000 + 0x0340)) = (1 << SourceIdx);
    }
}

static void NVIC_SetEINTSenseLevel(uint32_t SourceIdx)
{
    if (SourceIdx < 0x19) (*(volatile uint32_t *)(0xA0060000 + 0x0338)) = (1 << SourceIdx);
    else if (SourceIdx < (0x19 + 0x0E))
    {
        SourceIdx -= 0x19;
        (*(volatile uint16_t *)(0xA0760000 + 0x0338)) = (1 << SourceIdx);
    }
}
...
static void NVIC_SetEINTPolarity(uint32_t SourceIdx, uint8_t Polarity)
{
    if (Polarity)
    {
        if (SourceIdx < 0x19) (*(volatile uint32_t *)(0xA0060000 + 0x0380 + 0x04 * (SourceIdx))) |= (1 << 11);
        else if (SourceIdx < (0x19 + 0x0E))
        {
            SourceIdx -= 0x19;
            (*(volatile uint16_t *)(0xA0760000 + 0x0380 + 0x04 * (SourceIdx))) |= (1 << 11);
        }
    }
    else
    {
...
{
    if (SourceIdx < 0x19) (*(volatile uint32_t *)(0xA0060000 + 0x0360)) |= (1 << SourceIdx);
    else if (SourceIdx < (0x19 + 0x0E))
    {
        SourceIdx -= 0x19;
        (*(volatile uint16_t *)(0xA0760000 + 0x0360)) |= (1 << SourceIdx);
    }
}
...
static void NVIC_SetEINTDebounce(uint32_t SourceIdx, uint16_t Debounce)
{
    ...
    if (SourceIdx < 0x19)
    {
        Masked = ((*(volatile uint32_t *)(0xA0060000 + 0x0318)) & (1 << SourceIdx)) ? true : false;
        if (!Masked) NVIC_MaskEINT2(SourceIdx);
        (*(volatile uint32_t *)(0xA0060000 + 0x0380 + 0x04 * (SourceIdx))) = Debounce & ~(1 << 15);
        USC_Pause_us(50);
        (*(volatile uint32_t *)(0xA0060000 + 0x0380 + 0x04 * (SourceIdx))) = Debounce;
        NVIC_SetEINT_EOI(SourceIdx);
        if (!Masked) NVIC_UnmaskEINT2(SourceIdx);
    }
    else if (SourceIdx < (0x19 + 0x0E))
    {
        SourceIdx -= 0x19;

        Masked = ((*(volatile uint16_t *)(0xA0760000 + 0x0318)) & (1 << SourceIdx)) ? true : false;
        if (!Masked) NVIC_MaskEINT2(SourceIdx + 0x19);
        (*(volatile uint16_t *)(0xA0760000 + 0x0380 + 0x04 * (SourceIdx))) &= ~((0x07 << 12) | (1 << 15));
        USC_Pause_us(50);
        (*(volatile uint16_t *)(0xA0760000 + 0x0380 + 0x04 * (SourceIdx))) = Debounce;
        USC_Pause_us(50);
        (*(volatile uint16_t *)(0xA0760000 + 0x0410)) |= 1 << SourceIdx;
        USC_Pause_us(50);
        NVIC_SetAEINT_EOI(SourceIdx);
        if (!Masked) NVIC_UnmaskEINT2(SourceIdx + 0x19);
    }
}
...
void NVIC_ChangeInterruptMode(uint32_t SourceIdx, boolean ModeIRQ)
{
    ...
    do
    {
        if (SourceIdx < 0x35)
        {
            if (SourceIdx < 32)
            {
                if (ModeIRQ) (*(volatile uint32_t *)(0xA0060000 + 0x0180)) &= ~(1 << SourceIdx);
                else (*(volatile uint32_t *)(0xA0060000 + 0x0180)) |= (1 << SourceIdx);
                break;
            }
            SourceIdx -= 32;
            if (ModeIRQ) (*(volatile uint32_t *)(0xA0060000 + 0x0184)) &= ~(1 << SourceIdx);
            else (*(volatile uint32_t *)(0xA0060000 + 0x0184)) |= (1 << SourceIdx);
            break;
        }
        if ((SourceIdx >= 0x40) && (SourceIdx < (0x40 + 0x04)))
        {
            SourceIdx -= 0x40;
            if (ModeIRQ) (*(volatile uint16_t *)(0xA0760000 + 0x0180)) &= ~(1 << SourceIdx);
            else (*(volatile uint16_t *)(0xA0760000 + 0x0180)) |= (1 << SourceIdx);
        }
    }
    while(0);
...
void NVIC_C_IRQ_Handler(void)
{
    ...
    while((IRQSrcIdx = NVIC_GetIRQStatus2()) != (1 << 8))
    {
        IRQSrcIdx &= 0x3F;
        if (IRQHandlers[IRQSrcIdx].Handler != 
# 308 "Source\\Lib\\MT6261\\Drivers\\nvic.c" 3 4
                                             ((void *)0)
# 308 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
                                                 )
        ...
        {
            do { printf("\r\nUnhandled IRQ 0x%02X", IRQSrcIdx); fflush(
# 312 "Source\\Lib\\MT6261\\Drivers\\nvic.c" 3
           (_impure_ptr->_stdout)
# 312 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
           ); } while(0);
        }
...
void NVIC_C_FIQ_Handler(void)
{
    ...
    while((FIQSrcIdx = NVIC_GetFIQStatus2()) != (1 << 8))
    {
        FIQSrcIdx &= 0x3F;
        if (IRQHandlers[FIQSrcIdx].Handler != 
# 325 "Source\\Lib\\MT6261\\Drivers\\nvic.c" 3 4
                                             ((void *)0)
# 325 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
                                                 )
        ...
        {
            do { printf("\r\nUnhandled FIQ 0x%02X", FIQSrcIdx); fflush(
# 329 "Source\\Lib\\MT6261\\Drivers\\nvic.c" 3
           (_impure_ptr->_stdout)
# 329 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
           ); } while(0);
        }
...
void NVIC_ADIE_C_IRQ_Handler(void)
{
    ...
    while((AIRQSrcIdx = NVIC_GetAIRQStatus2()) != (1 << 8))
    {
        AIRQSrcIdx &= 0x03;
        if (AIRQHandlers[AIRQSrcIdx].Handler != 
# 342 "Source\\Lib\\MT6261\\Drivers\\nvic.c" 3 4
                                               ((void *)0)
# 342 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
                                                   )
        ...
        {
            do { printf("\r\nUnhandled AIRQ 0x%02X", AIRQSrcIdx); fflush(
# 346 "Source\\Lib\\MT6261\\Drivers\\nvic.c" 3
           (_impure_ptr->_stdout)
# 346 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
           ); } while(0);
        }
...
void NVIC_EINTCHandler(void)
{
    ...
    if ((EINTSrcIdx < 0x19) && (EINTHandlers[EINTSrcIdx].Handler != 
# 356 "Source\\Lib\\MT6261\\Drivers\\nvic.c" 3 4
                                                                               ((void *)0)
# 356 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
                                                                                   ))
    ...
    {
        do { printf("\r\nUnhandled EINT 0x%02X", EINTSrcIdx); fflush(
# 360 "Source\\Lib\\MT6261\\Drivers\\nvic.c" 3
       (_impure_ptr->_stdout)
# 360 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
       ); } while(0);
    }
...
void NVIC_AEINTCHandler(void)
{
    ...
    if ((AEINTSrcIdx < 0x0E) && (AEINTHandlers[AEINTSrcIdx].Handler != 
# 369 "Source\\Lib\\MT6261\\Drivers\\nvic.c" 3 4
                                                                                       ((void *)0)
# 369 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
                                                                                           ))
    ...
    {
        do { printf("\r\nUnhandled AEINT 0x%02X", AEINTSrcIdx); fflush(
# 373 "Source\\Lib\\MT6261\\Drivers\\nvic.c" 3
       (_impure_ptr->_stdout)
# 373 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
       ); } while(0);
    }
...
void NVIC_Initialize(void)
{
    ...
    (*(volatile uint32_t *)(0xA0060000 + 0x0020)) = 0xFFFFFFFF;
    (*(volatile uint32_t *)(0xA0060000 + 0x0024)) = 0xFFFFFFFF;
    (*(volatile uint32_t *)(0xA0060000 + 0x0320)) = 0xFFFFFFFF;
    (*(volatile uint32_t *)(0xA0060000 + 0x0360)) = 0;

    (*(volatile uint16_t *)(0xA0760000 + 0x0020)) = 0xFFFF;
    (*(volatile uint16_t *)(0xA0760000 + 0x0320)) = 0xFFFF;
    (*(volatile uint16_t *)(0xA0760000 + 0x0360)) = 0;

    for(i = 0; i < 0x12; i++)
        do { typeof(i) _x = i; (*(volatile uint32_t *)(0xA0060000 + 0x0200 + 4 * (_x >> 2))) &= ~(0xFF << (8 * (_x & 0x03))); (*(volatile uint32_t *)(0xA0060000 + 0x0200 + 4 * (_x >> 2))) |= ((i) & 0x3F) << (8 * (_x & 0x03)); } while(0);

    memset(IRQHandlers, 0x00, sizeof(IRQHandlers));
    memset(EINTHandlers, 0x00, sizeof(EINTHandlers));

    for(i = 0; i < 0x04; i++)
        do { typeof(i) _x = i; (*(volatile uint16_t *)(0xA0760000 + 0x0200 + 4 * ((_x) >> 1))) &= ~(0x03 << (8 * ((_x) & 0x01))); (*(volatile uint16_t *)(0xA0760000 + 0x0200 + 4 * ((_x) >> 1))) |= ((i) & 0x03) << (8 * ((_x) & 0x01)); } while(0);

    memset(AIRQHandlers, 0x00, sizeof(AIRQHandlers));
    memset(AEINTHandlers, 0x00, sizeof(AEINTHandlers));

    while((i = NVIC_GetIRQStatus2()) != (1 << 8)) NVIC_SetIRQ_EOI(i);
    while((i = NVIC_GetAIRQStatus2()) != (1 << 8)) NVIC_SetAIRQ_EOI(i);

    (*(volatile uint32_t *)(0xA0060000 + 0x0308)) = 0xFFFFFFFF;
    (*(volatile uint16_t *)(0xA0760000 +0x0308)) = 0xFFFF;
    NVIC_RegisterIRQ(0x18, NVIC_EINTCHandler, 0, true, true);
    NVIC_RegisterIRQ((0x00 + 0x40), NVIC_AEINTCHandler, 0, true, true);
    NVIC_RegisterIRQ(0x0A, NVIC_ADIE_C_IRQ_Handler, 1, true, true);
...
# 420 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
        ...
        else
        {
            ...
            if (Sense == 0) NVIC_SetIRQSenseEdge(SourceIdx);
    ...
    else if ((SourceIdx >= 0x40) && (SourceIdx < (0x40 + 0x04)))
    {
        if (Handler == 
# 438 "Source\\Lib\\MT6261\\Drivers\\nvic.c" 3 4
                      ((void *)0)
# 438 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
                          ) NVIC_UnregisterIRQ(SourceIdx);
        else
...
boolean NVIC_UnregisterIRQ(uint32_t SourceIdx)
{
    ...
    if (SourceIdx < 0x35)
    {
        ...
        IRQHandlers[SourceIdx].Handler = 
# 466 "Source\\Lib\\MT6261\\Drivers\\nvic.c" 3 4
                                        ((void *)0)
# 466 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
                                            ;
        __restore_interrupts(intflags);
    ...
    if ((SourceIdx >= 0x40) && (SourceIdx < (0x40 + 0x04)))
    {
        intflags = __disable_interrupts();
        NVIC_MaskIRQ2(SourceIdx);
        AIRQHandlers[SourceIdx - 0x40].Handler = 
# 474 "Source\\Lib\\MT6261\\Drivers\\nvic.c" 3 4
                                                             ((void *)0)
# 474 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
                                                                 ;
        __restore_interrupts(intflags);
...
# 488 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
        ...
        if (Sense == 0) NVIC_SetEINTSenseEdge(SourceIdx);
    ...
    if (SourceIdx < (0x19 + 0x0E))
    {
        if (Handler == 
# 511 "Source\\Lib\\MT6261\\Drivers\\nvic.c" 3 4
                      ((void *)0)
# 511 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
                          )
        {
        ...
        if (AEINTHandlers[SourceIdx - 0x19].Handler == Handler) return true;

        intflags = __disable_interrupts();
        AEINTHandlers[SourceIdx - 0x19].Handler = Handler;

        if (Sense == 0) NVIC_SetEINTSenseEdge(SourceIdx);
        else NVIC_SetEINTSenseLevel(SourceIdx);
        NVIC_SetEINTDebounce(SourceIdx, Debounce);
        NVIC_SetEINTPolarity(SourceIdx, !!Polarity);
        (*(volatile uint16_t *)(0xA0760000 + 0x0410)) = (1 << (SourceIdx - 0x19));
...
boolean NVIC_UnregisterEINT(uint32_t SourceIdx)
{
    ...
    if (SourceIdx < 0x19)
    {
        ...
        EINTHandlers[SourceIdx].Handler = 
# 545 "Source\\Lib\\MT6261\\Drivers\\nvic.c" 3 4
                                         ((void *)0)
# 545 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
                                             ;
    ...
    if (SourceIdx < (0x19 + 0x0E))
    {
        intflags = __disable_interrupts();
        NVIC_MaskEINT2(SourceIdx);
        AEINTHandlers[SourceIdx - 0x19].Handler = 
# 554 "Source\\Lib\\MT6261\\Drivers\\nvic.c" 3 4
                                                             ((void *)0)
# 554 "Source\\Lib\\MT6261\\Drivers\\nvic.c"
                                                                 ;
        NVIC_SetEINTDebounce(SourceIdx, 0x0000);
...
{
    if ((SourceIdx < 0x35) || ((SourceIdx >= 0x40) && (SourceIdx < (0x40 + 0x04))))
    {
        uint32_t intflags = __disable_interrupts();
