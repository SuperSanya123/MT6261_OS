# 1 "Source\\Application\\Drivers\\ili9341.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\Application\\Drivers\\ili9341.c"
# 21 "Source\\Application\\Drivers\\ili9341.c"
...
# 22 "Source\\Application\\Drivers\\ili9341.c" 2

# 1 "Source\\Application\\Drivers\\ili9341.h" 1
# 24 "Source\\Application\\Drivers\\ili9341.c" 2

boolean ILI9341_Initialize(void)
{
    LCDIF_WriteCommand(0xC0);
    LCDIF_WriteData((((0x23) & 0x3F) << 0));

    LCDIF_WriteCommand(0xC1);
    LCDIF_WriteData((((0x10) & 0x07) << 0));

    LCDIF_WriteCommand(0xC5);
    LCDIF_WriteData((((0x3E) & 0x7F) << 0));
    LCDIF_WriteData((((0x28) & 0x7F) << 0));

    LCDIF_WriteCommand(0x36);
    LCDIF_WriteData((0 << 3));

    LCDIF_WriteCommand(0x3A);
    LCDIF_WriteData((((0x06) & 0x07) << 4) | (((0x06) & 0x07) << 0));

    LCDIF_WriteCommand(0xB1);
    LCDIF_WriteData((((0x00) & 0x03) << 0));
    LCDIF_WriteData((((0x18) & 0x1F) << 0));

    LCDIF_WriteCommand(0xB6);
    LCDIF_WriteData((((0x02) & 0x03) << 2) | (((0x00) & 0x03) << 0));
    LCDIF_WriteData((1 << 7) | (((0x02) & 0x0F) << 0));
    LCDIF_WriteData((((0x1D) & 0x3F) << 0));

    LCDIF_WriteCommand(0x11);
    LCDIF_WriteCommand(0x29);
...
{
    LCDIF_WriteCommand(0x28);
    LCDIF_WriteCommand(0x10);
}
...
{
    pLCDCMD Command = 
# 72 "Source\\Application\\Drivers\\ili9341.c" 3 4
                     ((void *)0)
# 72 "Source\\Application\\Drivers\\ili9341.c"
                         ;

    if (Rct != 
# 74 "Source\\Application\\Drivers\\ili9341.c" 3 4
              ((void *)0)
# 74 "Source\\Application\\Drivers\\ili9341.c"
                  )
    {
        uint32_t i = 0;

        Command = malloc(sizeof(TLCDCMD) + 11 * sizeof(uint32_t));
        if (Command != 
# 79 "Source\\Application\\Drivers\\ili9341.c" 3 4
                      ((void *)0)
# 79 "Source\\Application\\Drivers\\ili9341.c"
                          )
        {
            Command->CMDCount = 11;
            Command->UpdateRect = *Rct;

            Command->CmdArray[i++] = (((0x2A) & 0x7FFFFF) << 0) | (1 << 23);
            Command->CmdArray[i++] = ((((((Rct->l) & 0xFF00) >> 8)) & 0x7FFFFF) << 0) | (0 << 23);
            Command->CmdArray[i++] = (((((Rct->l) & 0xFF)) & 0x7FFFFF) << 0) | (0 << 23);
            Command->CmdArray[i++] = ((((((Rct->r) & 0xFF00) >> 8)) & 0x7FFFFF) << 0) | (0 << 23);
            Command->CmdArray[i++] = (((((Rct->r) & 0xFF)) & 0x7FFFFF) << 0) | (0 << 23);

            Command->CmdArray[i++] = (((0x2B) & 0x7FFFFF) << 0) | (1 << 23);
            Command->CmdArray[i++] = ((((((Rct->t + 0x00) & 0xFF00) >> 8)) & 0x7FFFFF) << 0) | (0 << 23);
            Command->CmdArray[i++] = (((((Rct->t + 0x00) & 0xFF)) & 0x7FFFFF) << 0) | (0 << 23);
            Command->CmdArray[i++] = ((((((Rct->b + 0x00) & 0xFF00) >> 8)) & 0x7FFFFF) << 0) | (0 << 23);
            Command->CmdArray[i++] = (((((Rct->b + 0x00) & 0xFF)) & 0x7FFFFF) << 0) | (0 << 23);

            Command->CmdArray[i++] = (((0x2C) & 0x7FFFFF) << 0) | (1 << 23);
        }
    }
    return Command;
}
