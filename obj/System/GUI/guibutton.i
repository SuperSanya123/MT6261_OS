# 1 "Source\\GUI\\guibutton.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\GUI\\guibutton.c"
# 21 "Source\\GUI\\guibutton.c"
...
# 22 "Source\\GUI\\guibutton.c" 2
# 1 "Source\\GUI\\guiobject.h" 1
# 23 "Source\\GUI\\guibutton.c" 2
# 1 "Source\\GUI\\guibutton.h" 1
# 24 "Source\\GUI\\guibutton.c" 2
...
static void GUI_DisableButtonTimer(void)
{
    ...
    ButtonTimer = 
# 36 "Source\\GUI\\guibutton.c" 3 4
                 ((void *)0)
# 36 "Source\\GUI\\guibutton.c"
                     ;
    ArepeatButton = 
# 37 "Source\\GUI\\guibutton.c" 3 4
                   ((void *)0)
# 37 "Source\\GUI\\guibutton.c"
                       ;
}
...
static void GUI_ButtonTimerHandler(pTIMER Timer)
{
    if (((uintptr_t)GUI_GetObjectActive() == (uintptr_t)ArepeatButton) &&
            ((pBUTTON)ArepeatButton)->Autorepeat && (ArepeatButton->OnClick != 
# 43 "Source\\GUI\\guibutton.c" 3 4
                                                                              ((void *)0)
# 43 "Source\\GUI\\guibutton.c"
                                                                                  ))
    {
        TPOINT DummyPoint = {0};
...
void GUI_DrawDefaultButton(pGUIOBJECT Object, pRECT Clip)
{
    ...
    if ((Object == 
# 63 "Source\\GUI\\guibutton.c" 3 4
                  ((void *)0)
# 63 "Source\\GUI\\guibutton.c"
                      ) || !Object->Visible ||
            (Object->Type != GO_BUTTON) || (Clip == 
# 64 "Source\\GUI\\guibutton.c" 3 4
                                                   ((void *)0)
# 64 "Source\\GUI\\guibutton.c"
                                                       )) return;
    ...
    {
        if (Button->Caption.Text != 
# 74 "Source\\GUI\\guibutton.c" 3 4
                                   ((void *)0)
# 74 "Source\\GUI\\guibutton.c"
                                       )
        {
            ...
            if (BackRects != 
# 83 "Source\\GUI\\guibutton.c" 3 4
                            ((void *)0)
# 83 "Source\\GUI\\guibutton.c"
                                )
            {
                uint32_t i;
                            ...
                            TCOLOR ForeColor, TGOFLAGS Flags)
{
    ...
    if ((Parent == 
# 105 "Source\\GUI\\guibutton.c" 3 4
                  ((void *)0)
# 105 "Source\\GUI\\guibutton.c"
                      ) ||
            !GUI_IsWindowObject(Parent) || GUI_IsLayerObject(Parent)) return 
# 106 "Source\\GUI\\guibutton.c" 3 4
                                                                            ((void *)0)
# 106 "Source\\GUI\\guibutton.c"
                                                                                ;

    Button = malloc(sizeof(TBUTTON));
    if (Button != 
# 109 "Source\\GUI\\guibutton.c" 3 4
                 ((void *)0)
# 109 "Source\\GUI\\guibutton.c"
                     )
    {
        ...
        else
        {
            ...
            Result = (tmpDLItem == 
# 139 "Source\\GUI\\guibutton.c" 3 4
                                  ((void *)0)
# 139 "Source\\GUI\\guibutton.c"
                                      ) ?
        ...
        else
        {
            free(Button);
            Button = 
# 153 "Source\\GUI\\guibutton.c" 3 4
                    ((void *)0)
# 153 "Source\\GUI\\guibutton.c"
                        ;
        }
    }
...
{
    if ((Object != 
# 161 "Source\\GUI\\guibutton.c" 3 4
                  ((void *)0)
# 161 "Source\\GUI\\guibutton.c"
                      ) && (Object->Type == GO_BUTTON))
    {
        pBUTTON Button = (pBUTTON)Object;

        if ((Button->Caption.Font != 
# 165 "Source\\GUI\\guibutton.c" 3 4
                                    ((void *)0)
# 165 "Source\\GUI\\guibutton.c"
                                        ) && (IsDynamicMemory(Button->Caption.Font)))
            free(Button->Caption.Font);
        Button->Caption.Font = 
# 167 "Source\\GUI\\guibutton.c" 3 4
                              ((void *)0)
# 167 "Source\\GUI\\guibutton.c"
                                  ;

        if ((Button->Caption.Text != 
# 169 "Source\\GUI\\guibutton.c" 3 4
                                    ((void *)0)
# 169 "Source\\GUI\\guibutton.c"
                                        ) && (IsDynamicMemory(Button->Caption.Text)))
            free(Button->Caption.Text);
        Button->Caption.Text = 
# 171 "Source\\GUI\\guibutton.c" 3 4
                              ((void *)0)
# 171 "Source\\GUI\\guibutton.c"
                                  ;
    }
}
...
{
    if ((Object != 
# 177 "Source\\GUI\\guibutton.c" 3 4
                  ((void *)0)
# 177 "Source\\GUI\\guibutton.c"
                      ) && (ClientArea != 
# 177 "Source\\GUI\\guibutton.c" 3 4
                                          ((void *)0)
# 177 "Source\\GUI\\guibutton.c"
...
{
    if ((Object != 
# 188 "Source\\GUI\\guibutton.c" 3 4
                  ((void *)0)
# 188 "Source\\GUI\\guibutton.c"
                      ) && (Object->Type == GO_BUTTON))
    {
...
# 194 "Source\\GUI\\guibutton.c" 3 4
               ((void *)0)
# 194 "Source\\GUI\\guibutton.c"
                   ;
}
...
{
    if ((Object != 
# 199 "Source\\GUI\\guibutton.c" 3 4
                  ((void *)0)
# 199 "Source\\GUI\\guibutton.c"
                      ) && (Object->Type == GO_BUTTON) && (ObjectText != 
# 199 "Source\\GUI\\guibutton.c" 3 4
                                                                         ((void *)0)
# 199 "Source\\GUI\\guibutton.c"
                                                                             ))
...
{
    if ((Object != 
# 211 "Source\\GUI\\guibutton.c" 3 4
                  ((void *)0)
# 211 "Source\\GUI\\guibutton.c"
                      ) && (Object->Type == GO_BUTTON))
    {
        ...
        if (Active && ((pBUTTON)Object)->Autorepeat)
        {
            ...
            ButtonTimer = LRT_Create(1000, GUI_ButtonTimerHandler, TF_AUTOREPEAT | TF_ENABLED);
            ArepeatButton = (ButtonTimer != 
# 219 "Source\\GUI\\guibutton.c" 3 4
                                           ((void *)0)
# 219 "Source\\GUI\\guibutton.c"
                                               ) ? Object : 
# 219 "Source\\GUI\\guibutton.c" 3 4
                                                            ((void *)0)
# 219 "Source\\GUI\\guibutton.c"
...
# 221 "Source\\GUI\\guibutton.c" 3 4
                               ((void *)0)
# 221 "Source\\GUI\\guibutton.c"
                                   )
...
{
    return ((Object != 
# 229 "Source\\GUI\\guibutton.c" 3 4
                      ((void *)0)
# 229 "Source\\GUI\\guibutton.c"
                          ) && (Object->Type == GO_BUTTON)) ?
