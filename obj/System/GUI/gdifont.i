# 1 "Source\\GUI\\gdifont.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\GUI\\gdifont.c"
# 21 "Source\\GUI\\gdifont.c"
...
# 22 "Source\\GUI\\gdifont.c" 2
# 1 "Source\\GUI\\gdifont.h" 1
# 23 "Source\\GUI\\gdifont.c" 2

static pBFC_CHARINFO GDI_GetFontCharInfo(pBFC_FONT Font, uint32_t Symbol)
{
    pBFC_FONT_PROP pProp;
    pBFC_CHARINFO Result = 
# 27 "Source\\GUI\\gdifont.c" 3 4
                           ((void *)0)
# 27 "Source\\GUI\\gdifont.c"
                               ;

    if (Font == 
# 29 "Source\\GUI\\gdifont.c" 3 4
               ((void *)0)
# 29 "Source\\GUI\\gdifont.c"
                   ) return 
# 29 "Source\\GUI\\gdifont.c" 3 4
                            ((void *)0)
# 29 "Source\\GUI\\gdifont.c"
    ...
    while(pProp != 
# 32 "Source\\GUI\\gdifont.c" 3 4
                  ((void *)0)
# 32 "Source\\GUI\\gdifont.c"
                      )
    {
                             ...
                             TCOLOR ForeColor, TCOLOR BackColor)
{
    ...
    TRECT TextRect;
    pRLIST SubRects = 
# 52 "Source\\GUI\\gdifont.c" 3 4
                        ((void *)0)
# 52 "Source\\GUI\\gdifont.c"
                            ;

    if (lc->ColorFormat != CF_RGB565) return 
# 54 "Source\\GUI\\gdifont.c" 3 4
                                            ((void *)0)
# 54 "Source\\GUI\\gdifont.c"
                                                ;

    FrameBuffer = lc->FrameBuffer;
    FrameWidth = (lc->LayerRgn.r - lc->LayerRgn.l + 1);

    ForeColor = ((((ForeColor) & 0xF80000) >> 8) | (((ForeColor) & 0xFC00) >> 5) | (((ForeColor) & 0xF8)) >> 3);
    BackColor = ((((BackColor) & 0xF80000) >> 8) | (((BackColor) & 0xFC00) >> 5) | (((BackColor) & 0xF8)) >> 3);
    ...
    if (GDI_ANDRectangles(&TextRect, Clip))
    {
        ...
        PixX = TextRect.l - Client->l;
        PixY = TextRect.t - Client->t;
        dx = TextRect.r - TextRect.l + 1;
        dy = TextRect.b - TextRect.t + 1;

        CapPtr = GDI_GetStringPosByXShift(&CharInfo, Text, PixX - XShift, &BitStartIndex);
        if (CapPtr != 
# 110 "Source\\GUI\\gdifont.c" 3 4
                     ((void *)0)
# 110 "Source\\GUI\\gdifont.c"
                         )
        {
            while(dx)
            {
                ...
                BitsDraw = ({ typeof(dx) _a = dx; typeof(CharInfo->Width - BitStartIndex) _b = CharInfo->Width - BitStartIndex; (_a < _b) ? _a : _b; });
                tmpY = dy;
                ...
                if (dx -= BitsDraw)
                {
                    while (*++CapPtr)
                    {
                        if ((CharInfo = GDI_GetFontCharInfo(Text->Font, *CapPtr)) != 
# 147 "Source\\GUI\\gdifont.c" 3 4
                                                                                    ((void *)0)
# 147 "Source\\GUI\\gdifont.c"
                                                                                        )
                        {
                            BitStartIndex = 0;
                            break;
                             ...
                             TCOLOR ForeColor, TCOLOR BackColor)
{
    ...
    TRECT TextRect;
    pRLIST SubRects = 
# 170 "Source\\GUI\\gdifont.c" 3 4
                        ((void *)0)
# 170 "Source\\GUI\\gdifont.c"
                            ;
    ...
    if ((lc->ColorFormat != CF_ARGB8888) &&
        ...
        return 
# 175 "Source\\GUI\\gdifont.c" 3 4
              ((void *)0)
# 175 "Source\\GUI\\gdifont.c"
                  ;
    ...
    if (GDI_ANDRectangles(&TextRect, Clip))
    {
        ...
        CapPtr = GDI_GetStringPosByXShift(&CharInfo, Text, PixX - XShift, &BitStartIndex);
        if (CapPtr != 
# 228 "Source\\GUI\\gdifont.c" 3 4
                     ((void *)0)
# 228 "Source\\GUI\\gdifont.c"
                         )
        {
            while(dx)
            {
                ...
                if (dx -= BitsDraw)
                {
                    ...
                    {
                        if ((CharInfo = GDI_GetFontCharInfo(Text->Font, *CapPtr)) != 
# 265 "Source\\GUI\\gdifont.c" 3 4
                                                                                    ((void *)0)
# 265 "Source\\GUI\\gdifont.c"
                                                                                        )
                        {
                            BitStartIndex = 0;
                            break;
...
{
    if (Text != 
# 307 "Source\\GUI\\gdifont.c" 3 4
               ((void *)0)
# 307 "Source\\GUI\\gdifont.c"
                   )
    {
        TSIZEXY SzXY = {0};

        if ((Text->Text != 
# 311 "Source\\GUI\\gdifont.c" 3 4
                          ((void *)0)
# 311 "Source\\GUI\\gdifont.c"
                              ) && (Text->Font != 
# 311 "Source\\GUI\\gdifont.c" 3 4
                                                  ((void *)0)
# 311 "Source\\GUI\\gdifont.c"
                                                      ))
        {
            ...
            while(*p)
            {
                ...
                if ((CharInfo = GDI_GetFontCharInfo(Text->Font, *p++)) != 
# 321 "Source\\GUI\\gdifont.c" 3 4
                                                                         ((void *)0)
# 321 "Source\\GUI\\gdifont.c"
                                                                             )
                               ...
                               uint32_t *DataBitIndex)
{
    ...
    if ((Text == 
# 336 "Source\\GUI\\gdifont.c" 3 4
                ((void *)0)
# 336 "Source\\GUI\\gdifont.c"
                    ) || (Text->Font == 
# 336 "Source\\GUI\\gdifont.c" 3 4
                                        ((void *)0)
# 336 "Source\\GUI\\gdifont.c"
...
# 336 "Source\\GUI\\gdifont.c"
    ...
    while(*p)
    {
        ...
        if (tmpCharInfo != 
# 344 "Source\\GUI\\gdifont.c" 3 4
                          ((void *)0)
# 344 "Source\\GUI\\gdifont.c"
                              )
        {
            if ((ReqXShift >= CurrentShift) && (ReqXShift < (CurrentShift + tmpCharInfo->Width)))
            {
                if (DataBitIndex != 
# 348 "Source\\GUI\\gdifont.c" 3 4
                                   ((void *)0)
# 348 "Source\\GUI\\gdifont.c"
                                       ) *DataBitIndex = ReqXShift - CurrentShift;
                if (CharInfo != 
# 349 "Source\\GUI\\gdifont.c" 3 4
                               ((void *)0)
# 349 "Source\\GUI\\gdifont.c"
    ...
    return 
# 356 "Source\\GUI\\gdifont.c" 3 4
          ((void *)0)
# 356 "Source\\GUI\\gdifont.c"
              ;
}
...
# 364 "Source\\GUI\\gdifont.c" 3 4
       ((void *)0)
# 364 "Source\\GUI\\gdifont.c"
           ,
        GDI_DrawText16,
        
# 366 "Source\\GUI\\gdifont.c" 3 4
       ((void *)0)
# 366 "Source\\GUI\\gdifont.c"
           ,
        
# 367 "Source\\GUI\\gdifont.c" 3 4
       ((void *)0)
# 367 "Source\\GUI\\gdifont.c"
           ,
        GDI_DrawText32,
        GDI_DrawText32,
        GDI_DrawText32
    ...
    if (((Layer < LCDIF_NUMLAYERS) && LCDScreen.VLayer[Layer].Initialized) &&
            (Text != 
# 374 "Source\\GUI\\gdifont.c" 3 4
                    ((void *)0)
# 374 "Source\\GUI\\gdifont.c"
                        ) && (Text->Font != 
# 374 "Source\\GUI\\gdifont.c" 3 4
                                            ((void *)0)
# 374 "Source\\GUI\\gdifont.c"
...
# 374 "Source\\GUI\\gdifont.c"
            ...
            (Client != 
# 376 "Source\\GUI\\gdifont.c" 3 4
                      ((void *)0)
# 376 "Source\\GUI\\gdifont.c"
                          ) && (Clip != 
# 376 "Source\\GUI\\gdifont.c" 3 4
                                        ((void *)0)
# 376 "Source\\GUI\\gdifont.c"
                                            ))
    {
        ...
        if (GDI_ANDRectangles(&tmpClip, &lc->LayerRgn) &&
                ...
                (DrawText[lc->ColorFormat] != 
# 383 "Source\\GUI\\gdifont.c" 3 4
                                             ((void *)0)
# 383 "Source\\GUI\\gdifont.c"
                                                 ))
            return DrawText[lc->ColorFormat](lc, Text, Client, &tmpClip, ForeColor, BackColor);
    }
    return 
# 386 "Source\\GUI\\gdifont.c" 3 4
          ((void *)0)
# 386 "Source\\GUI\\gdifont.c"
              ;
}
