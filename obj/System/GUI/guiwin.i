# 1 "Source\\GUI\\guiwin.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\GUI\\guiwin.c"
# 21 "Source\\GUI\\guiwin.c"
...
# 22 "Source\\GUI\\guiwin.c" 2
# 1 "Source\\GUI\\guiobject.h" 1
# 23 "Source\\GUI\\guiwin.c" 2
# 1 "Source\\GUI\\guiwin.h" 1
# 24 "Source\\GUI\\guiwin.c" 2
...
static boolean GUI_MoveWindowToTop(pGUIOBJECT Object)
{
    ...
    if (!((pWIN)Object)->Topmost)
    {
        ...
        while(tmpDLItem != 
# 37 "Source\\GUI\\guiwin.c" 3 4
                          ((void *)0)
# 37 "Source\\GUI\\guiwin.c"
                              )
        {
            pGUIOBJECT tmpObject = (pGUIOBJECT)tmpDLItem->Data;

            if ((tmpObject == 
# 41 "Source\\GUI\\guiwin.c" 3 4
                             ((void *)0)
# 41 "Source\\GUI\\guiwin.c"
                                 ) ||
...
void GUI_DrawDefaultWindow(pGUIOBJECT Object, pRECT Clip)
{
    ...
    if ((Object == 
# 59 "Source\\GUI\\guiwin.c" 3 4
                  ((void *)0)
# 59 "Source\\GUI\\guiwin.c"
                      ) || !Object->Visible ||
            !GUI_IsWindowObject(Object) || (Clip == 
# 60 "Source\\GUI\\guiwin.c" 3 4
                                                   ((void *)0)
# 60 "Source\\GUI\\guiwin.c"
                                                       )) return;
...
pGUIOBJECT GUI_CreateLayer(TVLINDEX Layer, TRECT Position, TCFORMAT CFormat,
                           uint8_t GlobalAlpha, TCOLOR ForeColor)
{
    if (Layer >= LCDIF_NUMLAYERS) return 
# 77 "Source\\GUI\\guiwin.c" 3 4
                                        ((void *)0)
# 77 "Source\\GUI\\guiwin.c"
                                            ;

    if (GUILayer[Layer] == 
# 79 "Source\\GUI\\guiwin.c" 3 4
                          ((void *)0)
# 79 "Source\\GUI\\guiwin.c"
                              )
    {
        ...
        if (LObject != 
# 84 "Source\\GUI\\guiwin.c" 3 4
                      ((void *)0)
# 84 "Source\\GUI\\guiwin.c"
                          )
        {
            memset(LObject, 0x00, sizeof(TWIN));

            do { typeof(Position.l) tval; if (Position.l > Position.r) { tval = Position.l; Position.l = Position.r; Position.r = tval; } } while(0);
            do { typeof(Position.t) tval; if (Position.t > Position.b) { tval = Position.t; Position.t = Position.b; Position.b = tval; } } while(0);

            LObject->Head.Position = GDI_GlobalToLocalRct(&Position, &Position.lt);
                            ...
                            TCOLOR ForeColor, TGOFLAGS Flags)
{
    ...
    if ((Parent == 
# 123 "Source\\GUI\\guiwin.c" 3 4
                  ((void *)0)
# 123 "Source\\GUI\\guiwin.c"
                      ) || !GUI_IsWindowObject(Parent)) return 
# 123 "Source\\GUI\\guiwin.c" 3 4
                                                               ((void *)0)
# 123 "Source\\GUI\\guiwin.c"
                                                                   ;
    ...
    if (Win != 
# 126 "Source\\GUI\\guiwin.c" 3 4
              ((void *)0)
# 126 "Source\\GUI\\guiwin.c"
                  )
    {
        ...
        if (Win->Topmost) Result = DL_AddItemPtr(ObjectsList, &Win->Head.ListHeader);
        else
        {
            pDLITEM tmpItem = DL_GetLastItem(ObjectsList);

            while(tmpItem != 
# 153 "Source\\GUI\\guiwin.c" 3 4
                            ((void *)0)
# 153 "Source\\GUI\\guiwin.c"
                                )
            {
                pGUIOBJECT tmpObject = tmpItem->Data;

                if ((tmpObject != 
# 157 "Source\\GUI\\guiwin.c" 3 4
                                 ((void *)0)
# 157 "Source\\GUI\\guiwin.c"
                                     ) &&
                        (!GUI_IsWindowObject(tmpObject) || !((pWIN)tmpObject)->Topmost))
                {
            ...
            if (tmpItem == 
# 165 "Source\\GUI\\guiwin.c" 3 4
                          ((void *)0)
# 165 "Source\\GUI\\guiwin.c"
                              ) Result = DL_AddItemAtIndexPtr(ObjectsList, 0, &Win->Head.ListHeader);
        }
        ...
        else
        {
            free(Win);
            Win = 
# 177 "Source\\GUI\\guiwin.c" 3 4
                 ((void *)0)
# 177 "Source\\GUI\\guiwin.c"
                     ;
        }
    }
...
boolean GUI_IsLayerObject(pGUIOBJECT Object)
{
    ...
    if ((Object != 
# 192 "Source\\GUI\\guiwin.c" 3 4
                  ((void *)0)
# 192 "Source\\GUI\\guiwin.c"
...
{
    return ((Object != 
# 202 "Source\\GUI\\guiwin.c" 3 4
                      ((void *)0)
# 202 "Source\\GUI\\guiwin.c"
                          ) && (Object->Type == GO_WINDOW));
}
...
int32_t GUI_GetWindowZIndex(pGUIOBJECT Win)
{
    ...
    if ((Win != 
# 209 "Source\\GUI\\guiwin.c" 3 4
               ((void *)0)
# 209 "Source\\GUI\\guiwin.c"
                   ) && GUI_IsWindowObject(Win) &&
            (((pWIN)Win)->Layer < LCDIF_NUMLAYERS) && (GUILayer[((pWIN)Win)->Layer] != 
# 210 "Source\\GUI\\guiwin.c" 3 4
                                                                                      ((void *)0)
# 210 "Source\\GUI\\guiwin.c"
                                                                                          ))
    {
...
{
    pGUIOBJECT Result = 
# 219 "Source\\GUI\\guiwin.c" 3 4
                       ((void *)0)
# 219 "Source\\GUI\\guiwin.c"
                           ;

    if ((Parent != 
# 221 "Source\\GUI\\guiwin.c" 3 4
                  ((void *)0)
# 221 "Source\\GUI\\guiwin.c"
                      ) && GUI_IsWindowObject(Parent))
    {
        ...
        {
            Object = (tmpDLItem == 
# 229 "Source\\GUI\\guiwin.c" 3 4
                                  ((void *)0)
# 229 "Source\\GUI\\guiwin.c"
                                      ) ? 
# 229 "Source\\GUI\\guiwin.c" 3 4
                                          ((void *)0) 
# 229 "Source\\GUI\\guiwin.c"
                                               : (pGUIOBJECT)tmpDLItem->Data;
            Result = ((Object != 
# 230 "Source\\GUI\\guiwin.c" 3 4
                                ((void *)0)
# 230 "Source\\GUI\\guiwin.c"
                                    ) &&
                      GUI_IsWindowObject(Object) &&
                      ((pWIN)Object)->Topmost) ? Object : 
# 232 "Source\\GUI\\guiwin.c" 3 4
                                                         ((void *)0)
# 232 "Source\\GUI\\guiwin.c"
                                                             ;
            *ObjectItem = ((ObjectItem != 
# 233 "Source\\GUI\\guiwin.c" 3 4
                                         ((void *)0)
# 233 "Source\\GUI\\guiwin.c"
                                             ) && (Result != 
# 233 "Source\\GUI\\guiwin.c" 3 4
                                                             ((void *)0)
# 233 "Source\\GUI\\guiwin.c"
...
# 233 "Source\\GUI\\guiwin.c"
        ...
        {
            while(tmpDLItem != 
# 237 "Source\\GUI\\guiwin.c" 3 4
                              ((void *)0)
# 237 "Source\\GUI\\guiwin.c"
                                  )
            {
                Object = (pGUIOBJECT)tmpDLItem->Data;
                if (Object != 
# 240 "Source\\GUI\\guiwin.c" 3 4
                             ((void *)0)
# 240 "Source\\GUI\\guiwin.c"
                                 )
                {
                    ...
                    if (!((pWIN)Object)->Topmost)
                    {
                        Result = Object;
                        if (ObjectItem != 
# 246 "Source\\GUI\\guiwin.c" 3 4
                                         ((void *)0)
# 246 "Source\\GUI\\guiwin.c"
                                             ) *ObjectItem = tmpDLItem;
                        break;
                    }
                }
                tmpDLItem = DL_GetPrevItem(tmpDLItem);
...
{
    pGUIOBJECT ObjectToInvalidate = 
# 259 "Source\\GUI\\guiwin.c" 3 4
                                   ((void *)0)
# 259 "Source\\GUI\\guiwin.c"
                                       ;

    if ((Object != 
# 261 "Source\\GUI\\guiwin.c" 3 4
                  ((void *)0)
# 261 "Source\\GUI\\guiwin.c"
                      ) &&
            GUI_IsWindowObject(Object) && !GUI_IsLayerObject(Object))
    {
        while(Object->Parent != 
# 264 "Source\\GUI\\guiwin.c" 3 4
                               ((void *)0)
# 264 "Source\\GUI\\guiwin.c"
                                   )
        {
...
{
    if ((Object != 
# 278 "Source\\GUI\\guiwin.c" 3 4
                  ((void *)0)
# 278 "Source\\GUI\\guiwin.c"
                      ) && (ClientArea != 
# 278 "Source\\GUI\\guiwin.c" 3 4
                                          ((void *)0)
# 278 "Source\\GUI\\guiwin.c"
