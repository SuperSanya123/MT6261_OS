# 1 "Source\\GUI\\guilabel.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\GUI\\guilabel.c"
# 21 "Source\\GUI\\guilabel.c"
...
# 22 "Source\\GUI\\guilabel.c" 2
# 1 "Source\\GUI\\guiobject.h" 1
# 23 "Source\\GUI\\guilabel.c" 2
# 1 "Source\\GUI\\guilabel.h" 1
# 24 "Source\\GUI\\guilabel.c" 2
...
void GUI_DrawDefaultLabel(pGUIOBJECT Object, pRECT Clip)
{
    ...
    if ((Object == 
# 31 "Source\\GUI\\guilabel.c" 3 4
                  ((void *)0)
# 31 "Source\\GUI\\guilabel.c"
                      ) || !Object->Visible ||
            (Object->Type != GO_LABEL) || (Clip == 
# 32 "Source\\GUI\\guilabel.c" 3 4
                                                  ((void *)0)
# 32 "Source\\GUI\\guilabel.c"
                                                      )) return;

    LabelRect = Object->Position;
    Layer = ((pWIN)Object->Parent)->Layer;

    if (Label->Caption.Text != 
# 37 "Source\\GUI\\guilabel.c" 3 4
                              ((void *)0)
# 37 "Source\\GUI\\guilabel.c"
                                  )
    {
        ...
        if (BackRects != 
# 46 "Source\\GUI\\guilabel.c" 3 4
                        ((void *)0)
# 46 "Source\\GUI\\guilabel.c"
                            )
        {
            uint32_t i;
                           ...
                           TCOLOR ForeColor, TGOFLAGS Flags)
{
    ...
    if ((Parent == 
# 67 "Source\\GUI\\guilabel.c" 3 4
                  ((void *)0)
# 67 "Source\\GUI\\guilabel.c"
                      ) ||
            !GUI_IsWindowObject(Parent) || GUI_IsLayerObject(Parent)) return 
# 68 "Source\\GUI\\guilabel.c" 3 4
                                                                            ((void *)0)
# 68 "Source\\GUI\\guilabel.c"
                                                                                ;

    Label = malloc(sizeof(TLABEL));
    if (Label != 
# 71 "Source\\GUI\\guilabel.c" 3 4
                ((void *)0)
# 71 "Source\\GUI\\guilabel.c"
                    )
    {
        ...
        else
        {
            ...
            Result = (tmpDLItem == 
# 100 "Source\\GUI\\guilabel.c" 3 4
                                  ((void *)0)
# 100 "Source\\GUI\\guilabel.c"
                                      ) ?
        ...
        if (Result)
        {
            ...
            if (Label->Head.Visible && Label->Head.InheritedVisible)
                GUI_Invalidate((pGUIOBJECT)Label);
        }
        else
        {
            free(Label);
            Label = 
# 114 "Source\\GUI\\guilabel.c" 3 4
                   ((void *)0)
# 114 "Source\\GUI\\guilabel.c"
                       ;
        }
    }
...
{
    if ((Object != 
# 122 "Source\\GUI\\guilabel.c" 3 4
                  ((void *)0)
# 122 "Source\\GUI\\guilabel.c"
                      ) && (Object->Type == GO_LABEL))
    {
        pLABEL Label = (pLABEL)Object;

        if ((Label->Caption.Font != 
# 126 "Source\\GUI\\guilabel.c" 3 4
                                   ((void *)0)
# 126 "Source\\GUI\\guilabel.c"
                                       ) && (IsDynamicMemory(Label->Caption.Font)))
            free(Label->Caption.Font);
        Label->Caption.Font = 
# 128 "Source\\GUI\\guilabel.c" 3 4
                             ((void *)0)
# 128 "Source\\GUI\\guilabel.c"
                                 ;

        if ((Label->Caption.Text != 
# 130 "Source\\GUI\\guilabel.c" 3 4
                                   ((void *)0)
# 130 "Source\\GUI\\guilabel.c"
                                       ) && (IsDynamicMemory(Label->Caption.Text)))
            free(Label->Caption.Text);
        Label->Caption.Text = 
# 132 "Source\\GUI\\guilabel.c" 3 4
                             ((void *)0)
# 132 "Source\\GUI\\guilabel.c"
                                 ;
    }
}
...
{
    if ((Object != 
# 138 "Source\\GUI\\guilabel.c" 3 4
                  ((void *)0)
# 138 "Source\\GUI\\guilabel.c"
                      ) && (Object->Type == GO_LABEL))
    {
...
# 144 "Source\\GUI\\guilabel.c" 3 4
               ((void *)0)
# 144 "Source\\GUI\\guilabel.c"
                   ;
}
...
{
    if ((Object != 
# 149 "Source\\GUI\\guilabel.c" 3 4
                  ((void *)0)
# 149 "Source\\GUI\\guilabel.c"
                      ) && (Object->Type == GO_LABEL) && (ObjectText != 
# 149 "Source\\GUI\\guilabel.c" 3 4
                                                                        ((void *)0)
# 149 "Source\\GUI\\guilabel.c"
                                                                            ))
