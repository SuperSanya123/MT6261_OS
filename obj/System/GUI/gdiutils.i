# 1 "Source\\GUI\\gdiutils.c"
# 1 "C:\\Users\\user\\Desktop\\DZ09-master//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "Source\\GUI\\gdiutils.c"
# 21 "Source\\GUI\\gdiutils.c"
...
# 22 "Source\\GUI\\gdiutils.c" 2
# 1 "Source\\GUI\\gdiutils.h" 1
# 23 "Source\\GUI\\gdiutils.c" 2
...
static void GDI_MergeRectsInRegion(pDLIST Region)
{
    ...
    if ((Region == 
# 29 "Source\\GUI\\gdiutils.c" 3 4
                  ((void *)0)
# 29 "Source\\GUI\\gdiutils.c"
                      ) || (DL_GetItemsCount(Region) <= 1)) return;

    ModItem = DL_GetFirstItem(Region);
    CmpItem = DL_GetNextItem(ModItem);

    while((ModItem != 
# 34 "Source\\GUI\\gdiutils.c" 3 4
                     ((void *)0)
# 34 "Source\\GUI\\gdiutils.c"
                         ) && (CmpItem != 
# 34 "Source\\GUI\\gdiutils.c" 3 4
                                          ((void *)0)
# 34 "Source\\GUI\\gdiutils.c"
                                              ))
    {
        ...
        while (CmpItem != 
# 37 "Source\\GUI\\gdiutils.c" 3 4
                         ((void *)0)
# 37 "Source\\GUI\\gdiutils.c"
                             )
        {
                    ...
                    ((ModRect->l - CmpRect->r == 1) || (CmpRect->l - ModRect->r == 1)))
            {
                ...
                ModRect->l = ({ typeof(ModRect->l) _a = ModRect->l; typeof(CmpRect->l) _b = CmpRect->l; (_a < _b) ? _a : _b; });
                ModRect->r = ({ typeof(ModRect->r) _a = ModRect->r; typeof(CmpRect->r) _b = CmpRect->r; (_a > _b) ? _a : _b; });
...
{
    if ((a != 
# 86 "Source\\GUI\\gdiutils.c" 3 4
             ((void *)0)
# 86 "Source\\GUI\\gdiutils.c"
                 ) && (b != 
# 86 "Source\\GUI\\gdiutils.c" 3 4
                            ((void *)0)
# 86 "Source\\GUI\\gdiutils.c"
...
{
    return ((Rct != 
# 99 "Source\\GUI\\gdiutils.c" 3 4
                   ((void *)0)
# 99 "Source\\GUI\\gdiutils.c"
                       ) && (Pt != 
# 99 "Source\\GUI\\gdiutils.c" 3 4
                                   ((void *)0)
# 99 "Source\\GUI\\gdiutils.c"
...
{
    if ((a == 
# 107 "Source\\GUI\\gdiutils.c" 3 4
             ((void *)0)
# 107 "Source\\GUI\\gdiutils.c"
                 ) || (b == 
# 107 "Source\\GUI\\gdiutils.c" 3 4
                            ((void *)0)
# 107 "Source\\GUI\\gdiutils.c"
...
{
    return (rct == 
# 124 "Source\\GUI\\gdiutils.c" 3 4
                  ((void *)0)
# 124 "Source\\GUI\\gdiutils.c"
                      ) ||
...
pRLIST GDI_CreateRList(void)
{
    ...
    if (tmpRList != 
# 132 "Source\\GUI\\gdiutils.c" 3 4
                   ((void *)0)
# 132 "Source\\GUI\\gdiutils.c"
                       )
        tmpRList->Count = 0;
...
pRLIST GDI_DeleteRList(pRLIST RList)
{
    ...
    return 
# 142 "Source\\GUI\\gdiutils.c" 3 4
          ((void *)0)
# 142 "Source\\GUI\\gdiutils.c"
              ;
}
...
TPOINT GDI_LocalToGlobalPt(pPOINT pt, pPOINT Offset)
{
    ...
    if (pt != 
# 149 "Source\\GUI\\gdiutils.c" 3 4
             ((void *)0)
# 149 "Source\\GUI\\gdiutils.c"
                 )
    {
        if (Offset != 
# 151 "Source\\GUI\\gdiutils.c" 3 4
                     ((void *)0)
# 151 "Source\\GUI\\gdiutils.c"
                         )
        {
            Res.x = Offset->x + pt->x;
            Res.y = Offset->y + pt->y;
...
TPOINT GDI_GlobalToLocalPt(pPOINT pt, pPOINT Offset)
{
    ...
    if (pt != 
# 169 "Source\\GUI\\gdiutils.c" 3 4
             ((void *)0)
# 169 "Source\\GUI\\gdiutils.c"
                 )
    {
        if (Offset != 
# 171 "Source\\GUI\\gdiutils.c" 3 4
                     ((void *)0)
# 171 "Source\\GUI\\gdiutils.c"
                         )
        {
            Res.x = pt->x - Offset->x;
            Res.y = pt->y - Offset->y;
...
TRECT GDI_LocalToGlobalRct(pRECT rct, pPOINT Offset)
{
    ...
    if (rct != 
# 189 "Source\\GUI\\gdiutils.c" 3 4
              ((void *)0)
# 189 "Source\\GUI\\gdiutils.c"
                  )
    {
        if (Offset != 
# 191 "Source\\GUI\\gdiutils.c" 3 4
                     ((void *)0)
# 191 "Source\\GUI\\gdiutils.c"
                         )
        {
...
TRECT GDI_GlobalToLocalRct(pRECT rct, pPOINT Offset)
{
    ...
    if (rct != 
# 213 "Source\\GUI\\gdiutils.c" 3 4
              ((void *)0)
# 213 "Source\\GUI\\gdiutils.c"
                  )
    {
        if (Offset != 
# 215 "Source\\GUI\\gdiutils.c" 3 4
                     ((void *)0)
# 215 "Source\\GUI\\gdiutils.c"
                         )
        {
...
TPOINT GDI_ScreenToLayerPt(TVLINDEX Layer, pPOINT pt)
{
    ...
    if ((pt == 
# 237 "Source\\GUI\\gdiutils.c" 3 4
              ((void *)0)
# 237 "Source\\GUI\\gdiutils.c"
                  ) || (Layer >= LCDIF_NUMLAYERS) || (GUILayer[Layer] == 
# 237 "Source\\GUI\\gdiutils.c" 3 4
                                                                         ((void *)0)
# 237 "Source\\GUI\\gdiutils.c"
                                                                             ))
...
{
    if ((a != 
# 250 "Source\\GUI\\gdiutils.c" 3 4
             ((void *)0)
# 250 "Source\\GUI\\gdiutils.c"
                 ) && (b != 
# 250 "Source\\GUI\\gdiutils.c" 3 4
                            ((void *)0)
# 250 "Source\\GUI\\gdiutils.c"
                                ))
    {
        ...
        {
            a->l = ({ typeof(a->l) _a = a->l; typeof(b->l) _b = b->l; (_a > _b) ? _a : _b; });
            a->r = ({ typeof(a->r) _a = a->r; typeof(b->r) _b = b->r; (_a < _b) ? _a : _b; });
            a->t = ({ typeof(a->t) _a = a->t; typeof(b->t) _b = b->t; (_a > _b) ? _a : _b; });
            a->b = ({ typeof(a->b) _a = a->b; typeof(b->b) _b = b->b; (_a < _b) ? _a : _b; });
            return true;
        }
    }
    return false;
...
{
    pDLIST ResRects = 
# 267 "Source\\GUI\\gdiutils.c" 3 4
                        ((void *)0)
# 267 "Source\\GUI\\gdiutils.c"
                            ;
    pRECTITEM tmpRectA, tmpRectB;

    if ((a == 
# 270 "Source\\GUI\\gdiutils.c" 3 4
             ((void *)0)
# 270 "Source\\GUI\\gdiutils.c"
                 ) || (b == 
# 270 "Source\\GUI\\gdiutils.c" 3 4
                            ((void *)0)
# 270 "Source\\GUI\\gdiutils.c"
...
# 270 "Source\\GUI\\gdiutils.c"
    ...
    if (!IsRectsOverlaps(a, b))
    {
        ResRects = DL_Create();
        if (ResRects != 
# 274 "Source\\GUI\\gdiutils.c" 3 4
                       ((void *)0)
# 274 "Source\\GUI\\gdiutils.c"
                           )
        {
            tmpRectA = malloc(sizeof(TRECTITEM));
            tmpRectB = malloc(sizeof(TRECTITEM));
            if ((tmpRectA == 
# 278 "Source\\GUI\\gdiutils.c" 3 4
                            ((void *)0)
# 278 "Source\\GUI\\gdiutils.c"
                                ) || (tmpRectB == 
# 278 "Source\\GUI\\gdiutils.c" 3 4
                                                  ((void *)0)
# 278 "Source\\GUI\\gdiutils.c"
                                                      ))
            {
                ...
                free(ResRects);
                return 
# 283 "Source\\GUI\\gdiutils.c" 3 4
                      ((void *)0)
# 283 "Source\\GUI\\gdiutils.c"
                          ;
            }
            tmpRectA->Rct = *a;
            tmpRectB->Rct = *b;
    ...
    else
    {
        if (IsRectInRect(a, b))
        {
            tmpRectA = malloc(sizeof(TRECTITEM));
            if (tmpRectA != 
# 296 "Source\\GUI\\gdiutils.c" 3 4
                           ((void *)0)
# 296 "Source\\GUI\\gdiutils.c"
                               )
            {
                ResRects = DL_Create();
                tmpRectA->Rct = *a;
                if (ResRects != 
# 300 "Source\\GUI\\gdiutils.c" 3 4
                               ((void *)0)
# 300 "Source\\GUI\\gdiutils.c"
                                   ) DL_AddItemPtr(ResRects, &tmpRectA->ListHeader);
                else
                {
                    free(tmpRectA);
                    return 
# 304 "Source\\GUI\\gdiutils.c" 3 4
                          ((void *)0)
# 304 "Source\\GUI\\gdiutils.c"
                              ;
                }
            }
        }
        else
        {
            ...
            if (tmpRList != 
# 312 "Source\\GUI\\gdiutils.c" 3 4
                           ((void *)0)
# 312 "Source\\GUI\\gdiutils.c"
                               )
            {
                if (tmpRList->Count &&
                        ((ResRects = DL_Create()) != 
# 315 "Source\\GUI\\gdiutils.c" 3 4
                                                    ((void *)0)
# 315 "Source\\GUI\\gdiutils.c"
                                                        ))
                {
                    uint32_t i;
                    ...
                    for(i = 0; i < tmpRList->Count; i++)
                    {
                        tmpRectB = malloc(sizeof(TRECTITEM));
                        if (tmpRectB != 
# 322 "Source\\GUI\\gdiutils.c" 3 4
                                       ((void *)0)
# 322 "Source\\GUI\\gdiutils.c"
                                           )
                        {
                    ...
                    tmpRectB = malloc(sizeof(TRECTITEM));
                    if (tmpRectB != 
# 329 "Source\\GUI\\gdiutils.c" 3 4
                                   ((void *)0)
# 329 "Source\\GUI\\gdiutils.c"
                                       )
                    {
                        tmpRectB->Rct = *b;
                        DL_AddItemPtr(ResRects, &tmpRectB->ListHeader);
...
pRLIST GDI_SUBRectangles(pRECT a, pRECT b)
{
    ...
    if (Rlist == 
# 347 "Source\\GUI\\gdiutils.c" 3 4
                ((void *)0)
# 347 "Source\\GUI\\gdiutils.c"
                    ) return 
# 347 "Source\\GUI\\gdiutils.c" 3 4
                             ((void *)0)
# 347 "Source\\GUI\\gdiutils.c"
                                 ;
    if ((a == 
# 348 "Source\\GUI\\gdiutils.c" 3 4
             ((void *)0)
# 348 "Source\\GUI\\gdiutils.c"
                 ) || (b == 
# 348 "Source\\GUI\\gdiutils.c" 3 4
                            ((void *)0)
# 348 "Source\\GUI\\gdiutils.c"
    ...
    if ((a->b - a->t) >= 0)
    {
        if ((a->r - b->r) > 0)
        {
            ...
            Rlist->Item[Rlist->Count].t = ({ typeof(a->t) _a = a->t; typeof(b->t) _b = b->t; (_a > _b) ? _a : _b; });
            Rlist->Item[Rlist->Count].r = a->r;
            Rlist->Item[Rlist->Count].b = ({ typeof(a->b) _a = a->b; typeof(b->b) _b = b->b; (_a < _b) ? _a : _b; });
            Rlist->Count++;
        }
        if ((b->l - a->l) > 0)
        {
...
boolean GDI_ADDRectToRegion(pDLIST Region, pRECT Rct)
{
    ...
    if ((Region == 
# 407 "Source\\GUI\\gdiutils.c" 3 4
                  ((void *)0)
# 407 "Source\\GUI\\gdiutils.c"
                      ) || (Rct == 
# 407 "Source\\GUI\\gdiutils.c" 3 4
                                   ((void *)0)
# 407 "Source\\GUI\\gdiutils.c"
    ...
    if (DL_GetItemsCount(Region))
    {
        ...
        while(tmpItem != 
# 413 "Source\\GUI\\gdiutils.c" 3 4
                        ((void *)0)
# 413 "Source\\GUI\\gdiutils.c"
                            )
        {
            ...
            if (IsRectsOverlaps(tmpRect, Rct))
            {
                ...
                if (tmpList != 
# 421 "Source\\GUI\\gdiutils.c" 3 4
                              ((void *)0)
# 421 "Source\\GUI\\gdiutils.c"
                                  )
                {
                    if (tmpList->Count)
                    {
                        ...
                        *tmpRect = tmpList->Item[0];
                        ...
                        {
                            if ((tmpRectItem = malloc(sizeof(TRECTITEM))) != 
# 431 "Source\\GUI\\gdiutils.c" 3 4
                                                                            ((void *)0)
# 431 "Source\\GUI\\gdiutils.c"
                                                                                )
                            {
    ...
    if (tmpRectItem != 
# 455 "Source\\GUI\\gdiutils.c" 3 4
                      ((void *)0)
# 455 "Source\\GUI\\gdiutils.c"
                          )
    {
        tmpRectItem->Rct = *Rct;
...
{
    if (Region == 
# 466 "Source\\GUI\\gdiutils.c" 3 4
                 ((void *)0)
# 466 "Source\\GUI\\gdiutils.c"
                     ) return false;

    if (DL_GetItemsCount(Region) && (Rct != 
# 468 "Source\\GUI\\gdiutils.c" 3 4
                                           ((void *)0)
# 468 "Source\\GUI\\gdiutils.c"
                                               ))
    {
        pDLITEM tmpItem = DL_GetFirstItem(Region);

        while(tmpItem != 
# 472 "Source\\GUI\\gdiutils.c" 3 4
                        ((void *)0)
# 472 "Source\\GUI\\gdiutils.c"
                            )
        {
            ...
            if (IsRectsOverlaps(tmpRect, Rct))
            {
                ...
                if (tmpList != 
# 480 "Source\\GUI\\gdiutils.c" 3 4
                              ((void *)0)
# 480 "Source\\GUI\\gdiutils.c"
                                  )
                {
                    if (tmpList->Count)
                    {
                        ...
                        *tmpRect = tmpList->Item[0];
                        ...
                        for(i = 1; i < tmpList->Count; i++)
                        {
                            ...
                            if ((tmpRectItem = malloc(sizeof(TRECTITEM))) != 
# 492 "Source\\GUI\\gdiutils.c" 3 4
                                                                            ((void *)0)
# 492 "Source\\GUI\\gdiutils.c"
                                                                                )
                            {
                                tmpRectItem->Rct = tmpList->Item[i];
                                DL_InsertItemBeforePtr(Region, tmpItem, (pDLITEM)tmpRectItem);
...
void GDI_FillRectangleX(pLCONTEXT lc, pRECT Rct, TCOLOR Color)
{
    ...
    if ((lc == 
# 530 "Source\\GUI\\gdiutils.c" 3 4
              ((void *)0)
# 530 "Source\\GUI\\gdiutils.c"
                  ) || (Rct == 
# 530 "Source\\GUI\\gdiutils.c" 3 4
                               ((void *)0)
# 530 "Source\\GUI\\gdiutils.c"
