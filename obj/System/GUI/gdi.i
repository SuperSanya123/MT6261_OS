...
# 22 "Source\\GUI\\gdi.c" 2
# 1 "Source\\GUI\\bfcfont.h" 1
# 23 "Source\\GUI\\gdi.c" 2
# 1 "Source\\GUI\\gdi.h" 1
# 24 "Source\\GUI\\gdi.c" 2

void GDI_FillRectangle(TVLINDEX Layer, TRECT Rct, TCOLOR Color)
{
    pLCONTEXT lc;
...
void GDI_DrawLine(TVLINDEX Layer, TPOINT P0, TPOINT P1, TCOLOR Color)
{
    if ((Layer >= LCDIF_NUMLAYERS) || !LCDScreen.VLayer[Layer].Initialized) return;
...
void GDI_SetPixel(TVLINDEX Layer, TPOINT P, TCOLOR Color)
{
    TRECT Rct;
    pLCONTEXT lc;
...
# 68 "Source\\GUI\\gdi.c"
                                        ))
    {
                ...
                GDI_ANDRectangles(&tmpClient, Clip))
        {
            ...
            DrwRect = Rect(Client->l, Client->t, Client->r, Client->t);
            if (GDI_ANDRectangles(&DrwRect, &tmpClient))
                GDI_FillRectangle(Layer, DrwRect, Color);
            DrwRect = Rect(Client->l, Client->t, Client->l, Client->b);
            if (GDI_ANDRectangles(&DrwRect, &tmpClient))
                GDI_FillRectangle(Layer, DrwRect, Color);
            DrwRect = Rect(Client->l + 1, Client->b, Client->r, Client->b);
            if (GDI_ANDRectangles(&DrwRect, &tmpClient))
                GDI_FillRectangle(Layer, DrwRect, Color);
            DrwRect = Rect(Client->r, Client->t + 1, Client->r, Client->b);
            if (GDI_ANDRectangles(&DrwRect, &tmpClient))
                GDI_FillRectangle(Layer, DrwRect, Color);
        }
    }
...
void GDI_Draw3DFrame(TVLINDEX Layer, pRECT Client, pRECT Clip, TCOLOR LightColor,
                     TCOLOR ShadowColor, boolean Pressed)
{
    if ((Layer >= LCDIF_NUMLAYERS) || !LCDScreen.VLayer[Layer].Initialized) return;
    if ((Client != 
# 97 "Source\\GUI\\gdi.c" 3 4
                  ((void *)0)
# 97 "Source\\GUI\\gdi.c"
                      ) && (Clip != 
# 97 "Source\\GUI\\gdi.c" 3 4
...
# 97 "Source\\GUI\\gdi.c"
                                        ))
    {
        ...
        {
            TRECT DrwRect;
            TCOLOR LTColor = (Pressed) ? ShadowColor : LightColor;
            TCOLOR RBColor = (Pressed) ? LightColor : ShadowColor;

            DrwRect = Rect(Client->l, Client->t, Client->r, Client->t);
            if (GDI_ANDRectangles(&DrwRect, &tmpClient))
                GDI_FillRectangle(Layer, DrwRect, LTColor);
            DrwRect = Rect(Client->l, Client->t, Client->l, Client->b);
            if (GDI_ANDRectangles(&DrwRect, &tmpClient))
                GDI_FillRectangle(Layer, DrwRect, LTColor);
            DrwRect = Rect(Client->l + 1, Client->b, Client->r, Client->b);
            if (GDI_ANDRectangles(&DrwRect, &tmpClient))
                GDI_FillRectangle(Layer, DrwRect, RBColor);
            DrwRect = Rect(Client->r, Client->t + 1, Client->r, Client->b);
            if (GDI_ANDRectangles(&DrwRect, &tmpClient))
                GDI_FillRectangle(Layer, DrwRect, RBColor);
        }
